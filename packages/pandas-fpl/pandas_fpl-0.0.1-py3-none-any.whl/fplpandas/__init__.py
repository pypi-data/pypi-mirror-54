...
class FPLPandas:
    ...
    def __init__(self, user_id: int = None, email: str = None, password: str = None, fpl: FPL = None):
        ...
        Args:
            user_id: The FPL user id. Only required for protected info such as user team. You can get the user id by selecting the Points tab on the FPL website and then extracting it from the browser URL like this: https://fantasy.premierleague.com/entry/{user_id}/event/6
