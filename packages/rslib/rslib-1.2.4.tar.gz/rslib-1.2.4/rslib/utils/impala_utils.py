...
class ImpalaUtils(object):
    ...
    def open_hive_conn(self):
        try:
            ...
            print('hive connection failed: %s' % e)
    ...
    def open_impala_conn(self):
        try:
            ...
            print('impala connection failed: %s' % e)
    ...
    def exec_sql_query(self, sql):
        ...
        try:
            ...
            print("exec query sql failed: %s" % e)
        return None
    ...
    def exec_sql_dml(self, sql):
        ...
        try:
            ...
            print("exec update sql failed: %s" % e)
        return False
    ...
    def exec_sql_query_pandas(self, sql=None, param_list=None):
        ...
        try:
            ...
            print("exec sql in pandas result failed: %s" % e)
        return None
