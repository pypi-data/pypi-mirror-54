...
class TransformerModel:
    ...
    def train_model(self, train_df, output_dir=None, show_running_loss=True, args=None):
        ...
        if 'text' in train_df.columns and 'labels' in train_df.columns:
            train_examples = [InputExample(i, text, None, label) for i, (text, label) in enumerate(zip(train_df.loc['text'], train_df.loc['labels']))]
        else:
    ...
    def evaluate(self, eval_df, output_dir, prefix="", **kwargs):
        ...
        if 'text' in eval_df.columns and 'labels' in eval_df.columns:
            eval_examples = [InputExample(i, text, None, label) for i, (text, label) in enumerate(zip(eval_df.loc['text'], eval_df.loc['labels']))]
        else:
