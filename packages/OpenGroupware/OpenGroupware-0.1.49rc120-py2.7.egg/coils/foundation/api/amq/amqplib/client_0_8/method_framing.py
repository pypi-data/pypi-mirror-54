...
from transport import AMQTimeOut  # Custom COILS change
...
class MethodReader(object):
    ...
    # OpenGroupware COILS custom change - added timeout= param
    def _next_method(self, timeout=None):
        ...
        while self.queue.empty():
            try:
                # Custom COILS change - passe timeout to read_frame
