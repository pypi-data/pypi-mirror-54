...
Timeout support added fro COILS use, changes noted.
  Adam Tauno Williams, 2016-09-27
  Also flaked/PEP8 tidy
...
import re
import socket
import select  # Custom COILS change


class AMQTimeOut(Exception):
    pass
...
class TCPTransport(_AbstractTransport):
    ...
    def _read(self, n, timeout=None):
        ...
        while len(self._read_buffer) < n:
            if timeout is not None:     # Custom COILS change
                self._timeout(timeout)  # Custom COILS change
