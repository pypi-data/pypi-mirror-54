...
class sympro_txt_read(object): 
   ...
   site_description : string
        ...
        elif self.filename and not self.txt_dir:
    ...
    def format_site_data(self):
        ...
        try:
            ...
            self.first_timestamp = self.data.iloc[0:]['Timestamp'].values[0]
            self.last_timestamp = self.data.iloc[-1:]['Timestamp'].values[0]
