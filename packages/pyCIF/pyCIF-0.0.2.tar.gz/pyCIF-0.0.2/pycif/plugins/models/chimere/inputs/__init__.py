...
#                **kwargs):
#     """Prepares inputs for the current CHIMERE simulation. It includes:
#         -  emissions (AEMISSIONS.nc)
#
#     Args:
#         - self (Plugin): CHIMERE plugin
#         - mod_input (str): one of: 'meteo','nml'
...
#         - runsubdir (str): path to the CHIMERE sub-simulation
