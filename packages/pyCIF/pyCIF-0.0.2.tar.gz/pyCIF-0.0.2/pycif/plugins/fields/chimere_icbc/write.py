...
def write(self, name, lbc_file, flx, mode='a'):
    """Write flux to AEMISSION CHIMERE compatible files.
    
    Args:
        self (Fluxes): the Fluxes plugin
        lbc_file (str): the file where to write fluxes
    ...
    save_nc(lbc_file, variables, varnames, vardims, dimnames, dimlens,
