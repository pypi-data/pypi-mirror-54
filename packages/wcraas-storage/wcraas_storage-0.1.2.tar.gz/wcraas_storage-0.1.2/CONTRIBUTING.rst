...
wcraas_storage could always use more documentation, whether as part of the
official wcraas_storage docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
3. The pull request should work for Python 3.6 and 3.7, and for PyPy. Check
   https://travis-ci.org/WCraaS/wcraas_storage/pull_requests
