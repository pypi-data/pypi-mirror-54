...
t <- read.table(args[1], col.names= c("pos","name","rf","score","query")) 
...
#names(t)<-c("pos","name","rf","score","query")
...
a<-read.table(args[2])
names(a)<-c("acc","type","name","method","start","stop","strand","score")
a$r <- c(1:nrow(a))
