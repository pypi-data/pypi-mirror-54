...
class DSBApi:
    ...
    def fetch_api(self):
        ...
        timetable_data = s.request("POST", "https://www.dsbmobile.de/jhw-1fd98248-440c-4283-bef6-dc82fe769b61.ashx/GetData", headers = {'User-Agent': self.user_agent, "Content-Type": "application/json;charset=utf-8", "Referer": "https://www.dsbmobile.de/default.aspx"}, json = {"req": {"Data": base64.encodebytes(jsonStream.getvalue()).decode("utf-8"), "DataType": 1}})
