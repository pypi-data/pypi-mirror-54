...
class JobApi(object):
    ...
    def get_job_status(self, job_id, **kwargs):  # noqa: E501
        ...
        Get a job status by ID  # noqa: E501
        ...
        :param str job_id: ID of job status to return (required)
        :param bool show_all: Whether to return the latest status only or all status updates
    ...
    def get_job_status_with_http_info(self, job_id, **kwargs):  # noqa: E501
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(list[JobStatus], status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        all_params = ['job_id', 'show_all']  # noqa: E501
