...
class Configuration(six.with_metaclass(TypeWithDefault, object)):
    ...
    def __init__(self, host="https://api.dallas-idc.com",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("limestone")
    ...
    def get_host_settings(self):
        ...
        return [
            {
                'url': "https://api.dallas-idc.com",
                'description': "Limestone Network API Host",
            }
        ]
