...
def sph_har(t, p, n, m):
    r"""Evaluate the **real**, **normalized**, spherical harmonic of degree n and
    order m.
...
def grad_sph_har(t, p, n, m, R=1):
    r"""Evaluates the gradient of the real, normalized, spherical harmonics defined in :func:`sph_har`
...
class Expansion:
    ...
    def __init__(self, a, yn, ym):
        """initialize a spherical harmonic expansion
        args:
            """
