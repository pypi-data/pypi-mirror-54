...
def get_summary(**kwargs):
    ...
    if not summary:
        log.warning("Extracting dirty summary: %s", img_path)
...
def rename_file(**kwargs):
    ...
    try:
        ...
        log.warning("Error, file name is to long: %s", img_path)
...
def raw_screenshots_namer(path=None, ignore_named=False, recursive=False):
