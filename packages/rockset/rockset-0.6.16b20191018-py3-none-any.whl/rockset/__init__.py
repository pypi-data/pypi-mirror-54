...
def compare_rockset_versions(installed_version, latest_version):
    ...
    if conformed_installed_version < conformed_latest_version:
        print('Warning: newer version {} available. Please upgreade'.
...
def version():
    ...
    compare_rockset_versions(version, latest_version)
    return version
