...
id = "02567f55b2a087d36ba3cb1f34157e8baaea00b8"
date = "2019-10-24 13:44:00 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "02567f55b2a087d36ba3cb1f34157e8baaea00b8":
        return
    msg = "Program id (02567f55b2a087d36ba3cb1f34157e8baaea00b8) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
