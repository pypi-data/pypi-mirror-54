...
#Daten die ich aus InstaPy geholt hab, hab nur einige Quaries zur Erstellung der Datenbank verwendet.
...
SQL_CREATE_RECORD_ACTIVITY_TABLE = """
    CREATE TABLE IF NOT EXISTS `recordActivity` (
        ...
        `comments` INTEGER UNSIGNED NOT NULL,
        `follows` INTEGER UNSIGNED NOT NULL,
        `unfollows` INTEGER UNSIGNED NOT NULL,
        `server_calls` INTEGER UNSIGNED NOT NULL,
