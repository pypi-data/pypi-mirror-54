...
class Pulp2contentApi(object):
    ...
    def read_with_http_info(self, pulp2_content_href, **kwargs):  # noqa: E501
        ...
        if ('pulp2_content_href' not in local_var_params or
                local_var_params['pulp2_content_href'] is None):
