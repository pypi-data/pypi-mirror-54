...
void btKinematicCharacterController::addGhostObject(btPairCachingGhostObject* ghostObject)
{
	m_ghostObject2 = ghostObject;
}
...
bool btKinematicCharacterController::recoverFromPenetration ( btCollisionWorld* collisionWorld)
{
	...
	if(m_ghostObject2)
	{
		collisionWorld->getDispatcher()->dispatchAllCollisionPairs(m_ghostObject2->getOverlappingPairCache(), collisionWorld->getDispatchInfo(), collisionWorld->getDispatcher());
	}
	...
	if(m_ghostObject2) m_ghostObject2->setWorldTransform(newTrans);
