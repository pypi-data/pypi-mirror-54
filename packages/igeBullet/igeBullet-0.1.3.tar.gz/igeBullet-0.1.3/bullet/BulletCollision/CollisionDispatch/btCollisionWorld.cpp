			...
			if ((colObj->getCollisionFlags() & btCollisionObject::CF_DISABLE_VISUALIZE_OBJECT)==0)
			{
				if (getDebugDrawer() && getDebugDrawer()->getDebugMode() & btIDebugDraw::DBG_DrawWireframe)
				{
					...
					case  ACTIVE_TAG:
						...
						#else
							color = btVector3(
								btScalar((float)(((int)(colObj))%50 +50)/100.0f),
								btScalar((float)(((int)(colObj)>>5)%50 +50)/100.0f),
								btScalar((float)(((int)(colObj)>>10)%50 +50)/100.0f)); break;
						#endif
					...
					case ISLAND_SLEEPING:
						...
						#else
							color = btVector3(
								btScalar((float)(((int)(colObj))%50 +20)/100.0f),
								btScalar((float)(((int)(colObj)>>5)%50 +20)/100.0f),
								btScalar((float)(((int)(colObj)>>10)%50 +20)/100.0f)); break;
						#endif
