...
///@todo: check out alignment methods for other platforms/compilers
	...
	#if defined(SN_TARGET_PSP2) || defined(__ANDROID__) || defined(__APPLE_CC__) || defined(__ORBIS__)
		#define BT_HAS_ALIGNED_ALLOCATOR
		#define SIMD_FORCE_INLINE __inline__
		#define ATTRIBUTE_ALIGNED16(a) a __attribute__((aligned(16)))
		#define ATTRIBUTE_ALIGNED64(a) a __attribute__((aligned(64)))
		#define ATTRIBUTE_ALIGNED128(a) a __attribute__((aligned(128)))
	#else
	...
	//btFullAssert is optional, slows down a lot
	#define btFullAssert(x)
	#if defined(SN_TARGET_PSP2) || defined(__ANDROID__) || defined(__ORBIS__)
		#define btLikely(_c) __builtin_expect(_c,1)
		#define btUnlikely(_c) __builtin_expect(_c,0)
	#else
		#define btLikely(_c)  _c
...
{
#if defined(__ANDROID__)||defined(SN_TARGET_PSP2)||defined(__ORBIS__)
	return atan2f(y,x);
#else
...
{
#if defined(WIN32) || defined(SN_TARGET_PSP2) || defined(__ANDROID__) || defined(__APPLE_CC__) || defined(__ORBIS__)
	return true;
#else
	long int i = 1;
