    ...
    def find_sprites(self):
        ...
        for i in range(len(pixels)):
            for j in range(len(pixels[0])):
                if pixels[i, j].tolist() != self.background_color and not label_map[i, j]:
                    label += 1
                    ...
                    while curr_pixels:
                        ...
                        for (x, y) in direction:
                            if 0 <= (pixel[0] + x) < len(pixels) and 0 <= (pixel[1] + y) < len(pixels[0]) \
                                and pixels[pixel[0] + x, pixel[1] + y].tolist() != list(self.background_color) \
                                and not label_map[pixel[0] + x, pixel[1] + y]:
                                label_map[pixel[0] + x, pixel[1] + y] = label_map[pixel[0], pixel[1]]
                                curr_pixels.append((pixel[0] + x, pixel[1] + y))
                                sprites[label].append((pixel[0] + x, pixel[1] + y))
        ...
        # pprint.pprint(label_map.tolist(), width=450)
