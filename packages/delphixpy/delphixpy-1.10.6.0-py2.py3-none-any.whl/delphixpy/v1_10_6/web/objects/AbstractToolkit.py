...
class AbstractToolkit(NamedUserObject):
    ...
    *(extends* :py:class:`v1_10_6.web.vo.NamedUserObject` *)* An installed
    ...
    def is_dirty(self):
        return any([self._pretty_name[1], self._name[1], self._language[1], self._root_squash_enabled[1], self._build_api[1], self._messages[1], self._host_types[1], self._version[1], self._default_locale[1], self._snapshot_schema[1]])
