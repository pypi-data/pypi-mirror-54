...
class ASELinkedSource(ASESource):
    ...
    *(extends* :py:class:`delphixpy.web.vo.ASESource` *)* A linked SAP ASE
    ...
    def is_dirty(self):
        return any([self._operations[1], self._load_backup_path[1], self._external_file_path[1], self._validated_sync_mode[1], self._load_location[1], self._staging_source[1], self._dump_history_file_enabled[1], self._runtime[1], self._config[1], self._dump_credentials[1]])
