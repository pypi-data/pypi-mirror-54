...
class Toolkit(AbstractToolkit):
    ...
    *(extends* :py:class:`delphixpy.web.vo.AbstractToolkit` *)* An installed
    ...
    def is_dirty(self):
        return any([self._linked_source_definition[1], self._virtual_source_definition[1], self._resources[1], self._discovery_definition[1], self._upgrade_definition[1]])
