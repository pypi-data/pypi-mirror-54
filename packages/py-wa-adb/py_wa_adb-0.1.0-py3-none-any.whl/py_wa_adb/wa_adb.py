...
class WA_ADB(object):
    ...
    # rb"(?P<_id>\d+)\|(?P<key_remote_jid>.+?)\|(?P<key_from_me>\d+)\|(?P<key_id>.*?)\|(?P<status>\d+)\|(?P<data>[\s\S]+)\|(?P<timestamp>\d+?)\n"
    # rb"(?P<_id>\d+)\|(?P<key_remote_jid>.+?)\|(?P<key_from_me>.+?)\|(?P<key_id>.*?)\|(?P<status>.*?)\|(?P<data>.*?)\|(?P<timestamp>\d+?)"

    """
    rb"(?P<_id>\d+)\|(?P<key_remote_jid>.+?)\|(?P<key_from_me>.*?)\|(?P<key_id>.*?)\|(?P<status>.*?)\|"\
    rb"(?P<needs_push>.*?)\|(?P<data>.*?)\|(?P<timestamp>.*?)\|(?P<media_url>.*?)\|(?P<media_mime_type>.*?)\|(?P<media_wa_type>.*?)\|"\
    rb"(?P<media_size>.*?)\|(?P<media_name>.*?)\|(?P<media_caption>.*?)\|(?P<media_hash>.*?)\|(?P<media_duration>.*?)\|"\
    rb"(?P<origin>.*?)\|(?P<latitude>.*?)\|(?P<longitude>.*?)\|(?P<thumb_image>.*?)\|(?P<remote_resource>.*?)\|(?P<received_timestamp>.*?)\|"\
    rb"(?P<send_timestamp>.*?)\|(?P<receipt_server_timestamp>.*?)\|(?P<receipt_device_timestamp>.*?)\|(?P<read_device_timestamp>.*?)\|(?P<played_device_timestamp>.*?)\|"\
    rb"(?P<raw_data>.*?)\|(?P<recipient_count>.*?)\|(?P<participant_hash>.*?)\|(?P<starred>.*?)\|(?P<quoted_row_id>.*?)\|(?P<mentioned_jids>.*?)\|"\
    rb"(?P<multicast_id>.*?)\|(?P<edit_version>.*?)\|(?P<media_enc_hash>.*?)\|(?P<payment_transaction_id>.*?)\|(?P<forwarded>.*?)\|"\
    rb"(?P<preview_type>.*?)\|(?P<send_count>\d*)\n" 
    """
