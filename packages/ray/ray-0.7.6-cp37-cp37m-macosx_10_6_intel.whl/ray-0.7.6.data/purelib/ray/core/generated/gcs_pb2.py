...
_ACTORTABLEDATA = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='node_manager_id', full_name='ray.rpc.ActorTableData.node_manager_id', index=4,
      ...
      serialized_options=None, json_name='nodeManagerId', file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='state', full_name='ray.rpc.ActorTableData.state', index=5,
    ...
    _descriptor.FieldDescriptor(
      name='max_reconstructions', full_name='ray.rpc.ActorTableData.max_reconstructions', index=6,
    ...
    _descriptor.FieldDescriptor(
      name='remaining_reconstructions', full_name='ray.rpc.ActorTableData.remaining_reconstructions', index=7,
    ...
    _descriptor.FieldDescriptor(
      name='ip_address', full_name='ray.rpc.ActorTableData.ip_address', index=8,
    ...
    _descriptor.FieldDescriptor(
      name='port', full_name='ray.rpc.ActorTableData.port', index=9,
    ...
    _descriptor.FieldDescriptor(
      name='is_direct_call', full_name='ray.rpc.ActorTableData.is_direct_call', index=10,
...
ResourceTableData = _reflection.GeneratedProtocolMessageType('ResourceTableData', (_message.Message,), dict(
...
GcsNodeInfo = _reflection.GeneratedProtocolMessageType('GcsNodeInfo', (_message.Message,), dict(
