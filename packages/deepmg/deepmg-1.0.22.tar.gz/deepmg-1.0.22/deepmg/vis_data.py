...
try:
    from utils import textcolor_display as text_display
except ImportError:
    from deepmg.utils import textcolor_display as text_display
...
def build_breaks (data,type_bin,num_bin=10,max_v=1,min_v=0):
    ...
    if type_bin == 'eqf':
        # step 1: flaten
        data_f = data.flatten()
        # step 2 remove 0 or values which is not counted as an appearance of feature in sample --> data_non0
