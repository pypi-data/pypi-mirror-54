...
from keylimepie.analysis.models import diskmodel, slabmodel
...
class outputgrid:
    ...
    def __init__(self, path, modeltype='disk', molecule=None, **kwargs):
        ...
        self.opacities = kwargs.get('opacities', os.path.join(self.aux,'jena_thin_e6.tab'))
    ...
    def levelpop(self, level):
        ...
        if level not in list(self.gridded['levels'].keys()):
    ...
    #
    # Use cell_intensity(EnergyLevel) to call the cell intensities for each cell.
    ...
    def fluxweighted(self, param, level, **kwargs):
        ...
        if param not in list(self.gridded.keys()):
