...
class ModelMetrics(object):
    ...
    def get_positive_predictive_indexes(self, class_name):
        ...
        return [
            ...
            for x in self.knowledgepack.get_positive_predictive_indexes(class_name)
        ]
    ...
    def get_false_positive_indexes(self, class_name):
        ...
        return [
            self.validation_set[x]
            for x in self.knowledgepack.get_false_positive_indexes(class_name)
        ]
    ...
    def get_true_positive_indexes(self, class_name):
        ...
        return [
            self.validation_set[x]
            for x in self.knowledgepack.get_true_positive_indexes(class_name)
        ]
