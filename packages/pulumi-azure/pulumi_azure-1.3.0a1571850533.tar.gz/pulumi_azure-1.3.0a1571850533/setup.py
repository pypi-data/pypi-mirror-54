...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v1.3.0-alpha.1571850533+g549abc6a'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v1.3.0-alpha.1571850533+g549abc6a`
                """)
            else:
                raise
