...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v1.4.0-alpha.1572381815+gaf12e3eb'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v1.4.0-alpha.1572381815+gaf12e3eb`
                """)
            else:
                raise
