...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v1.4.0-alpha.1572400586+g261c0c2d'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v1.4.0-alpha.1572400586+g261c0c2d`
                """)
            else:
                raise
