...
class S3Wrapper(Base):
    ...
    def upload(self, file_handle, uuid):
        ...
        with timer.time("s3_upload"):
            ...
            s3_config = self._generate_s3_values_for_type(
    ...
    def _generate_s3_values_for_type(self, config: dict, uuid: UUID) -> dict:
    ...
    def get_download_url(
        ...
        s3_config = self._generate_s3_values_for_type(config=config, uuid=uuid)
