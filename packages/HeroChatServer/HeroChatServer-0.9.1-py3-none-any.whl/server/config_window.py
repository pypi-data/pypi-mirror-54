"""File for config window class. Based on PyQt5 classes."""
...
class ConfigWindow(QDialog):
    """Config window constructor. Based on PyQt5 QDialog."""
    ...
    def initUI(self):
        ...
        self.db_path_label = QLabel('Database file: ', self)
        ...
        self.ip_label = QLabel('IPv4 Connections: ', self)
        self.ip_label.move(10, 148)
        self.ip_label.setFixedSize(180, 15)

        self.ip_label_note = QLabel('Leave it empty to receive all connections', self)
    ...
    def open_file_dialog(self):
        """Open dialog to get directory. Based on QFileDialog."""
        global dialog
    ...
    def save_server_config(self):
        """Saving method. Check values and save settings."""
        ...
        try:
            ...
            if 1023 < port < 65536:
                ...
                with open(f"{dir_path}/{'server.ini'}", 'w') as conf:
                    ...
                    message.information(self, 'OK', 'Successfully saved!')
            else:
                message.warning(self, 'Error', 'Port must be from 1024 to 65536')
