...
class UpgradeFrom900To910(UpgradeStep):
    FROM = semver.parse_version_info('9.0.0')  # type: semver.VersionInfo
    TO = semver.parse_version_info('9.1.0')  # type: semver.VersionInfo

    @info_function_start_finish('Upgrade From 9.0.0 To 9.1.0')
    def process(self):
        # type: () -> None
