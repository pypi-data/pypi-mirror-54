...
function GetOciSubcommands_compute() {
    $ociSubcommands = @{
        'compute' = 'boot-volume-attachment console-history dedicated-vm-host dedicated-vm-host-instance device image instance instance-console-connection pic shape vnic-attachment volume-attachment'
