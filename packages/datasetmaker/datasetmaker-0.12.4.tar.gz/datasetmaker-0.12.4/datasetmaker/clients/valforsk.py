        ...
        self.data = [
            {
                ...
                'datapoints': [
                    {
                        'measures': ['valforsk_samplesize'],
                        'keys': ['pollster', 'day']
                    },
                    {
                        'measures': ['valforsk_opinion_value'],
                        'keys': ['party', 'pollster', 'day']
                    }
                ]
            },
            {
                ...
                'datapoints': [
                    {
                        'measures': ['valforsk_issue_position'],
                        'keys': ['valforsk_issue', 'party', 'year']
                    }
                ]
            },
            {
        ...
        for i, data in enumerate(self.data):
            ...
            if data['datapoints']:
                for datapoints in data['datapoints']:
                    package.set_datapoints(**datapoints)
