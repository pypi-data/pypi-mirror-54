...
DEFAULT_SPM_PATH = "gs://t5-data/vocabs/{}/sentencepiece.model"  # GCS
...
for config_suffix in _c4_config_suffixes:
  TaskRegistry.add(
      ...
      sentencepiece_model_path=DEFAULT_SPM_PATH.format("cc_all.32000"),
      metric_fns=[])
...
for prefix, b, tfds_version in b_configs:
  TaskRegistry.add(
      ...
      sentencepiece_model_path=DEFAULT_SPM_PATH.format(
          "cc_all.32000"))
