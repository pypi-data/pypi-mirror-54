...
class UserProfile(models.Model):
    ...
    def get_student_list(self):
        ...
        if self.is_role("lecturer"):
            filter2 = Q(userprofile__lecturer=self) | (
                    Q(userprofile__user_class__assistant__userprofile__lecturer=self) & ~Q(
                userprofile__user__groups__name__in=self.get_assistant_groupname_list()))
        else:
            filter2 = Q(pk=None)
        # 助教
