...
if __name__ == '__main__':
    ...
    parametros_recSim = dict(temperatura=[1.0], iteraciones_inyeccion_temperatura=[50],
                             maximo_inyecciones_temperatura=[5])

    lista_bloque_parametros_armonica = genera_lista_ejecuciones_heuristicas(parametros_recSim, repeticiones=1)

    inicia_exploracion_heuristica(recSim, lista_bloque_parametros_armonica, nucleos_cpu=1)
