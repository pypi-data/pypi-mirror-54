...
setup(
    ...
    url='https://github.com/Marcnuth/tensorflow-play',
    ...
    description="The lightweight engineering TensorFlow wrapper for AI engineer. Write less, Reuse more, Scale easily.",
