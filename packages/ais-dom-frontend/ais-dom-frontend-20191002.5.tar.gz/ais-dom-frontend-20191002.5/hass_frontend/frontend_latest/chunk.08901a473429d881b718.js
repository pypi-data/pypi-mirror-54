/*! For license information please see chunk.08901a473429d881b718.js.LICENSE */
(self.webpackJsonp=self.webpackJsonp||[]).push([[28],{195:function(t,e,i){"use strict";var s=i(3),o=i(0),a=(i(222),i(206));const r=customElements.get("mwc-switch");let c=class extends r{firstUpdated(){super.firstUpdated(),this.style.setProperty("--mdc-theme-secondary","var(--primary-color)"),this.classList.toggle("slotted",Boolean(this._slot.assignedNodes().length))}static get styles(){return[a.a,o.c`
        :host {
          display: flex;
          flex-direction: row;
          align-items: center;
...
//# sourceMappingURL=chunk.08901a473429d881b718.js.map