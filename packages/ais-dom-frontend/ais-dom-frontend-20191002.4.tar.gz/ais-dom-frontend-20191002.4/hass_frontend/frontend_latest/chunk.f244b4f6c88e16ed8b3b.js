...
`},727:function(e,t,i){"use strict";i.r(t),i.d(t,"HuiWeatherForecastCardEditor",function(){return r});var a=i(3),n=i(0),s=(i(191),i(196)),o=i(18),c=i(208);const l=Object(s.a)({type:"string",entity:"string?",name:"string?"});let r=class extends n.a{setConfig(e){e=l(e),this._config=e}get _entity(){return this._config.entity||""}get _name(){return this._config.name||""}render(){return this.hass?n.f`
      ${c.a}
    ...
    `:n.f``}_valueChanged(e){if(!this._config||!this.hass)return;const t=e.target;this[`_${t.configValue}`]!==t.value&&(t.configValue&&(""===t.value?delete this._config[t.configValue]:this._config=Object.assign(Object.assign({},this._config),{[t.configValue]:t.value})),Object(o.a)(this,"config-changed",{config:this._config}))}};Object(a.c)([Object(n.g)()],r.prototype,"hass",void 0),Object(a.c)([Object(n.g)()],r.prototype,"_config",void 0),r=Object(a.c)([Object(n.d)("hui-weather-forecast-card-editor")],r)}}]);
//# sourceMappingURL=chunk.f244b4f6c88e16ed8b3b.js.map