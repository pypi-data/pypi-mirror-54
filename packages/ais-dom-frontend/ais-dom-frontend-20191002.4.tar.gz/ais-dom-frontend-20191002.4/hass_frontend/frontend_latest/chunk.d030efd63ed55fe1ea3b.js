/*! For license information please see chunk.d030efd63ed55fe1ea3b.js.LICENSE */
(self.webpackJsonp=self.webpackJsonp||[]).push([[119],{113:function(e,t,i){"use strict";i(5);var n=i(94),o=i(61),a=i(6),r=i(1),s=i(4);Object(a.a)({_template:s.a`
    <style>
      :host {
...
`,is:"paper-item",behaviors:[a.a]})},144:function(e,t,i){"use strict";i(45),i(68),i(42),i(54);const n=document.createElement("template");n.setAttribute("style","display: none;"),n.innerHTML="<dom-module id=\"paper-item-shared-styles\">\n  <template>\n    <style>\n      :host, .paper-item {\n        display: block;\n        position: relative;\n        min-height: var(--paper-item-min-height, 48px);\n        padding: 0px 16px;\n      }\n\n      .paper-item {\n        @apply --paper-font-subhead;\n        border:none;\n        outline: none;\n        background: white;\n        width: 100%;\n        text-align: left;\n      }\n\n      :host([hidden]), .paper-item[hidden] {\n        display: none !important;\n      }\n\n      :host(.iron-selected), .paper-item.iron-selected {\n        font-weight: var(--paper-item-selected-weight, bold);\n\n        @apply --paper-item-selected;\n      }\n\n      :host([disabled]), .paper-item[disabled] {\n        color: var(--paper-item-disabled-color, var(--disabled-text-color));\n\n        @apply --paper-item-disabled;\n      }\n\n      :host(:focus), .paper-item:focus {\n        position: relative;\n        outline: 0;\n\n        @apply --paper-item-focused;\n      }\n\n      :host(:focus):before, .paper-item:focus:before {\n        @apply --layout-fit;\n\n        background: currentColor;\n        content: '';\n        opacity: var(--dark-divider-opacity);\n        pointer-events: none;\n\n        @apply --paper-item-focused-before;\n      }\n    </style>\n  </template>\n</dom-module>",document.head.appendChild(n.content)},145:function(e,t,i){"use strict";i(5),i(42);var n=i(123),o=i(6),a=i(4);Object(o.a)({_template:a.a`
    ...
    <slot></slot>
`,is:"paper-listbox",behaviors:[n.a],hostAttributes:{role:"listbox"}})},147:function(e,t,i){"use strict";i(5);var n=i(31),o=i(35),a=i(87),r=i(122),s=i(6),l=i(1),c=i(4);Object(s.a)({_template:c.a`
    <style>
      :host {
        position: fixed;
      }
...
<div id="checkboxLabel"><slot></slot></div>`;l.setAttribute("strip-whitespace",""),Object(a.a)({_template:l,is:"paper-checkbox",behaviors:[n.a],hostAttributes:{role:"checkbox","aria-checked":!1,tabindex:0},properties:{ariaActiveAttribute:{type:String,value:"aria-checked"}},attached:function(){Object(s.a)(this,function(){if("-1px"===this.getComputedStyleValue("--calculated-paper-checkbox-ink-size").trim()){var e=this.getComputedStyleValue("--calculated-paper-checkbox-size").trim(),t="px",i=e.match(/[A-Za-z]+$/);null!==i&&(t=i[0]);var n=parseFloat(e),o=8/3*n;"px"===t&&(o=Math.floor(o))%2!=n%2&&o++,this.updateStyles({"--paper-checkbox-ink-size":o+t})}})},_computeCheckboxClass:function(e,t){var i="";return e&&(i+="checked "),t&&(i+="invalid"),i},_computeCheckmarkClass:function(e){return e?"":"hidden"},_createRipple:function(){return this._rippleContainer=this.$.checkboxContainer,o.b._createRipple.call(this)}})},175:function(e,t,i){"use strict";var n=i(9);t.a=Object(n.a)(e=>(class extends e{static get properties(){return{hass:Object,localize:{type:Function,computed:"__computeLocalize(hass.localize)"}}}__computeLocalize(e){return e}}))},177:function(e,t,i){"use strict";var n=i(3),o=i(0);class a extends o.a{static get styles(){return o.c`
    ...
    `}render(){return o.f`
      ${this.header?o.f`
          ...
          `:o.f``}
      <slot></slot>
    `}}Object(n.c)([Object(o.g)()],a.prototype,"header",void 0),customElements.define("ha-card",a)},182:function(e,t,i){"use strict";i(5),i(45),i(42),i(54);var n=i(6),o=i(4);Object(n.a)({_template:o.a`
    <style>
      :host {
    ...
    <slot></slot>
`,is:"paper-item-body"})},186:function(e,t,i){"use strict";i(5),i(45),i(54),i(144);var n=i(6),o=i(4),a=i(119);Object(n.a)({_template:o.a`
    ...
    <slot></slot>
`,is:"paper-icon-item",behaviors:[a.a]})},211:function(e,t,i){"use strict";i(5),i(45);var n=i(6),o=i(1),a=i(4),r=i(129);Object(n.a)({_template:a.a`
    <style>
      :host {
        display: block;
        /**
...
`,is:"app-header-layout",behaviors:[r.a],properties:{hasScrollingRegion:{type:Boolean,value:!1,reflectToAttribute:!0}},observers:["resetLayout(isAttached, hasScrollingRegion)"],get header(){return Object(o.a)(this.$.headerSlot).getDistributedNodes()[0]},_updateLayoutStates:function(){var e=this.header;if(this.isAttached&&e){this.$.wrapper.classList.remove("initializing"),e.scrollTarget=this.hasScrollingRegion?this.$.contentContainer:this.ownerDocument.documentElement;var t=e.offsetHeight;this.hasScrollingRegion?(e.style.left="",e.style.right=""):requestAnimationFrame(function(){var t=this.getBoundingClientRect(),i=document.documentElement.clientWidth-t.right;e.style.left=t.left+"px",e.style.right=i+"px"}.bind(this));var i=this.$.contentContainer.style;e.fixed&&!e.condenses&&this.hasScrollingRegion?(i.marginTop=t+"px",i.paddingTop=""):(i.paddingTop=t+"px",i.marginTop="")}}})},227:function(e,t,i){"use strict";function n(e,t){return e&&-1!==e.config.components.indexOf(t)}i.d(t,"a",function(){return n})},288:function(e,t,i){"use strict";i(108);var n=i(4),o=i(30),a=i(118),r=i(227),s=i(18);customElements.define("ha-start-voice-button",class extends(Object(a.a)(o.a)){static get template(){return n.a`
      ...
      ></paper-icon-button>
    `}static get properties(){return{hass:{type:Object,value:null},canListen:{type:Boolean,computed:"computeCanListen(hass)",notify:!0}}}computeCanListen(e){return"webkitSpeechRecognition"in window&&Object(r.a)(e,"conversation")&&"https:"===location.protocol}handleListenClick(){Object(s.a)(this,"show-dialog",{dialogImport:()=>i.e(153).then(i.bind(null,340)),dialogTag:"ha-voice-command-dialog"})}})},690:function(e,t,i){"use strict";i.r(t);i(211),i(218),i(150),i(155),i(108),i(93),i(186),i(182),i(143),i(145),i(147);var n=i(4),o=i(30),a=(i(130),i(288),i(177),i(175));customElements.define("ha-panel-shopping-list",class extends(Object(a.a)(o.a)){static get template(){return n.a`
...
//# sourceMappingURL=chunk.d030efd63ed55fe1ea3b.js.map