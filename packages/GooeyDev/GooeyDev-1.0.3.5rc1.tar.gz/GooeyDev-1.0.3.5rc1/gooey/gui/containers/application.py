...
class GooeyApplication(wx.Frame):
    ...
    def __init__(self, buildSpec, *args, **kwargs):
        ...
        pub.subscribe(events.WINDOW_CMD, self.onPrintCMD)
    ...
    def onPrintCMD(self,*args,**kwarg):
        print("HIEEE!")
        with transactUI(self):
            ...
            if config.isValid():
                self.showConsole()
                self.console.appendText("CLI: " + self.buildCliString())
                print("Hoooo!")
    ...
    def showSettings(self):
        ...
        self.footer.showButtons('print_cmd_button','cancel_button', 'start_button')
