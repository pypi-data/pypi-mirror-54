from datalogue.clients.http import _HttpClient, Union, Optional
...
class Dtl:
    ...
    @staticmethod
    def signup(uri='', first_name='', last_name='', email='', password='', accept_terms=True, ca_certificate: Optional[str] = None) -> Union[DtlError, User]:
        """
