...
class NodeClassifications:
    def __init__(self, schema_node_id: UUID, ontology_node_ids: List[UUID]):
        self.schema_node_id = schema_node_id
        self.ontology_node_ids = ontology_node_ids

    def __repr__(self):
        return (f'{self.__class__.__name__}('
                f'schema_node_id: {self.schema_node_id!r}, '
                f'ontology_node_ids: {self.ontology_node_ids!r}')
    ...
    def _as_payload(self) -> Union[DtlError, dict]:
        ...
        return {
            ...
            "userClassifications": list(map(lambda ontology_node_id: {"ontologyNodeId": str(ontology_node_id)},
                                            self.ontology_node_ids))
        }
