...
class Classify(Transformation):
    ...
    def __init__(self, training_id: UUID, paths: Optional[List[List[str]]] = None, use_context: bool = False, include_classes: bool = False,
        ...
        :param training_id: id of the training that this Classify transformation is going to use
    ...
    def _as_payload(self) -> dict:
        ...
        base["modelIdentifier"] = str(self.training_id)
...
def _classify_from_payload(json: dict) -> Union[DtlError, Classify]:
    ...
    training_id = parse_uuid(json, "modelIdentifier")
    ...
    return Classify(training_id, paths, use_context, include_classes, include_score, replace_class, datastore_collection_name)
