...
class Job:
    def __init__(self, stream_id: UUID, run_at: datetime, status: JobStatus, stream_collection_id: UUID, id: UUID, remaining_time_millis: int, percentage_progress: int, created_by: UUID, details: str, ended_at: Optional[datetime]):
