...
class SimpleMiddleware (MiddlewareMixin ):#line:12
    def process_request (self ,request ):#line:14
        O0OO00O0O000O00OO =request .path #line:16
        if not O0OO00O0O000O00OO .endswith ('/'):#line:17
            O0OO00O0O000O00OO =O0OO00O0O000O00OO +'/'#line:18
        if O0OO00O0O000O00OO .endswith ('group/action/'):#line:20
            return view .action (request )#line:21
        elif O0OO00O0O000O00OO .endswith ('simplepro/active/'):#line:22
            return backends .process_lic (request )#line:23
        elif O0OO00O0O000O00OO .endswith ('simplepro/info/'):#line:24
