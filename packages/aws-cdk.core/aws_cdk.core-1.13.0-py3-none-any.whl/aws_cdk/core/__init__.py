...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/core", "1.13.0", __name__, "core@1.13.0.jsii.tgz")
...
class Stack(Construct, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/core.Stack"):
    ...
    def __init__(self, scope: typing.Optional["Construct"]=None, name: typing.Optional[str]=None, *, description: typing.Optional[str]=None, env: typing.Optional["Environment"]=None, stack_name: typing.Optional[str]=None, tags: typing.Optional[typing.Mapping[str,str]]=None) -> None:
        """Creates a new stack.
