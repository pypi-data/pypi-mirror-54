...
placeholders = {
    'accessCode1': itkdb.settings.ITK_DB_CODE1,
    'accessCode2': itkdb.settings.ITK_DB_CODE2,
}
...
with betamax.Betamax.configure() as config:
    config.cassette_library_dir = itkdb.settings.CASSETTE_LIBRARY_DIR
...
def auth_user():
    ...
    with betamax.Betamax(
        user._session, cassette_library_dir=itkdb.settings.CASSETTE_LIBRARY_DIR
