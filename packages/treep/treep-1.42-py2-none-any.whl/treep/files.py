...
def _get_workspace_path(starting_dir=None):

    root,_ = _find_root(starting_dir)
...
def read_configuration_files(starting_dir=None):

    all_projects = {}
    all_repositories = {}

    root,configuration_folders = _find_root(starting_dir)
    ...
    workspace_path = _get_workspace_path(starting_dir)
