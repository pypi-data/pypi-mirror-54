...
from docutils.languages import it
...
def waitProcesses(asProcIdList):
    ...
    if not isinstance(asProcIdList , collections.Sequence):
        _log("[WARNING] waitProcesses asProcIdList is not a list, return empty list")
        return asReturnStatus;
    
    # Temporary List
    asProcessesToCheck = asProcIdList; 
    ...
    while (iProcessCount >0):
        ...
        for iProcessIndex in xrange(iProcessCount):
