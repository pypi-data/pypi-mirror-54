...
def django_greater_than(version):
    ...
    DJANGO_VERSION = re.match(r'\d.\d+', DJANGO_VERSION)
    DJANGO_VERSION = DJANGO_VERSION.group()
...
def is_number(field):
    return isinstance(field, (IntegerField, SmallIntegerField, PositiveIntegerField,
                              PositiveSmallIntegerField, BigIntegerField, CommaSeparatedIntegerField, DecimalField,
                              FloatField))
