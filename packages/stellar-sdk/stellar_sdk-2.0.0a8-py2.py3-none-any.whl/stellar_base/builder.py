...
class Builder(object):
    ...
    @classmethod
    def challenge_tx(cls, server_secret, client_account_id, anchor_name, network='TESTNET', timeout=300):
        ...
        :param str anchor_name: Anchor's name to be used in the manage_data key.
        :param str network: The network to connect to for verifying and retrieving
            additional attributes from. 'PUBLIC' is an alias for 'Public Global Stellar Network ; September 2015',
            'TESTNET' is an alias for 'Test SDF Network ; September 2015'. Defaults to TESTNET.
        ...
        nonce = os.urandom(64)
        transaction.append_manage_data_op(data_name='{} auth'.format(anchor_name), data_value=nonce,
