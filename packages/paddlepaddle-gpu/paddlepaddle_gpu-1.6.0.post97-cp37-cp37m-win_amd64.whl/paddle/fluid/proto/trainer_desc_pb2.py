...
_TRAINERDESC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='hogwild_param', full_name='paddle.framework.TrainerDesc.hogwild_param', index=16,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='downpour_param', full_name='paddle.framework.TrainerDesc.downpour_param', index=17,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='pull_dense_param', full_name='paddle.framework.TrainerDesc.pull_dense_param', index=18,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='section_param', full_name='paddle.framework.TrainerDesc.section_param', index=19,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='data_desc', full_name='paddle.framework.TrainerDesc.data_desc', index=20,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='adjust_ins_weight_config', full_name='paddle.framework.TrainerDesc.adjust_ins_weight_config', index=21,
