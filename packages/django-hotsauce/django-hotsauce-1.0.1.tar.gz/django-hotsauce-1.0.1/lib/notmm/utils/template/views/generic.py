...
from notmm.utils.template.requestcontext import RequestContext
from notmm.utils.template.utils import get_template_loader
from notmm.utils.template import TemplateException
...
log = configure_logging('notmm.utils.template')
