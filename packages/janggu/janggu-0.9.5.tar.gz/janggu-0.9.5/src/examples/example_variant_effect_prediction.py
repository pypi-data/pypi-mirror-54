...
gindexer = GenomicIndexer.create_from_file(varinatsfile, None, None)
...
plotGenomeTrack(cov, chrom, start, end).savefig('predicted_variant_effects_oct4.png')
...
plotGenomeTrack(cov,
                chrom, start, end).savefig('predicted_variant_effects_mafk.png')
