...
class UIWindow(QObject):
    ...
    def add_shortcut(self, key_sequence: str, action: callable):
        QShortcut(QKeySequence(key_sequence.upper()), self.window, action)
...
if __name__ == '__main__':
    ...
    app = QApplication()
    main_form = UIWindow('examples/adobe.ui', "examples/icon.png")
    main_form.show()
    sys.exit(app.exec_())
