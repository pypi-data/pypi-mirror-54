...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v1.5.0-alpha.1572013827+g0771fe6'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v1.5.0-alpha.1572013827+g0771fe6`
                """)
            else:
                raise
