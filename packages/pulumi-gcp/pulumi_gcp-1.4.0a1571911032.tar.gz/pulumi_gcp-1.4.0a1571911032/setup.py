...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v1.4.0-alpha.1571911032+g1c5d22e'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v1.4.0-alpha.1571911032+g1c5d22e`
                """)
            else:
                raise
