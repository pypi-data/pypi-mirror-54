...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v1.5.0-alpha.1572481793+gc085ce6'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v1.5.0-alpha.1572481793+gc085ce6`
                """)
            else:
                raise
