...
class test_nd_all(unittest.TestCase):
    ...
    def test_selective_attribute_nd(self):
        ...
        self.assertEqual('other', nd.info['interfaces']['Ethernet1/1']['neighbors']['2010:2:3::2']['origin'])
        # Check does not match
        self.assertNotEqual('static', nd.info['interfaces']['Ethernet1/1']['neighbors']['2010:2:3::2']['origin'])
    ...
    def test_missing_attributes_nd(self):
        ...
        with self.assertRaises(KeyError):
            interfaces = nd.info['interfaces']['Etherenet1/1']['neighbors']['2010:2:3::2']
