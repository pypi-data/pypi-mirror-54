...
class Bankcard4Eles(BoolDataBase):
    ...
    detail_service = 'bank_card_four_elements_detail'
    detail_mode = 'mode_bank_card_four_elements_detail'
    ...
    def generate_biz_data(cls,
                          ...
                          ident_number: str,
                          bank_card: str,
                          phone: str, is_detail_version: bool = False) -> Dict[str, Any]:
    ...
    def set_biz_data(self, name: str, ident_number: str, bankcard: str, phone: str, is_detail_version: bool = False) -> 'Bankcard4Eles':
        """
        ...
        :return:
        """
        self.biz_data = self.generate_biz_data(name, ident_number, bankcard, phone, is_detail_version=is_detail_version)
