...
class WebDriverOverrider():
    ...
    def override():
        ...
        def get_url(obj, url):
            RunReportContainer.add_report_csv_row(ActionStartedCsvRow())
            RunReportContainer.get_current_block_run_holder().proxyServer.new_har("panet.co.il", options={'captureHeaders': True, 'captureContent': True, 'captureCookies': True, 'captureBinaryContent': True, 'initialPageRef': True, 'initialPageTitle': True})
            try:
