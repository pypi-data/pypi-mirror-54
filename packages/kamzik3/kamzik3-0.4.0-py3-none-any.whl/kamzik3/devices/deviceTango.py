...
class DeviceTango(Device, DeviceProxy):
    ...
    def handle_configuration(self):
        ...
        for attribute in self.tango_attributes:
            ...
            self.attributes[attribute] = Attribute(value, readonly=not ta.nb_written,
                                                   description=tc.description,
                                                   default_type=default_type, set_function=set_function,
                                                   unit=tc.unit, min_value=min_value, max_value=max_value,
                                                   decimals=decimals)
...
class DeviceTangoLambdaDetector(DeviceTango):
    ...
    def handle_configuration(self):
        try:
            ...
            self.attributes["OperatingMode"] = Attribute(current_mode,
