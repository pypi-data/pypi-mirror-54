...
class DeviceKohzu(DeviceSocket):
    ...
    def _init_attributes(self):
        ...
        self.attributes.update({
            ...
            ATTR_MODULES: Attribute(None, readonly=True, default_type=np.uint16),
        })
...
class DeviceKohzuChannel(DeviceChannel):
    ...
    def _init_attributes(self):
        ...
        self.attributes.update({
            ATTR_STATE: Attribute(None, readonly=True, default_type=np.uint8, min_value=0, max_value=3),
            ATTR_EMERGENCY_STOP: Attribute(None, readonly=True, default_type=np.bool),
            ATTR_CWL: Attribute(None, readonly=True, default_type=np.bool),
            ATTR_CCWL: Attribute(None, readonly=True, default_type=np.bool),
            ATTR_ORG: Attribute(None, readonly=True, default_type=np.bool),
            ATTR_NORG: Attribute(None, readonly=True, default_type=np.bool),
            ATTR_REFERENCED: Attribute(None, readonly=True, default_type=np.bool),
            ATTR_ROTATION_CHANGE: Attribute(None, default_type=np.uint8, min_value=0, max_value=1,
                                            set_function=lambda v: self.set_sys(ATTR_ROTATION_CHANGE, v)),
            ATTR_SWAP_LIMITS: Attribute(None, default_type=np.uint8, min_value=0, max_value=1,
                                        set_function=lambda v: self.set_sys(ATTR_SWAP_LIMITS, v)),
            ATTR_ENCODER_READ: Attribute(None, default_type=np.int64, set_function=self.set_encoder_value),
            ATTR_PULSE_READ: Attribute(None, default_type=np.int64, set_function=self.set_pulse_value, unit="pulse"),
            ATTR_POSITION: Attribute(None, default_type=np.int64, set_function=self._move_absolute, unit="nm",
                                     set_value_when_set_function=False),
            ATTR_REFERENCING_METHOD: Attribute(None, default_type=np.uint8, min_value=1, max_value=15,
                                               set_function=lambda v: self.set_sys(ATTR_REFERENCING_METHOD, v)),
            ATTR_POSITION_LOWER_LIMIT: Attribute(None, default_type=np.int64, min_value=-134217728,
                                                 max_value=134217727, unit="nm",
                                                 set_function=lambda v: self.set_sys(ATTR_POSITION_LOWER_LIMIT, v)),
            ATTR_STEP_RESOLUTION: Attribute(500, default_type=np.int64, min_value=1,
                                            max_value=134217727, unit="nm"),
            ATTR_START_SPEED: Attribute(1, default_type=np.int32, min_value=1, max_value=2.5e6, unit="pulse/s",
                                        set_function=lambda v: self.write_speed_table(start_speed=v)),
            ATTR_TOP_SPEED: Attribute(1, default_type=np.int32, min_value=2, max_value=5e6, unit="pulse/s",
                                      set_function=lambda v: self.write_speed_table(top_speed=v)),
            ATTR_ACCELERATION_TIME: Attribute(1, default_type=np.int32, min_value=1, max_value=10e3, unit="ms",
                                              set_function=lambda v: self.write_speed_table(acceleration_time=v)),
            ATTR_DECELERATION_TIME: Attribute(1, default_type=np.int32, min_value=1, max_value=10e3, unit="ms",
                                              set_function=lambda v: self.write_speed_table(deceleration_time=v)),
            ATTR_ENCODER_RESOLUTION: Attribute(50, default_type=np.int64, min_value=1,
                                               max_value=134217727, unit="nm"),
            ATTR_POSITION_UPPER_LIMIT: Attribute(None, default_type=np.int64, min_value=-134217728,
                                                 max_value=134217727, unit="nm",
                                                 set_function=lambda v: self.set_sys(ATTR_POSITION_UPPER_LIMIT, v)),
            ATTR_MAXIMUM_VELOCITY: Attribute(None, default_type=np.uint32, min_value=2, max_value=5000000,
                                             set_function=lambda v: self.set_sys(ATTR_MAXIMUM_VELOCITY, v)),
            ATTR_ENCODER_CALC_NUM: Attribute(None, default_type=np.uint32, min_value=1, max_value=134217727,
                                             set_function=lambda v: self.set_sys(ATTR_ENCODER_CALC_NUM, v)),
            ATTR_ENCODER_CALC_DEN: Attribute(None, default_type=np.uint32, min_value=1, max_value=134217727,
                                             set_function=lambda v: self.set_sys(ATTR_ENCODER_CALC_DEN, v)),
            ATTR_FEEDBACK_CONTROL_TYPE: Attribute(None, default_type=DeviceKohzu.feedback_control_method.keys(),
                                                  set_function=lambda v: self.set_sys(ATTR_FEEDBACK_CONTROL_TYPE,
                                                                                      DeviceKohzu.feedback_control_method[
                                                                                          v])),
            ATTR_RETRY_COUNT: Attribute(None, default_type=np.uint16, min_value=1, max_value=10e3,
                                        set_function=lambda v: self.set_sys(ATTR_RETRY_COUNT, v)),
            ATTR_FEEDBACK_TIMEOUT: Attribute(None, default_type=np.uint16, min_value=1, max_value=10e3, unit="ms",
                                             set_function=lambda v: self.set_sys(ATTR_FEEDBACK_TIMEOUT, v)),
            ATTR_TRIGGER_SOURCE: Attribute(None, default_type=DeviceKohzu.trigger_source.keys(),
                                           set_function=lambda v: self.set_sys(ATTR_TRIGGER_SOURCE,
                                                                               DeviceKohzu.trigger_source[v])),
            ATTR_TRIGGER_EDGE: Attribute(None, default_type=DeviceKohzu.trigger_edge.keys(),
                                         set_function=lambda v: self.set_sys(ATTR_TRIGGER_EDGE,
                                                                             DeviceKohzu.trigger_edge[v])),
            ATTR_TRIGGER_PM_PITCH: Attribute(None, default_type=np.uint32, min_value=1, max_value=100e3,
                                             set_function=lambda v: self.set_sys(ATTR_TRIGGER_PM_PITCH, v)),
            ATTR_TRIGGER_ENC_PITCH: Attribute(None, default_type=np.uint32, min_value=1, max_value=100e3,
                                              set_function=lambda v: self.set_sys(ATTR_TRIGGER_ENC_PITCH, v)),
            ATTR_TRIGGER_PULSE_WIDTH: Attribute(None, default_type=DeviceKohzu.trigger_pulse_width.keys(),
                                                set_function=lambda v: self.set_sys(ATTR_TRIGGER_PULSE_WIDTH,
                                                                                    DeviceKohzu.trigger_pulse_width[
                                                                                        v])),
            ATTR_ENCODER_ADDING: Attribute(None, default_type=DeviceKohzu.encoder_adding.keys(),
                                           set_function=lambda v: self.set_sys(ATTR_ENCODER_ADDING,
                                                                               DeviceKohzu.encoder_adding[
                                                                                   v])),
            ATTR_TRIGGER_LOGIC: Attribute(None, default_type=DeviceKohzu.trigger_logic.keys(),
                                          set_function=lambda v: self.set_sys(ATTR_TRIGGER_LOGIC,
                                                                              DeviceKohzu.trigger_logic[
                                                                                  v])),
            ATTR_MOTOR_EXCITATION: Attribute(None, default_type=DeviceKohzu.motor_excitation.keys(),
                                             set_function=lambda v: self.set_sys(ATTR_MOTOR_EXCITATION,
                                                                                 DeviceKohzu.motor_excitation[
                                                                                     v])),
            ATTR_MOTOR_SELECTION: Attribute(None, default_type=DeviceKohzu.motor_selection.keys(),
                                            set_function=lambda v: self.set_sys(ATTR_MOTOR_SELECTION,
                                                                                DeviceKohzu.motor_selection[
                                                                                    v])),
            ATTR_MICROSTEP_SELECT: Attribute(None, default_type=DeviceKohzu.microstep_select.keys(),
                                             set_function=lambda v: self.set_sys(ATTR_MICROSTEP_SELECT,
                                                                                 DeviceKohzu.microstep_select[
                                                                                     v])),
            ATTR_STOP_TYPE: Attribute(None, default_type=DeviceKohzu.stop_type.keys(),
                                      set_function=lambda v: self.set_sys(ATTR_STOP_TYPE,
                                                                          DeviceKohzu.stop_type[
                                                                              v])),
            ATTR_ACCELERATION_PATTERN: Attribute(None, default_type=DeviceKohzu.accelerating_pattern.keys(),
                                                 set_function=lambda v: self.write_speed_table(
                                                     acceleration_pattern=v)),
            ATTR_READ_ENCODER: Attribute(True, readonly=False, default_type=np.bool),
            ATTR_VELOCITY: Attribute(0, default_type=np.int64, min_value=0, max_value=3e6, unit="nm/s",
