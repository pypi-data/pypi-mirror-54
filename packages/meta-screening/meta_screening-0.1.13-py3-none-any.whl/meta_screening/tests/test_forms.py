...
class ScreeningTestMixin:
    ...
    def complete_part_one(self, hospital_identifier=None, **options):
        ...
        return ScreeningPartOne.objects.get(
...
class TestForms(ScreeningTestMixin, TestCase):
    ...
    def test_screening_ok(self):
        ...
        form = ScreeningPartTwoForm(
            data=part_two_eligible_options,
            instance=instance)
        form.is_valid()
        self.assertEqual(form._errors, {})
        form.save()
        ...
        form = ScreeningPartThreeForm(
            data=part_three_eligible_options,
            instance=instance)
        form.is_valid()
        self.assertEqual(form._errors, {})
        form.save()
    ...
    def test_screening_two_urine_bhcg_pregnant_na(self):
        instance = self.complete_part_one(
            gender=FEMALE, pregnant=NOT_APPLICABLE)
    ...
    def test_screening_two_urine_bhcg_male_pregnant(self):
        instance = self.complete_part_one(
            gender=MALE, pregnant=NOT_APPLICABLE)
    ...
    def test_screening_creatinine(self):
        ...
        self.complete_part_three(
            instance=instance, verbose=True, creatinine=9000.0)
