...
class AppWindow(QtWidgets.QMainWindow, layout.Ui_MainWindow):
	...
	def __init__(self, parent=None,**kwargs):
		...
		self.VERSION = REGISTERS.VERSION_ATMEGA328P #This needs to be dynamically changed when hardware is connected
		...
		self.ADC_PINS = REGISTERS.VERSIONS[self.VERSION]['ADC']
