...
class BaseDao(object):
    ...
    def delete(self, db="mysql", **kwargs):
        ...
        try:
            if db == "mysql":
                system.mysql_dao.delete_by_id(self.table_name, self.id, **kwargs)
            else:
                system.mongo_dao.remove_by_id(self.table_name, self.id, **kwargs)
    ...
    def insert(self, db="mysql", **kwargs):
        ...
        try:
            if db == "mysql":
                system.mysql_dao.insert(self, **kwargs)
            else:
                system.mongo_dao.save(self, **kwargs)
        except Exception as e:
    ...
    def update_dao(self, db="mysql", **kwargs):
        ...
        try:
            if db == "mysql":
                system.mysql_dao.update_dao(self, **kwargs)
            else:
                system.mongo_dao.save(self, **kwargs)
        except Exception as e:
    ...
    def load(T, id, db="mysql", **kwargs):
        ...
        try:
            if db == "mysql":
                return system.mysql_dao.find_by_id(T, id, **kwargs)
            else:
                return system.mongo_dao.find_by_id(T.table_name, id, **kwargs)
        except Exception as e:
