...
class RedisDB(object):
    ...
    def init_pool(self):
        ...
        self.redis_pool = redis.ConnectionPool(host=system_conf.get_value(key, 'host'), port=system_conf.get_value(key, 'port'),max_connections=30,socket_connect_timeout=3)
