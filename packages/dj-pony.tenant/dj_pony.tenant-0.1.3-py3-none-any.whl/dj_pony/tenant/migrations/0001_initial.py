# Generated by Django 2.2.4 on 2019-10-18 03:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ulid', dj_pony.ulidfield.models.ULIDField(default=ulid.api.new, unique=True)),
                ('extra_data', jsonfield.fields.JSONField(blank=True, default={'is_non_profit': False, 'logo': None, 'number_of_employees': 0}, null=True)),
                ('settings', jsonfield.fields.JSONField(blank=True, default={'notify_users_by_email': True}, null=True)),
            ],
            options={
                'abstract': False,
            },
