...
(本文档更新于 **2019-10-25**; 如发现库和文档相关问题, 请联系 [AkShare](https://github.com/jindaxiang/akshare) 作者: jindaxiang@163.com)
...
6. 增加更多的网络数据采集接口:
    ...
    6.13 增加[和讯财经网站](http://www.hexun.com/)数据接口, 提供股票-企业社会责任数据(开发完成);
...
感谢[和讯财经网站](http://www.hexun.com/)提供的企业社会责任数据;
