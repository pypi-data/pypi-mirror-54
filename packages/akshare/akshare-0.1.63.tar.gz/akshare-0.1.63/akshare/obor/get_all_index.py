# -*- coding: utf-8 -*-
"""
Created on Thu Nov  2 20:12:15 2017
...
import re
from akshare.akshare.obor.get_countries_from_invest_web import get_countries_url

web_site = get_countries_url()
for item_1 in web_site.iloc[:, 0]:
    # item_1 = web_site.iloc[:, 0][9]
    ...
    if para_header.split(' ')[0] == 'FTSE/JSE':
        small_title = 'FTSE'
    else:
        small_title = para_header.split(' ')[0]
    print(para_header.split(' ')[0])
    df_data.to_csv('C:\\Users\\king\\Desktop\\obor_rank\\data\\' + small_title + '--' + title + '.csv',
