...
class ApproveMethod(ContractMethod):
    ...
    def call(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(guy, wad).call(tx_params.as_dict())
    ...
    def send_transaction(
        ...
        (guy, wad) = self.validate_and_normalize_inputs(guy, wad)
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(guy, wad).transact(tx_params.as_dict())
    ...
    def estimate_gas(
        ...
        (guy, wad) = self.validate_and_normalize_inputs(guy, wad)
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(guy, wad).estimateGas(
            tx_params.as_dict()
        )
...
class TransferFromMethod(ContractMethod):
    ...
    def call(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(src, dst, wad).call(tx_params.as_dict())
    ...
    def send_transaction(
        ...
        (src, dst, wad) = self.validate_and_normalize_inputs(src, dst, wad)
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(src, dst, wad).transact(
            tx_params.as_dict()
        )
    ...
    def estimate_gas(
        ...
        (src, dst, wad) = self.validate_and_normalize_inputs(src, dst, wad)
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(src, dst, wad).estimateGas(
            tx_params.as_dict()
        )
...
class TransferMethod(ContractMethod):
    ...
    def call(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(dst, wad).call(tx_params.as_dict())
    ...
    def send_transaction(
        ...
        (dst, wad) = self.validate_and_normalize_inputs(dst, wad)
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(dst, wad).transact(tx_params.as_dict())
    ...
    def estimate_gas(
        ...
        (dst, wad) = self.validate_and_normalize_inputs(dst, wad)
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(dst, wad).estimateGas(
            tx_params.as_dict()
        )
