...
class ApproveMethod(ContractMethod):
    ...
    def call(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(_spender, _value).call(
            tx_params.as_dict()
        )
    ...
    def send_transaction(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(_spender, _value).transact(
            tx_params.as_dict()
        )
    ...
    def estimate_gas(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(_spender, _value).estimateGas(
            tx_params.as_dict()
        )
...
class TransferFromMethod(ContractMethod):
    ...
    def call(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(_from, _to, _value).call(
            tx_params.as_dict()
        )
    ...
    def send_transaction(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(_from, _to, _value).transact(
            tx_params.as_dict()
        )
    ...
    def estimate_gas(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(_from, _to, _value).estimateGas(
            tx_params.as_dict()
        )
...
class TransferMethod(ContractMethod):
    ...
    def call(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(_to, _value).call(tx_params.as_dict())
    ...
    def send_transaction(
        ...
        (_to, _value) = self.validate_and_normalize_inputs(_to, _value)
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(_to, _value).transact(
            tx_params.as_dict()
        )
    ...
    def estimate_gas(
        ...
        (_to, _value) = self.validate_and_normalize_inputs(_to, _value)
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(_to, _value).estimateGas(
            tx_params.as_dict()
        )
...
class AllowanceMethod(ContractMethod):
    ...
    def call(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(_owner, _spender).call(
            tx_params.as_dict()
        )
    ...
    def send_transaction(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(_owner, _spender).transact(
            tx_params.as_dict()
        )
    ...
    def estimate_gas(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(_owner, _spender).estimateGas(
            tx_params.as_dict()
        )
...
class ZRXToken:
    ...
    def __init__(
        ...
        self.decimals = DecimalsMethod(
            web3_or_provider, contract_address, functions.decimals, validator
        )
