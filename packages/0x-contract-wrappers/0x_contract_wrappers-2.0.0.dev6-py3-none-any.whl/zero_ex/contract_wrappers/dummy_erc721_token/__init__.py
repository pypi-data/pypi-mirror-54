...
class ApproveMethod(ContractMethod):
    ...
    def call(
        ...
        return self.underlying_method(_approved, _token_id).call(
            tx_params.as_dict()
        )
    ...
    def send_transaction(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(_approved, _token_id).transact(
            tx_params.as_dict()
        )
    ...
    def estimate_gas(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(_approved, _token_id).estimateGas(
            tx_params.as_dict()
        )
...
class BalanceOfMethod(ContractMethod):
    ...
    def call(self, _owner: str, tx_params: Optional[TxParams] = None) -> int:
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(_owner).call(tx_params.as_dict())
    ...
    def send_transaction(
        ...
        (_owner) = self.validate_and_normalize_inputs(_owner)
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(_owner).transact(tx_params.as_dict())
    ...
    def estimate_gas(
        ...
        (_owner) = self.validate_and_normalize_inputs(_owner)
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(_owner).estimateGas(tx_params.as_dict())
...
class BurnMethod(ContractMethod):
    ...
    def call(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(_owner, _token_id).call(
            tx_params.as_dict()
        )
    ...
    def send_transaction(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(_owner, _token_id).transact(
            tx_params.as_dict()
        )
    ...
    def estimate_gas(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(_owner, _token_id).estimateGas(
            tx_params.as_dict()
        )
...
class GetApprovedMethod(ContractMethod):
    ...
    def call(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(_token_id).call(tx_params.as_dict())
    ...
    def send_transaction(
        ...
        (_token_id) = self.validate_and_normalize_inputs(_token_id)
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(_token_id).transact(tx_params.as_dict())
    ...
    def estimate_gas(
        ...
        (_token_id) = self.validate_and_normalize_inputs(_token_id)
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(_token_id).estimateGas(
            tx_params.as_dict()
        )
...
class IsApprovedForAllMethod(ContractMethod):
    ...
    def call(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(_owner, _operator).call(
            tx_params.as_dict()
        )
    ...
    def send_transaction(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(_owner, _operator).transact(
            tx_params.as_dict()
        )
    ...
    def estimate_gas(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(_owner, _operator).estimateGas(
            tx_params.as_dict()
        )
...
class MintMethod(ContractMethod):
    ...
    def call(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(_to, _token_id).call(tx_params.as_dict())
    ...
    def send_transaction(
        ...
        (_to, _token_id) = self.validate_and_normalize_inputs(_to, _token_id)
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(_to, _token_id).transact(
            tx_params.as_dict()
        )
    ...
    def estimate_gas(
        ...
        (_to, _token_id) = self.validate_and_normalize_inputs(_to, _token_id)
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(_to, _token_id).estimateGas(
            tx_params.as_dict()
        )
...
class SafeTransferFrom1Method(ContractMethod):
    ...
    def call(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(_from, _to, _token_id).call(
            tx_params.as_dict()
        )
    ...
    def send_transaction(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(_from, _to, _token_id).transact(
            tx_params.as_dict()
        )
    ...
    def estimate_gas(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(_from, _to, _token_id).estimateGas(
            tx_params.as_dict()
        )
...
class SafeTransferFrom2Method(ContractMethod):
    ...
    def call(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(_from, _to, _token_id, _data).call(
            tx_params.as_dict()
        )
    ...
    def send_transaction(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(_from, _to, _token_id, _data).transact(
            tx_params.as_dict()
        )
...
class SetApprovalForAllMethod(ContractMethod):
    ...
    def call(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(_operator, _approved).call(
            tx_params.as_dict()
        )
    ...
    def send_transaction(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(_operator, _approved).transact(
            tx_params.as_dict()
        )
    ...
    def estimate_gas(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(_operator, _approved).estimateGas(
            tx_params.as_dict()
        )
...
class DummyERC721Token:
    ...
    def __init__(
        ...
        self.name = NameMethod(
            web3_or_provider, contract_address, functions.name, validator
        )
        ...
        self.symbol = SymbolMethod(
            web3_or_provider, contract_address, functions.symbol, validator
        )
