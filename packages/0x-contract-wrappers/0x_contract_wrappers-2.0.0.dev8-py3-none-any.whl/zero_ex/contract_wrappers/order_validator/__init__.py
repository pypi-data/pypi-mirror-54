...
class GetOrderAndTraderInfoMethod(ContractMethod):
    ...
    def call(
        ...
        return self.underlying_method(order, taker_address).call(
            tx_params.as_dict()
        )
    ...
    def send_transaction(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(order, taker_address).transact(
            tx_params.as_dict()
        )
    ...
    def estimate_gas(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(order, taker_address).estimateGas(
            tx_params.as_dict()
        )
...
class GetBalanceAndAllowanceMethod(ContractMethod):
    ...
    def call(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(target, asset_data).call(
            tx_params.as_dict()
        )
    ...
    def send_transaction(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(target, asset_data).transact(
            tx_params.as_dict()
        )
    ...
    def estimate_gas(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(target, asset_data).estimateGas(
            tx_params.as_dict()
        )
...
class GetOrdersAndTradersInfoMethod(ContractMethod):
    ...
    def call(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(orders, taker_addresses).call(
            tx_params.as_dict()
        )
    ...
    def send_transaction(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(orders, taker_addresses).transact(
            tx_params.as_dict()
        )
    ...
    def estimate_gas(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(orders, taker_addresses).estimateGas(
            tx_params.as_dict()
        )
...
class GetErc721TokenOwnerMethod(ContractMethod):
    ...
    def call(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(token, token_id).call(
            tx_params.as_dict()
        )
    ...
    def send_transaction(
        ...
        (token, token_id) = self.validate_and_normalize_inputs(token, token_id)
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(token, token_id).transact(
            tx_params.as_dict()
        )
    ...
    def estimate_gas(
        ...
        (token, token_id) = self.validate_and_normalize_inputs(token, token_id)
        tx_params = super().normalize_tx_params(tx_params)
        return self.underlying_method(token, token_id).estimateGas(
            tx_params.as_dict()
        )
