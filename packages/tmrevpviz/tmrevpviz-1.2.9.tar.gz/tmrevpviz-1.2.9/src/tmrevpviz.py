...
def tmrevpviz_run(CSV_MAIN_PATH_INPUT, CSV_DETAILS_PATH_INPUT, CSV_SUMMARY_PATH_INPUT, CSV_VPP_PATH_INPUT, CSV_IO_PATH_INPUT, INTERSECTION_INPUT, TIMETABLE_INTERVAL_INPUT, NO_CYCLE_INTERVALS_INPUT, OUTPUT_FOLDER_INPUT):

    global CSV_MAIN_PATH_GVAL
    global CSV_DETAILS_PATH_GVAL
    global CSV_SUMMARY_PATH_GVAL
    global CSV_VPP_PATH_GVAL
    global CSV_IO_PATH_GVAL
    ...
    CSV_IO_PATH_GVAL = CSV_IO_PATH_INPUT
    ...
    try:
        i_io = pd.read_excel(CSV_IO_PATH_GVAL)
    except FileNotFoundError as e:
        feedback_text.set("Error: Can't find " + CSV_IO_PATH_GVAL)
        return
    # ----------------- FETCH CSV FILES END--------------------------------
    #######################################################################
    ...
    VALIDATION_WORKSHEET.write(VALIDATION_WORKBOOK_INDEX, 2, 'FAULT ID')
    VALIDATION_WORKSHEET.write(VALIDATION_WORKBOOK_INDEX, 3, 'FAULT COMMENT')
...
tk.Label(window,
         text="CSV_IO_PATH",  bg="#00817d", fg="white", anchor="e").grid(row=4)
tk.Label(window,
...
feedback_label = tk.Label(window, textvariable=feedback_text,  bg="#00817d", fg="white", anchor="e").grid(column=0, row=9, columnspan=4)
...
CSV_IO_PATH.grid(row=4, column=2)
...
# CSV_IO_PATH.insert(0, r'C:\Users\Torkil\Desktop\IO.xlsx')#(0, r'C:\Users\Torkil\Documents\Programming\Python\IFN702\Phase 1\data\M1118\M1118_IO.csv')
