...
class Yota():
    ...
    def srt_search(self, keyword, sample_length=7, merge_clips_shorter_than=10, mixtape=True):
        ...
        result = srt.main(keyword, self.youtube_hash, min_clip_length = merge_clips_shorter_than)
        if mixtape:
            if len(result) > 0:
