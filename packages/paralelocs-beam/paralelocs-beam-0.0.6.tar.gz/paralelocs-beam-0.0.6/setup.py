...
setup(
    ...
    author='Lucas de Castro Magalhães',
    ...
    project_urls={
        'Changelog': 'https://https://gitlab.com/paralelo/lucasmagalhaes/paralelocs_beam/blob/master/CHANGELOG.rst',
        'Issue Tracker': 'https://https://gitlab.com/paralelo/lucasmagalhaes/paralelocs_beam/issues',
    },
    keywords=[
