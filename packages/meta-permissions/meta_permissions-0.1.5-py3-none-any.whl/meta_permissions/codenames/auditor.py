...
auditor += [
    ...
    "meta_lists.view_followupvitals",
    "meta_lists.view_historicalfollowupvitals",
    "meta_lists.view_historicalpatienthistory",
    "meta_lists.view_historicalphysicalexam",
    "meta_lists.view_offstudyreasons",
    "meta_lists.view_oiprophylaxis",
    "meta_lists.view_symptoms",
    "meta_prn.view_causeofdeath",
