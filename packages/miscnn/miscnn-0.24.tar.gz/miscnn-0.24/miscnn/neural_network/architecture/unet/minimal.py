...
Methods:
    ...
    create_model_2D:        Creating the 2D U-Net minimal model using Keras
    create_model_3D:        Creating the 3D U-Net minimal model using Keras
"""
class Architecture(Abstract_Architecture):
    #---------------------------------------------#
    #                Initialization               #
    #---------------------------------------------#
    def __init__(self, activation='sigmoid', batch_normalization=True):
        # Parse parameter
