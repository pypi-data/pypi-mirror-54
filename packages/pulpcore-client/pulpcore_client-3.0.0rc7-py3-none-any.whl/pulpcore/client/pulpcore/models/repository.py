...
class Repository(object):
    ...
    def __init__(self, pulp_href=None, pulp_created=None, versions_href=None, latest_version_href=None, name=None, plugin_managed=None, description=None):  # noqa: E501
