...
class Status(object):
    ...
    def __init__(self, versions=None, online_workers=None, missing_workers=None, online_content_apps=None, database_connection=None, redis_connection=None, local_vars_configuration=None):  # noqa: E501
