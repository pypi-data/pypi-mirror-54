...
class Status(object):
    ...
    def __init__(self, versions=None, online_workers=None, missing_workers=None, online_content_apps=None, database_connection=None, redis_connection=None):  # noqa: E501
    ...
    def online_content_apps(self, online_content_apps):
        ...
        """
        if online_content_apps is None:
