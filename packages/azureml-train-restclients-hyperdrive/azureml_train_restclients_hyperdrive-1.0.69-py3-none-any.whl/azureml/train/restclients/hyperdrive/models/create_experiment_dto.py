...
class CreateExperimentDto(Model):
    ...
    def __init__(self, generator_config, name, platform, platform_config, policy_config, primary_metric_config, user, description=None, max_concurrent_jobs=None, max_duration_minutes=None, max_total_jobs=None, study_id=None):
