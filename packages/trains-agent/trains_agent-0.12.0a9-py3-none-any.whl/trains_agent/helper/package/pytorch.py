...
class SimplePytorchRequirement(SimpleSubstitution):
    ...
    def get_torch_page(cls, cuda_version):
        ...
        for k in keys:
            if k <= cuda:
                return cls.torch_page_lookup[k]
        # return default - zero
        return cls.torch_page_lookup[0]
...
class PytorchRequirement(SimpleSubstitution):
    ...
    def get_url_for_platform(self, req):
        ...
        torch_url = SimplePytorchRequirement.get_torch_page(self.cuda_version)
