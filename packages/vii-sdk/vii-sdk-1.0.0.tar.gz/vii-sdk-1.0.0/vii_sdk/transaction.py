...
class Transaction(object):
    ...
    <vii_sdk.transaction_envelope.TransactionEnvelope>` which is
    then signed before being sent over the network.

    For more information on Transactions in Vii, see `Vii's guide
    on transactions`_.

    .. _Vii's guide on transactions:
        https://www.vii.vip/developers/guides/concepts/transactions.html
    ...
    :param Memo memo: The memo being sent with the transaction, being
          ...
          :class:`Memo <vii_sdk.memo.Memo>` object.
    :param int fee: The fee amount for the transaction, which should equal
          FEE (currently 100 stroops) multiplied by the number of
          operations in the transaction. See `Vii's latest documentation
          on fees
          <https://www.vii.vip/developers/guides/concepts/fees.html#transaction-fee>`_
          for more information.
    :param list operations: A list of :class:`Operation
          <vii_sdk.operation.Operation>` objects (typically its
          subclasses as defined in :mod:`vii_sdk.operation` to be
    ...
    def add_operation(self, operation):
        """Add an :class:`Operation <vii_sdk.operation.Operation>` to
        this transaction.
