...
HORIZON_LIVE = "https://h.vii.vip"
HORIZON_TEST = "https://horizon-testnet.vii.vip"
DEFAULT_REQUEST_TIMEOUT = 11  # two ledgers + 1 sec, let's retry faster and not wait 60 secs.
DEFAULT_NUM_RETRIES = 3
DEFAULT_BACKOFF_FACTOR = 0.5
USER_AGENT = {
    'X-Client-Name': 'py-vii-sdk',
...
class Horizon(object):
    def __init__(self,
        ...
        :param dict user_agent: representing the user-agent you want,
            such as `{'X-Client-Name': 'py-Vii-base', 'X-Client-Version': __version__}`

        """
        if user_agent is None:
            self.user_agent = USER_AGENT
        if horizon_uri is None:
            self.horizon_uri = HORIZON_LIVE
        else:
    ...
    def submit(self, te):
        ...
        `POST /transactions
        <https://www.vii.vip/developers/horizon/reference/endpoints/transactions-create.html>`_
    ...
    def account(self, address):
        ...
        <https://www.vii.vip/developers/horizon/reference/endpoints/accounts-single.html>`_
    ...
    def account_data(self, address, key):
        ...
        <https://www.vii.vip/developers/horizon/reference/endpoints/data-for-account.html>`_
    ...
    def account_effects(self, address, cursor=None, order='asc', limit=10, sse=False):
        ...
        <https://www.vii.vip/developers/horizon/reference/endpoints/effects-for-account.html>`_
    ...
    def account_offers(self, address, cursor=None, order='asc', limit=10, sse=False):
        ...
        <https://www.vii.vip/developers/horizon/reference/endpoints/offers-for-account.html>`_
    ...
    def account_operations(self, address, cursor=None, order='asc', limit=10, include_failed=False, sse=False):
        ...
        <https://www.vii.vip/developers/horizon/reference/endpoints/operations-for-account.html>`_
    ...
    def account_transactions(self, address, cursor=None, order='asc', limit=10, include_failed=False, sse=False):
        ...
        <https://www.vii.vip/developers/horizon/reference/endpoints/transactions-for-account.html>`_
    ...
    def account_payments(self, address, cursor=None, order='asc', limit=10, sse=False):
        ...
        <https://www.vii.vip/developers/horizon/reference/endpoints/payments-for-account.html>`_
    ...
    def account_trades(self, address, cursor=None, order='asc', limit=10, sse=False):
        ...
        <https://www.vii.vip/developers/horizon/reference/endpoints/trades-for-account.html>`_
    ...
    def assets(self, asset_code=None, asset_issuer=None, cursor=None, order='asc', limit=10):
        ...
        <https://www.vii.vip/developers/horizon/reference/endpoints/assets-all.html>`_
    ...
    def transactions(self, cursor=None, order='asc', limit=10, include_failed=False, sse=False):
        ...
        <https://www.vii.vip/developers/horizon/reference/endpoints/transactions-all.html>`_
    ...
    def transaction(self, tx_hash):
        ...
        <https://www.vii.vip/developers/horizon/reference/endpoints/transactions-single.html>`_
    ...
    def transaction_operations(self, tx_hash, cursor=None, order='asc', include_failed=False, limit=10):
        ...
        <https://www.vii.vip/developers/horizon/reference/endpoints/operations-for-transaction.html>`_
    ...
    def transaction_effects(self, tx_hash, cursor=None, order='asc', limit=10):
        ...
        <https://www.vii.vip/developers/horizon/reference/endpoints/effects-for-transaction.html>`_
    ...
    def transaction_payments(self, tx_hash, cursor=None, order='asc', limit=10):
        ...
        <https://www.vii.vip/developers/horizon/reference/endpoints/payments-for-transaction.html>`_
    ...
    def order_book(self, selling_asset_code, buying_asset_code, selling_asset_issuer=None, buying_asset_issuer=None,
        ...
        `GET /order_book
        <https://www.vii.vip/developers/horizon/reference/endpoints/orderbook-details.html>`_
    ...
    def ledgers(self, cursor=None, order='asc', limit=10, sse=False):
        ...
        <https://www.vii.vip/developers/horizon/reference/endpoints/ledgers-all.html>`_
    ...
    def ledger(self, ledger_id):
        ...
        <https://www.vii.vip/developers/horizon/reference/endpoints/ledgers-single.html>`_
    ...
    def ledger_effects(self, ledger_id, cursor=None, order='asc', limit=10):
        ...
        <https://www.vii.vip/developers/horizon/reference/endpoints/effects-for-ledger.html>`_
    ...
    def ledger_operations(self, ledger_id, cursor=None, order='asc', include_failed=False, limit=10):
        ...
        <https://www.vii.vip/developers/horizon/reference/endpoints/operations-for-ledger.html>`_
    ...
    def ledger_payments(self, ledger_id, cursor=None, order='asc', limit=10):
        ...
        <https://www.vii.vip/developers/horizon/reference/endpoints/payments-for-ledger.html>`_
    ...
    def ledger_transactions(self, ledger_id, cursor=None, order='asc', include_failed=False, limit=10):
        ...
        <https://www.vii.vip/developers/horizon/reference/endpoints/transactions-for-ledger.html>`_
    ...
    def effects(self, cursor=None, order='asc', limit=10, sse=False):
        ...
        <https://www.vii.vip/developers/horizon/reference/endpoints/effects-all.html>`_
    ...
    def operations(self, cursor=None, order='asc', limit=10, include_failed=False, sse=False):
        ...
        <https://www.vii.vip/developers/horizon/reference/endpoints/operations-all.html>`_
    ...
    def operation(self, op_id):
        ...
        `GET /operations/{id}
        <https://www.vii.vip/developers/horizon/reference/endpoints/operations-single.html>`_
    ...
    def operation_effects(self, op_id, cursor=None, order='asc', limit=10):
        ...
        <https://www.vii.vip/developers/horizon/reference/endpoints/effects-for-operation.html>`_
    ...
    def payments(self, cursor=None, order='asc', limit=10, sse=False):
        ...
        <https://www.vii.vip/developers/horizon/reference/endpoints/payments-all.html>`_
    ...
    def paths(self, destination_account, destination_amount, source_account, destination_asset_code,
        ...
        `GET /paths
        <https://www.vii.vip/developers/horizon/reference/endpoints/path-finding.html>`_
    ...
    def trades(self, base_asset_code=None, counter_asset_code=None, base_asset_issuer=None, counter_asset_issuer=None,
        ...
        `GET /trades
        <https://www.vii.vip/developers/horizon/reference/endpoints/trades.html>`_
    ...
    def trade_aggregations(self, resolution, base_asset_code, counter_asset_code,
        ...
        <https://www.vii.vip/developers/horizon/reference/endpoints/trade_aggregations.html>`_
    ...
    def offer_trades(self, offer_id, cursor=None, order='asc', limit=10):
        ...
        <https://www.vii.vip/developers/horizon/reference/endpoints/trades-for-offer.html>`_
    ...
    def metrics(self):
        ...
        `GET /metrics
        <https://www.vii.vip/developers/horizon/reference/endpoints/metrics.html>`_
    ...
    def fee_stats(self):
        ...
        `GET /fee_stats
        <https://www.vii.vip/developers/horizon/reference/endpoints/fee-stats.html>`_
