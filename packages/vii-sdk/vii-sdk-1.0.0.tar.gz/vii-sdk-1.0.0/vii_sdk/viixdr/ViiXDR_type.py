...
class LedgerUpgrade:
    ...
    switch = property(lambda s:
                      {const.LEDGER_UPGRADE_VERSION: s.newLedgerVersion, const.LEDGER_UPGRADE_BASE_FEE: s.newBaseFee,
                       ...
                       const.LEDGER_UPGRADE_BASE_RESERVE: s.newBaseReserve, }[s.type])
...
class BucketEntry:
    ...
    switch = property(lambda s:
                      {const.LIVEENTRY: s.liveEntry, const.INITENTRY: s.liveEntry, const.DEADENTRY: s.deadEntry,
                       const.METAENTRY: s.metaEntry, }[s.type])
...
class PathPaymentStrictReceiveResult:
    ...
    switch = property(lambda s: {const.PATH_PAYMENT_STRICT_RECEIVE_SUCCESS: s.success,
                                 const.PATH_PAYMENT_STRICT_RECEIVE_NO_ISSUER: s.noIssuer, }.get(s.code, None))
...
class PathPaymentStrictSendResult:
    ...
    switch = property(lambda s: {const.PATH_PAYMENT_STRICT_SEND_SUCCESS: s.success,
                                 const.PATH_PAYMENT_STRICT_SEND_NO_ISSUER: s.noIssuer, }.get(s.code, None))
