...
from .utils import encode_check, ViiMnemonic, \
...
class Keypair(object):
    ...
    verifying key for use with the Vii network.
    ...
    * :meth:`Keypair.from_address`
    ...
    def deterministic(cls, mnemonic, passphrase='', lang='english', index=0):
        ...
        Using a mnemonic, such as one generated from :class:`ViiMnemonic`,
        generate a new keypair deterministically. Uses :class:`ViiMnemonic`
        ...
        :param int index: The index of the keypair generated by the mnemonic.
            ...
            mnemonic, such as::
                ...
                >>> from vii_sdk.keypair import Keypair
