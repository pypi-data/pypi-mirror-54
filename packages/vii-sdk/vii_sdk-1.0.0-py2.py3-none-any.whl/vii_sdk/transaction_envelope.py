...
class TransactionEnvelope(object):
    ...
    class handles signing and conversion to and from XDR for usage on Vii's
    network.

    :param tx: The transaction that is encapsulated in this envelope.
    :type tx: :class:`Transaction <vii_sdk.transaction.Transaction>`
    ...
    def sign(self, keypair):
        ...
        :param keypair: The keypair to use for signing this transaction
            envelope.
        :type keypair: :class:`Keypair <vii_sdk.keypair.Keypair>`
        :raises: :exc:`SignatureExistError
            <vii_sdk.exceptions.SignatureExistError>`
    ...
    def sign_hashX(self, preimage):
        ...
        See Vii's documentation on `Multi-Sig
    ...
    def signature_base(self):
        ...
        validators on the Vii Network will accept.
