# Generated by xdrgen.py from ../xdr/ on Wed Oct 23 20:31:07 2019
import xdrlib
from xdrlib import Error as XDRError

from . import ViiXDR_const as const
from . import ViiXDR_type as types
...
class StellarXDRPacker(xdrlib.Packer):
    ...
    def pack_LedgerUpgradeType(self, data):
        ...
        if self.check_enum and data not in [const.LEDGER_UPGRADE_VERSION, const.LEDGER_UPGRADE_BASE_FEE,
                                            const.LEDGER_UPGRADE_MAX_TX_SET_SIZE, const.LEDGER_UPGRADE_BASE_RESERVE]:
    ...
    def pack_OperationType(self, data):
        ...
        if self.check_enum and data not in [const.CREATE_ACCOUNT, const.PAYMENT, const.PATH_PAYMENT_STRICT_RECEIVE,
                                            const.MANAGE_SELL_OFFER, const.CREATE_PASSIVE_SELL_OFFER, const.SET_OPTIONS,
                                            const.CHANGE_TRUST, const.ALLOW_TRUST, const.ACCOUNT_MERGE, const.INFLATION,
                                            const.MANAGE_DATA, const.BUMP_SEQUENCE, const.MANAGE_BUY_OFFER,
    ...
    def pack_Memo(self, data):
        ...
        if data.type == const.MEMO_NONE:
            ...
            if len(data.text) > 128 and self.check_array:
    ...
    def pack_PathPaymentStrictReceiveResultCode(self, data):
        ...
        if self.check_enum and data not in [const.PATH_PAYMENT_STRICT_RECEIVE_SUCCESS,
    ...
    def pack_PathPaymentStrictSendResultCode(self, data):
        ...
        if self.check_enum and data not in [const.PATH_PAYMENT_STRICT_SEND_SUCCESS,
    ...
    def pack_ManageSellOfferResultCode(self, data):
        ...
        if self.check_enum and data not in [const.MANAGE_SELL_OFFER_SUCCESS, const.MANAGE_SELL_OFFER_MALFORMED,
                                            const.MANAGE_SELL_OFFER_SELL_NO_TRUST, const.MANAGE_SELL_OFFER_BUY_NO_TRUST,
                                            const.MANAGE_SELL_OFFER_SELL_NOT_AUTHORIZED,
                                            const.MANAGE_SELL_OFFER_BUY_NOT_AUTHORIZED,
                                            const.MANAGE_SELL_OFFER_LINE_FULL, const.MANAGE_SELL_OFFER_UNDERFUNDED,
                                            const.MANAGE_SELL_OFFER_CROSS_SELF, const.MANAGE_SELL_OFFER_SELL_NO_ISSUER,
                                            const.MANAGE_SELL_OFFER_BUY_NO_ISSUER, const.MANAGE_SELL_OFFER_NOT_FOUND,
    ...
    def pack_ManageBuyOfferResultCode(self, data):
        ...
        if self.check_enum and data not in [const.MANAGE_BUY_OFFER_SUCCESS, const.MANAGE_BUY_OFFER_MALFORMED,
                                            const.MANAGE_BUY_OFFER_SELL_NO_TRUST, const.MANAGE_BUY_OFFER_BUY_NO_TRUST,
                                            const.MANAGE_BUY_OFFER_SELL_NOT_AUTHORIZED,
                                            const.MANAGE_BUY_OFFER_BUY_NOT_AUTHORIZED, const.MANAGE_BUY_OFFER_LINE_FULL,
                                            const.MANAGE_BUY_OFFER_UNDERFUNDED, const.MANAGE_BUY_OFFER_CROSS_SELF,
                                            const.MANAGE_BUY_OFFER_SELL_NO_ISSUER, const.MANAGE_BUY_OFFER_BUY_NO_ISSUER,
                                            const.MANAGE_BUY_OFFER_NOT_FOUND, const.MANAGE_BUY_OFFER_LOW_RESERVE]:
    ...
    def pack_AccountMergeResultCode(self, data):
        ...
        if self.check_enum and data not in [const.ACCOUNT_MERGE_SUCCESS, const.ACCOUNT_MERGE_MALFORMED,
                                            ...
                                            const.ACCOUNT_MERGE_HAS_SUB_ENTRIES, const.ACCOUNT_MERGE_SEQNUM_TOO_FAR,
    ...
    def pack_OperationResultCode(self, data):
        ...
        if self.check_enum and data not in [const.opINNER, const.opBAD_AUTH, const.opNO_ACCOUNT, const.opNOT_SUPPORTED,
                                            const.opTOO_MANY_SUBENTRIES, const.opEXCEEDED_WORK_LIMIT]:
