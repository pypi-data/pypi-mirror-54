...
def PopulateFilterFromRecArray(symbol,norgatetimeseriesfunction,start_date,end_date,assetindexcounter,dates,out):
...
def PopulateFilter(symbol,norgatetimeseriesfunction,start_date,end_date,assetindexcounter,dates,out):
    ...
    out[:,assetindexcounter] = timeseries.reindex(dates,fill_value=False,copy=False).values[:,0]
