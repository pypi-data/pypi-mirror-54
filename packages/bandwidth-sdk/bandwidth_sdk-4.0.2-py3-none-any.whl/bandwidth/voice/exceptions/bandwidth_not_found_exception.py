...
class BandwidthNotFoundException(bandwidth.exceptions.api_exception.APIException):
    def __init__(self, reason, response):
        """Constructor for the BandwidthNotFoundException class
        ...
        """
        super(BandwidthNotFoundException, self).__init__(reason, response)
