...
class StatChecker:
    ...
    @staticmethod
    def _get_title_data(content: etree.ElementTree) -> DotDict[str, Tuple[str, Union[str, None]]]:
    ...
    @staticmethod
    def _get_columns_data(section: etree.ElementTree) -> DotDict[str, DotDict[str, Any]]:
    ...
    def _get_rows_data(section: etree.ElementTree,
                       section_dict: DotDict[str, Any]) -> DotDict[str, ]:
    ...
    def _get_sections_data(self, content: etree.ElementTree) -> DotDict[str, Any]:
    ...
    def _get_controls_data(self, content: etree.ElementTree) -> List[DotDict[str, Any]]:
    ...
    @staticmethod
    def _get_dics_data(content: etree.ElementTree) -> DotDict[str, DotDict[str, Any]]:
