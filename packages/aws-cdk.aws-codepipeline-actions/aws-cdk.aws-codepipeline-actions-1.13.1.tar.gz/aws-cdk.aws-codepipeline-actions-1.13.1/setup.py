...
kwargs = json.loads("""
{
    ...
    "package_data": {
        "aws_cdk.aws_codepipeline_actions._jsii": [
            "aws-codepipeline-actions@1.13.1.jsii.tgz"
        ],
        "aws_cdk.aws_codepipeline_actions": [
            "py.typed"
        ]
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-codebuild~=1.13,>=1.13.1",
        "aws-cdk.aws-codecommit~=1.13,>=1.13.1",
        "aws-cdk.aws-codedeploy~=1.13,>=1.13.1",
        "aws-cdk.aws-codepipeline~=1.13,>=1.13.1",
        "aws-cdk.aws-ec2~=1.13,>=1.13.1",
        "aws-cdk.aws-ecr~=1.13,>=1.13.1",
        "aws-cdk.aws-ecs~=1.13,>=1.13.1",
        "aws-cdk.aws-events~=1.13,>=1.13.1",
        "aws-cdk.aws-events-targets~=1.13,>=1.13.1",
        "aws-cdk.aws-iam~=1.13,>=1.13.1",
        "aws-cdk.aws-lambda~=1.13,>=1.13.1",
        "aws-cdk.aws-s3~=1.13,>=1.13.1",
        "aws-cdk.aws-sns~=1.13,>=1.13.1",
        "aws-cdk.aws-sns-subscriptions~=1.13,>=1.13.1",
