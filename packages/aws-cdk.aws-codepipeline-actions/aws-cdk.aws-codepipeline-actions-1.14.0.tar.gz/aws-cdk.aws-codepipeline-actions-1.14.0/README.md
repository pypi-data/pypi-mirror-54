...
cdk_build_project = codebuild.PipelineProject(pipeline_stack, "CdkBuildProject",
    environment={
...
lambda_build_project = codebuild.PipelineProject(pipeline_stack, "LambdaBuildProject",
    environment={
        "build_image": codebuild.LinuxBuildImage.UBUNTU_14_04_NODEJS_10_1_0
    },
    build_spec=codebuild.BuildSpec.from_object(
