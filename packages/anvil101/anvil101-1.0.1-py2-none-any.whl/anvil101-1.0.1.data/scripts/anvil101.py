...
#---
import os, importlib
fs = [f for f in os.listdir('./mods') if f.endswith('.py')]
...
if run == True:
  ...
  size = pickle.load( open( "settings.dat", "rb" ) )
  MAPWIDTH = int(size.split("x")[0])
  MAPHEIGHT = int(size.split("x")[1])
  print("35% done")
  sleep(1)
  clear()
  print("Generating graphics drawer...")
