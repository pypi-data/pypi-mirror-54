...
class Financial:
    ...
    account_purchase_adjustment_contra = Client(
        _application_name,
        'account_purchase_adjustment_contra/',
    )
    ...
    account_purchase_debit_note_contra = Client(
        _application_name,
        'account_purchase_debit_note_contra/',
    )
    ...
    account_purchase_invoice_contra = Client(
        _application_name,
        'account_purchase_invoice_contra/',
    )
    ...
    account_purchase_payment_contra = Client(
        _application_name,
        'account_purchase_payment_contra/',
    )
    ...
    account_sale_adjustment_contra = Client(
        _application_name,
        'account_sale_adjustment_contra/',
    )
    ...
    account_sale_credit_note_contra = Client(
        _application_name,
        'account_sale_credit_note_contra/',
    )
    ...
    cash_purchase_debit_note_contra = Client(
        _application_name,
        'cash_purchase_debit_note_contra/',
    )
