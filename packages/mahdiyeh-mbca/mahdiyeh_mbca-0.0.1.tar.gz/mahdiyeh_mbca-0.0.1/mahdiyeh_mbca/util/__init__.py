# mahdiyeh_mbca/util/__init__.py
#
...
mahdiyeh_mbca.util package.
===============

This package contains the tools needed by many modules
of Mahdiyeh Mano Basic Computer Assembler.
