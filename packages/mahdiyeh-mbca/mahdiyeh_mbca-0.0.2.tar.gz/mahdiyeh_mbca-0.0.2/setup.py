...
# open _version file
with open(os.path.join(base_path, "mahdiyeh_mbca", "_version.py")) as file:
...
# open mahdiyeh_mbca/__init__.py to retrieve package info
with open(os.path.join(base_path, "mahdiyeh_mbca", "__init__.py"), "r") as file:
...
name = "mahdiyeh_mbca"
url = "https://gitlab.com/Azadeh-Afzar/Computer-Science/Mahdiyeh-Mano-Basic-Computer-Assembler"
...
entry_points = {
    "console_scripts": [
        "mmbca-py = mahdiyeh_mbca.main:main",
    ]
}
