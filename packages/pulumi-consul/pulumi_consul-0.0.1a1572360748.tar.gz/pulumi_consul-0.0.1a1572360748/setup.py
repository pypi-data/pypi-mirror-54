...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'consul', 'v0.0.1-alpha.1572360748+gd08ed91'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource consul v0.0.1-alpha.1572360748+gd08ed91`
                """)
            else:
                raise
