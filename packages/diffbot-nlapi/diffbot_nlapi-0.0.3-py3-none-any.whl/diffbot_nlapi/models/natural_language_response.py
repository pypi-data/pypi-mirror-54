...
from diffbot_nlapi.models.entity_with_mentions import EntityWithMentions  # noqa: F401,E501
from diffbot_nlapi.models.mention_with_entities import MentionWithEntities  # noqa: F401,E501
...
class NaturalLanguageResponse(object):
    ...
    """
    swagger_types = {
        'mentions': 'list[MentionWithEntities]',
        'entities': 'list[EntityWithMentions]',
    ...
    def mentions(self):
        ...
        :rtype: list[MentionWithEntities]
        """
