...
from web import application, ctx, OK, BadRequest, header, InternalError, seeother, template, setcookie, input as param_input
...
class OIDC(RucioController):
    ...
    def GET(self):
        ...
        issuer = ctx.env.get('HTTP_X_RUCIO_CLIENT_AUTHORIZE_ISSUER', 'xdc')
