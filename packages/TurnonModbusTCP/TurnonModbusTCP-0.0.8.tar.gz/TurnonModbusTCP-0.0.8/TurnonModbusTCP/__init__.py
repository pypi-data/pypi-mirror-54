...
def set_client(ServerIP="192.168.6.105",ServerPORT=502):
	global modbus_host
	global modbus_port
...
def Write(write_address=-1, write_data=0):
	...
	if write_address >= 8000 or write_address <= 9999 :
...
def robot_control(control_mode=66, data_X=3001, data_Y=3001, data_Z=3001):
