# LibraClient  [![Build Status](https://travis-ci.org/violas-project/violas-client.svg?branch=master)](https://travis-ci.org/violas-project/violas-client) [![MIT licensed](https://img.shields.io/badge/license-MIT-blue.svg)](./LICENSE)
