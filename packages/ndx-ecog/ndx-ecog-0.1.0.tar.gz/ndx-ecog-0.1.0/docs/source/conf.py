...
# -*- coding: utf-8 -*-
#
# ndx-ecog documentation build configuration file, created by
# sphinx-quickstart on Tue Oct 15 19:07:30 2019.
#
...
latex_documents = [
    (master_doc, 'ndx-ecog.tex', 'ndx-ecog Documentation',
     'Ben Dichter', 'manual'),
]
...
man_pages = [
    (master_doc, 'ndx-ecog', 'ndx-ecog Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ndx-ecog', 'ndx-ecog Documentation',
     author, 'ndx-ecog', 'One line description of project.',
     'Miscellaneous'),
]
