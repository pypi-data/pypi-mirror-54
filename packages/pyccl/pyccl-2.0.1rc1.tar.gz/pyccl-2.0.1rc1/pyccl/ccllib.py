...
class spline_params(object):
    ...
    A_SPLINE_TYPE = property(_ccllib.spline_params_A_SPLINE_TYPE_get, _ccllib.spline_params_A_SPLINE_TYPE_set, doc=r"""A_SPLINE_TYPE : p.gsl_interp_type""")
    K_SPLINE_TYPE = property(_ccllib.spline_params_K_SPLINE_TYPE_get, _ccllib.spline_params_K_SPLINE_TYPE_set, doc=r"""K_SPLINE_TYPE : p.gsl_interp_type""")
    M_SPLINE_TYPE = property(_ccllib.spline_params_M_SPLINE_TYPE_get, _ccllib.spline_params_M_SPLINE_TYPE_set, doc=r"""M_SPLINE_TYPE : p.gsl_interp_type""")
    D_SPLINE_TYPE = property(_ccllib.spline_params_D_SPLINE_TYPE_get, _ccllib.spline_params_D_SPLINE_TYPE_set, doc=r"""D_SPLINE_TYPE : p.gsl_interp_type""")
    PNL_SPLINE_TYPE = property(_ccllib.spline_params_PNL_SPLINE_TYPE_get, _ccllib.spline_params_PNL_SPLINE_TYPE_set, doc=r"""PNL_SPLINE_TYPE : p.gsl_interp2d_type""")
    PLIN_SPLINE_TYPE = property(_ccllib.spline_params_PLIN_SPLINE_TYPE_get, _ccllib.spline_params_PLIN_SPLINE_TYPE_set, doc=r"""PLIN_SPLINE_TYPE : p.gsl_interp2d_type""")
    CORR_SPLINE_TYPE = property(_ccllib.spline_params_CORR_SPLINE_TYPE_get, _ccllib.spline_params_CORR_SPLINE_TYPE_set, doc=r"""CORR_SPLINE_TYPE : p.gsl_interp_type""")
...
class data(object):
    ...
    logsigma = property(_ccllib.data_logsigma_get, _ccllib.data_logsigma_set, doc=r"""logsigma : p.gsl_spline""")
    dlnsigma_dlogm = property(_ccllib.data_dlnsigma_dlogm_get, _ccllib.data_dlnsigma_dlogm_set, doc=r"""dlnsigma_dlogm : p.gsl_spline""")
    alphahmf = property(_ccllib.data_alphahmf_get, _ccllib.data_alphahmf_set, doc=r"""alphahmf : p.gsl_spline""")
    betahmf = property(_ccllib.data_betahmf_get, _ccllib.data_betahmf_set, doc=r"""betahmf : p.gsl_spline""")
    gammahmf = property(_ccllib.data_gammahmf_get, _ccllib.data_gammahmf_set, doc=r"""gammahmf : p.gsl_spline""")
    phihmf = property(_ccllib.data_phihmf_get, _ccllib.data_phihmf_set, doc=r"""phihmf : p.gsl_spline""")
    etahmf = property(_ccllib.data_etahmf_get, _ccllib.data_etahmf_set, doc=r"""etahmf : p.gsl_spline""")
    p_lin = property(_ccllib.data_p_lin_get, _ccllib.data_p_lin_set, doc=r"""p_lin : p.ccl_f2d_t""")
    p_nl = property(_ccllib.data_p_nl_get, _ccllib.data_p_nl_set, doc=r"""p_nl : p.ccl_f2d_t""")
...
class cosmology(object):
    ...
    computed_linear_power = property(_ccllib.cosmology_computed_linear_power_get, _ccllib.cosmology_computed_linear_power_set, doc=r"""computed_linear_power : bool""")
    computed_nonlin_power = property(_ccllib.cosmology_computed_nonlin_power_get, _ccllib.cosmology_computed_nonlin_power_set, doc=r"""computed_nonlin_power : bool""")
    ...
    computed_hmfparams = property(_ccllib.cosmology_computed_hmfparams_get, _ccllib.cosmology_computed_hmfparams_set, doc=r"""computed_hmfparams : bool""")
...
def parameters_create(Omega_c, Omega_b, Omega_k, Neff, mnu, mnu_type, w0, wa, h, norm_pk, n_s, bcm_log10Mc, bcm_etab, bcm_ks, mu_0, sigma_0, nz_mgrowth, zarr_mgrowth, dfarr_mgrowth, status):
    r"""parameters_create(double Omega_c, double Omega_b, double Omega_k, double Neff, double * mnu, ccl_mnu_convention mnu_type, double w0, double wa, double h, double norm_pk, double n_s, double bcm_log10Mc, double bcm_etab, double bcm_ks, double mu_0, double sigma_0, int nz_mgrowth, double * zarr_mgrowth, double * dfarr_mgrowth, int * status) -> parameters"""
    return _ccllib.parameters_create(Omega_c, Omega_b, Omega_k, Neff, mnu, mnu_type, w0, wa, h, norm_pk, n_s, bcm_log10Mc, bcm_etab, bcm_ks, mu_0, sigma_0, nz_mgrowth, zarr_mgrowth, dfarr_mgrowth, status)

def parameters_create_flat_lcdm(Omega_c, Omega_b, h, norm_pk, n_s, status):
    r"""parameters_create_flat_lcdm(double Omega_c, double Omega_b, double h, double norm_pk, double n_s, int * status) -> parameters"""
...
def parameters_write_yaml(params, filename, status):
    r"""parameters_write_yaml(parameters params, char const * filename, int * status)"""
    return _ccllib.parameters_write_yaml(params, filename, status)

def parameters_read_yaml(filename, status):
    r"""parameters_read_yaml(char const * filename, int * status) -> parameters"""
    return _ccllib.parameters_read_yaml(filename, status)
...
def parameters_create_nu(Omega_c, Omega_b, Omega_k, Neff, w0, wa, h, norm_pk, n_s, bcm_log10Mc, bcm_etab, bcm_ks, mu_0, sigma_0, mnu_is_sum, m_nu, status):
    r"""parameters_create_nu(double Omega_c, double Omega_b, double Omega_k, double Neff, double w0, double wa, double h, double norm_pk, double n_s, double bcm_log10Mc, double bcm_etab, double bcm_ks, double mu_0, double sigma_0, int mnu_is_sum, double * m_nu, int * status) -> parameters"""
    return _ccllib.parameters_create_nu(Omega_c, Omega_b, Omega_k, Neff, w0, wa, h, norm_pk, n_s, bcm_log10Mc, bcm_etab, bcm_ks, mu_0, sigma_0, mnu_is_sum, m_nu, status)

def parameters_create_nu_vec(Omega_c, Omega_b, Omega_k, Neff, w0, wa, h, norm_pk, n_s, bcm_log10Mc, bcm_etab, bcm_ks, mu_0, sigma_0, zarr, dfarr, mnu_is_sum, m_nu, status):
    r"""parameters_create_nu_vec(double Omega_c, double Omega_b, double Omega_k, double Neff, double w0, double wa, double h, double norm_pk, double n_s, double bcm_log10Mc, double bcm_etab, double bcm_ks, double mu_0, double sigma_0, double * zarr, double * dfarr, int mnu_is_sum, double * m_nu, int * status) -> parameters"""

    if numpy.shape(zarr) != numpy.shape(dfarr):
        raise CCLError("Input shape for `zarr` must match `dfarr`!")


    return _ccllib.parameters_create_nu_vec(Omega_c, Omega_b, Omega_k, Neff, w0, wa, h, norm_pk, n_s, bcm_log10Mc, bcm_etab, bcm_ks, mu_0, sigma_0, zarr, dfarr, mnu_is_sum, m_nu, status)
f2d_cclgrowth = _ccllib.f2d_cclgrowth

f2d_customgrowth = _ccllib.f2d_customgrowth
...
class f2d_t(object):
    ...
    growth = property(_ccllib.f2d_t_growth_get, _ccllib.f2d_t_growth_set, doc=r"""growth : p.f(double).double""")
...
def f2d_t_new(na, a_arr, nk, lk_arr, fka_arr, fk_arr, fa_arr, is_factorizable, extrap_order_lok, extrap_order_hik, extrap_linear_growth, is_fka_log, growth, growth_factor_0, growth_exponent, interp_type, status):
    r"""f2d_t_new(int na, double * a_arr, int nk, double * lk_arr, double * fka_arr, double * fk_arr, double * fa_arr, int is_factorizable, int extrap_order_lok, int extrap_order_hik, ccl_f2d_extrap_growth_t extrap_linear_growth, int is_fka_log, double (*)(double) growth, double growth_factor_0, int growth_exponent, ccl_f2d_interp_t interp_type, int * status) -> f2d_t"""


    return _ccllib.f2d_t_new(na, a_arr, nk, lk_arr, fka_arr, fk_arr, fa_arr, is_factorizable, extrap_order_lok, extrap_order_hik, extrap_linear_growth, is_fka_log, growth, growth_factor_0, growth_exponent, interp_type, status)
...
def Sig_MG(cosmo, a, status):
    r"""Sig_MG(cosmology cosmo, double a, int * status) -> double"""


    return _ccllib.Sig_MG(cosmo, a, status)

def mu_MG(cosmo, a, status):
    r"""mu_MG(cosmology cosmo, double a, int * status) -> double"""


    return _ccllib.mu_MG(cosmo, a, status)
...
def mu_MG_vec(cosmo, a, nout, status):
    r"""mu_MG_vec(cosmology cosmo, double * a, int nout, int * status)"""

    if numpy.shape(a) != (nout,):
        raise CCLError("Input shape for `a` must match `(nout,)`!")


    return _ccllib.mu_MG_vec(cosmo, a, nout, status)

def Sig_MG_vec(cosmo, a, nout, status):
    r"""Sig_MG_vec(cosmology cosmo, double * a, int nout, int * status)"""

    if numpy.shape(a) != (nout,):
        raise CCLError("Input shape for `a` must match `(nout,)`!")


    return _ccllib.Sig_MG_vec(cosmo, a, nout, status)
...
def linear_matter_power(cosmo, k, a, status):
    r"""linear_matter_power(cosmology cosmo, double k, double a, int * status) -> double"""


    return _ccllib.linear_matter_power(cosmo, k, a, status)

def nonlin_matter_power(cosmo, k, a, status):
    r"""nonlin_matter_power(cosmology cosmo, double k, double a, int * status) -> double"""


    return _ccllib.nonlin_matter_power(cosmo, k, a, status)

def cosmology_compute_linear_power(cosmo, psp, status):
    r"""cosmology_compute_linear_power(cosmology cosmo, f2d_t psp, int * status)"""


    return _ccllib.cosmology_compute_linear_power(cosmo, psp, status)

def cosmology_compute_nonlin_power(cosmo, status):
    r"""cosmology_compute_nonlin_power(cosmology cosmo, int * status)"""


    return _ccllib.cosmology_compute_nonlin_power(cosmo, status)

def sigmaR(cosmo, R, a, status):
    r"""sigmaR(cosmology cosmo, double R, double a, int * status) -> double"""


    return _ccllib.sigmaR(cosmo, R, a, status)

def sigmaV(cosmo, R, a, status):
    r"""sigmaV(cosmology cosmo, double R, double a, int * status) -> double"""


    return _ccllib.sigmaV(cosmo, R, a, status)

def sigma8(cosmo, status):
    r"""sigma8(cosmology cosmo, int * status) -> double"""


    return _ccllib.sigma8(cosmo, status)

def linear_matter_power_vec(cosmo, a, k, nout, status):
    r"""linear_matter_power_vec(cosmology cosmo, double a, double * k, int nout, int * status)"""

    if numpy.shape(k) != (nout,):
        raise CCLError("Input shape for `k` must match `(nout,)`!")


    return _ccllib.linear_matter_power_vec(cosmo, a, k, nout, status)

def nonlin_matter_power_vec(cosmo, a, k, nout, status):
    r"""nonlin_matter_power_vec(cosmology cosmo, double a, double * k, int nout, int * status)"""

    if numpy.shape(k) != (nout,):
        raise CCLError("Input shape for `k` must match `(nout,)`!")


    return _ccllib.nonlin_matter_power_vec(cosmo, a, k, nout, status)

def sigmaR_vec(cosmo, a, R, nout, status):
    r"""sigmaR_vec(cosmology cosmo, double a, double * R, int nout, int * status)"""

    if numpy.shape(R) != (nout,):
        raise CCLError("Input shape for `R` must match `(nout,)`!")


    return _ccllib.sigmaR_vec(cosmo, a, R, nout, status)

def sigmaV_vec(cosmo, a, R, nout, status):
    r"""sigmaV_vec(cosmology cosmo, double a, double * R, int nout, int * status)"""

    if numpy.shape(R) != (nout,):
        raise CCLError("Input shape for `R` must match `(nout,)`!")


    return _ccllib.sigmaV_vec(cosmo, a, R, nout, status)
...
def correlation_3d(cosmo, a, n_r, r, xi, do_taper_pk, taper_pk_limits, status):
    r"""correlation_3d(cosmology cosmo, double a, int n_r, double * r, double * xi, int do_taper_pk, double * taper_pk_limits, int * status)"""


    return _ccllib.correlation_3d(cosmo, a, n_r, r, xi, do_taper_pk, taper_pk_limits, status)

def correlation_multipole(cosmo, a, beta, l, n_s, s, xi, status):
    r"""correlation_multipole(cosmology cosmo, double a, double beta, int l, int n_s, double * s, double * xi, int * status)"""


    return _ccllib.correlation_multipole(cosmo, a, beta, l, n_s, s, xi, status)

def correlation_multipole_spline(cosmo, a, status):
    r"""correlation_multipole_spline(cosmology cosmo, double a, int * status)"""


    return _ccllib.correlation_multipole_spline(cosmo, a, status)

def correlation_3dRsd(cosmo, a, n_s, s, mu, beta, xi, use_spline, status):
    r"""correlation_3dRsd(cosmology cosmo, double a, int n_s, double * s, double mu, double beta, double * xi, int use_spline, int * status)"""


    return _ccllib.correlation_3dRsd(cosmo, a, n_s, s, mu, beta, xi, use_spline, status)

def correlation_3dRsd_avgmu(cosmo, a, n_s, s, beta, xi, status):
    r"""correlation_3dRsd_avgmu(cosmology cosmo, double a, int n_s, double * s, double beta, double * xi, int * status)"""


    return _ccllib.correlation_3dRsd_avgmu(cosmo, a, n_s, s, beta, xi, status)

def correlation_pi_sigma(cosmo, a, beta, pi, n_sig, sig, xi, use_spline, status):
    r"""correlation_pi_sigma(cosmology cosmo, double a, double beta, double pi, int n_sig, double * sig, double * xi, int use_spline, int * status)"""


    return _ccllib.correlation_pi_sigma(cosmo, a, beta, pi, n_sig, sig, xi, use_spline, status)
...
def correlation_3d_vec(cosmo, a, r, nxi, status):
    r"""correlation_3d_vec(cosmology cosmo, double a, double * r, int nxi, int * status)"""

    if numpy.shape(r) != (nxi,):
        raise CCLError("Input shape for `r` must match `(nxi,)`!")


    return _ccllib.correlation_3d_vec(cosmo, a, r, nxi, status)

def correlation_multipole_vec(cosmo, a, beta, l, s, nxis, status):
    r"""correlation_multipole_vec(cosmology cosmo, double a, double beta, int l, double * s, int nxis, int * status)"""

    if numpy.shape(s) != (nxis,):
        raise CCLError("Input shape for `s` must match `(nxis,)`!")


    return _ccllib.correlation_multipole_vec(cosmo, a, beta, l, s, nxis, status)

def correlation_3dRsd_vec(cosmo, a, mu, beta, s, nxis, use_spline, status):
    r"""correlation_3dRsd_vec(cosmology cosmo, double a, double mu, double beta, double * s, int nxis, int use_spline, int * status)"""

    if numpy.shape(s) != (nxis,):
        raise CCLError("Input shape for `s` must match `(nxis,)`!")


    return _ccllib.correlation_3dRsd_vec(cosmo, a, mu, beta, s, nxis, use_spline, status)

def correlation_3dRsd_avgmu_vec(cosmo, a, beta, s, nxis, status):
    r"""correlation_3dRsd_avgmu_vec(cosmology cosmo, double a, double beta, double * s, int nxis, int * status)"""

    if numpy.shape(s) != (nxis,):
        raise CCLError("Input shape for `s` must match `(nxis,)`!")


    return _ccllib.correlation_3dRsd_avgmu_vec(cosmo, a, beta, s, nxis, status)

def correlation_pi_sigma_vec(cosmo, a, beta, pie, sig, nxis, use_spline, status):
    r"""correlation_pi_sigma_vec(cosmology cosmo, double a, double beta, double pie, double * sig, int nxis, int use_spline, int * status)"""

    if numpy.shape(sig) != (nxis,):
        raise CCLError("Input shape for `sig` must match `(nxis,)`!")


    return _ccllib.correlation_pi_sigma_vec(cosmo, a, beta, pie, sig, nxis, use_spline, status)

def cosmology_compute_sigma(cosmo, status):
    r"""cosmology_compute_sigma(cosmology cosmo, int * status)"""


    return _ccllib.cosmology_compute_sigma(cosmo, status)

def cosmology_compute_hmfparams(cosmo, status):
    r"""cosmology_compute_hmfparams(cosmology cosmo, int * status)"""


    return _ccllib.cosmology_compute_hmfparams(cosmo, status)

def massfunc(cosmo, smooth_mass, a, odelta, status):
    r"""massfunc(cosmology cosmo, double smooth_mass, double a, double odelta, int * status) -> double"""


    return _ccllib.massfunc(cosmo, smooth_mass, a, odelta, status)

def halo_bias(cosmo, smooth_mass, a, odelta, status):
    r"""halo_bias(cosmology cosmo, double smooth_mass, double a, double odelta, int * status) -> double"""


    return _ccllib.halo_bias(cosmo, smooth_mass, a, odelta, status)

def massfunc_m2r(cosmo, smooth_mass, status):
    r"""massfunc_m2r(cosmology cosmo, double smooth_mass, int * status) -> double"""


    return _ccllib.massfunc_m2r(cosmo, smooth_mass, status)

def sigmaM(cosmo, smooth_mass, a, status):
    r"""sigmaM(cosmology cosmo, double smooth_mass, double a, int * status) -> double"""
...
def r_delta(cosmo, halomass, a, odelta, status):
    r"""r_delta(cosmology cosmo, double halomass, double a, double odelta, int * status) -> double"""


    return _ccllib.r_delta(cosmo, halomass, a, odelta, status)

def massfunc_vec(cosmo, a, odelta, halo_mass, nout, status):
    r"""massfunc_vec(cosmology cosmo, double a, double odelta, double * halo_mass, int nout, int * status)"""

    if numpy.shape(halo_mass) != (nout,):
        raise CCLError("Input shape for `halo_mass` must match `(nout,)`!")


    return _ccllib.massfunc_vec(cosmo, a, odelta, halo_mass, nout, status)

def massfunc_m2r_vec(cosmo, halo_mass, nout, status):
    r"""massfunc_m2r_vec(cosmology cosmo, double * halo_mass, int nout, int * status)"""

    if numpy.shape(halo_mass) != (nout,):
        raise CCLError("Input shape for `halo_mass` must match `(nout,)`!")


    return _ccllib.massfunc_m2r_vec(cosmo, halo_mass, nout, status)

def sigmaM_vec(cosmo, a, halo_mass, nout, status):
    r"""sigmaM_vec(cosmology cosmo, double a, double * halo_mass, int nout, int * status)"""

    if numpy.shape(halo_mass) != (nout,):
        raise CCLError("Input shape for `halo_mass` must match `(nout,)`!")


    return _ccllib.sigmaM_vec(cosmo, a, halo_mass, nout, status)

def halo_bias_vec(cosmo, a, odelta, halo_mass, nout, status):
    r"""halo_bias_vec(cosmology cosmo, double a, double odelta, double * halo_mass, int nout, int * status)"""

    if numpy.shape(halo_mass) != (nout,):
        raise CCLError("Input shape for `halo_mass` must match `(nout,)`!")


    return _ccllib.halo_bias_vec(cosmo, a, odelta, halo_mass, nout, status)
...
def angular_cls_limber(cosmo, trc1, trc2, psp, nl_out, l_out, cl_out, status):
    r"""angular_cls_limber(cosmology cosmo, cl_tracer_collection_t trc1, cl_tracer_collection_t trc2, f2d_t psp, int nl_out, double * l_out, double * cl_out, int * status)"""


    return _ccllib.angular_cls_limber(cosmo, trc1, trc2, psp, nl_out, l_out, cl_out, status)
...
def angular_cl_vec(cosmo, clt1, clt2, pspec, l_limber, ell, nout, status):
    r"""angular_cl_vec(cosmology cosmo, cl_tracer_collection_t clt1, cl_tracer_collection_t clt2, f2d_t pspec, double l_limber, double * ell, int nout, int * status)"""

    if numpy.shape(ell) != (nout,):
        raise CCLError("Input shape for `ell` must match `(nout,)`!")


    return _ccllib.angular_cl_vec(cosmo, clt1, clt2, pspec, l_limber, ell, nout, status)
...
def calculate_nu_phasespace_spline(status):
    r"""calculate_nu_phasespace_spline(int * status) -> gsl_spline *"""
...
def twohalo_matter_power(cosmo, k, a, status):
    r"""twohalo_matter_power(cosmology cosmo, double k, double a, int * status) -> double"""


    return _ccllib.twohalo_matter_power(cosmo, k, a, status)

def onehalo_matter_power(cosmo, k, a, status):
    r"""onehalo_matter_power(cosmology cosmo, double k, double a, int * status) -> double"""


    return _ccllib.onehalo_matter_power(cosmo, k, a, status)

def halomodel_matter_power(cosmo, k, a, status):
    r"""halomodel_matter_power(cosmology cosmo, double k, double a, int * status) -> double"""


    return _ccllib.halomodel_matter_power(cosmo, k, a, status)

def halo_concentration(cosmo, halomass, a, odelta, status):
    r"""halo_concentration(cosmology cosmo, double halomass, double a, double odelta, int * status) -> double"""


    return _ccllib.halo_concentration(cosmo, halomass, a, odelta, status)

def onehalo_matter_power_vec(cosmo, a, k, nout, status):
    r"""onehalo_matter_power_vec(cosmology cosmo, double a, double * k, int nout, int * status)"""

    if numpy.shape(k) != (nout,):
        raise CCLError("Input shape for `k` must match `(nout,)`!")


    return _ccllib.onehalo_matter_power_vec(cosmo, a, k, nout, status)

def twohalo_matter_power_vec(cosmo, a, k, nout, status):
    r"""twohalo_matter_power_vec(cosmology cosmo, double a, double * k, int nout, int * status)"""

    if numpy.shape(k) != (nout,):
        raise CCLError("Input shape for `k` must match `(nout,)`!")


    return _ccllib.twohalo_matter_power_vec(cosmo, a, k, nout, status)

def halomodel_matter_power_vec(cosmo, a, k, nout, status):
    r"""halomodel_matter_power_vec(cosmology cosmo, double a, double * k, int nout, int * status)"""

    if numpy.shape(k) != (nout,):
        raise CCLError("Input shape for `k` must match `(nout,)`!")


    return _ccllib.halomodel_matter_power_vec(cosmo, a, k, nout, status)

def halo_concentration_vec(cosmo, a, odelta, halo_mass, nout, status):
    r"""halo_concentration_vec(cosmology cosmo, double a, double odelta, double * halo_mass, int nout, int * status)"""

    if numpy.shape(halo_mass) != (nout,):
        raise CCLError("Input shape for `halo_mass` must match `(nout,)`!")


    return _ccllib.halo_concentration_vec(cosmo, a, odelta, halo_mass, nout, status)

def halo_profile_nfw_vec(cosmo, c, halomass, massdef_delta_m, a, r, nout, status):
    r"""halo_profile_nfw_vec(cosmology cosmo, double c, double halomass, double massdef_delta_m, double a, double * r, int nout, int * status)"""

    if numpy.shape(r) != (nout,):
        raise CCLError("Input shape for `r` must match `(nout,)`!")


    return _ccllib.halo_profile_nfw_vec(cosmo, c, halomass, massdef_delta_m, a, r, nout, status)

def projected_halo_profile_nfw_vec(cosmo, c, halomass, massdef_delta_m, a, r, nout, status):
    r"""projected_halo_profile_nfw_vec(cosmology cosmo, double c, double halomass, double massdef_delta_m, double a, double * r, int nout, int * status)"""

    if numpy.shape(r) != (nout,):
        raise CCLError("Input shape for `r` must match `(nout,)`!")


    return _ccllib.projected_halo_profile_nfw_vec(cosmo, c, halomass, massdef_delta_m, a, r, nout, status)

def halo_profile_einasto_vec(cosmo, c, halomass, massdef_delta_m, a, r, nout, status):
    r"""halo_profile_einasto_vec(cosmology cosmo, double c, double halomass, double massdef_delta_m, double a, double * r, int nout, int * status)"""

    if numpy.shape(r) != (nout,):
        raise CCLError("Input shape for `r` must match `(nout,)`!")


    return _ccllib.halo_profile_einasto_vec(cosmo, c, halomass, massdef_delta_m, a, r, nout, status)

def halo_profile_hernquist_vec(cosmo, c, halomass, massdef_delta_m, a, r, nout, status):
    r"""halo_profile_hernquist_vec(cosmology cosmo, double c, double halomass, double massdef_delta_m, double a, double * r, int nout, int * status)"""

    if numpy.shape(r) != (nout,):
        raise CCLError("Input shape for `r` must match `(nout,)`!")


    return _ccllib.halo_profile_hernquist_vec(cosmo, c, halomass, massdef_delta_m, a, r, nout, status)
