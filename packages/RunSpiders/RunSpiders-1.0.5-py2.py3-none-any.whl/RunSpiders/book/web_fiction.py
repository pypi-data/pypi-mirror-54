...
class WebFictionSpider:
    ...
    def recipe_to_ebook(self, recipe, ebook_format='mobi'):
        ...
        if not recipe_name.endswith('.recipe'):
            ...
            return
        ebook_name = recipe_name.replace(".recipe", "." + ebook_format)
        ebook = os.path.join(self.book_folder, ebook_name)
        ...
        try:
            os.system('ebook-convert "{}" "{}"'.format(recipe, ebook))
