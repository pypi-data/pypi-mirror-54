...
Your startup script /PATH/TO/serve.py,
...
.. code:: bash
  ...
  sudo /PATH/TO/serve.py -d

After binding 80 and 443, will drop root privileges.

For automating renew certification, add cron job,

.. code:: bash

  # try renew twice a day
  1 4,16 * * * /usr/bin/certbot renew --renew-hook="su - ubuntu -c 'sudo /PATH/TO/serve.py restart'"
