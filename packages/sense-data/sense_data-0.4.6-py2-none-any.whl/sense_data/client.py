...
class SenseDataService(object):
    ...
    def get_code_by_name(self, name):
        with grpc.insecure_channel(self._host + ":" + self._port,
            ...
            _response = _stub.get_code_by_name(stock_pb2.Request(entity_name=_name))
            # print(_response)
            _status = _response.status
            if _status.code != 0:
    ...
    def get_detail_info_by_name(self, name):
        with grpc.insecure_channel(self._host + ":" + self._port,
            ...
            _stub = stock_pb2_grpc.StockInfStub(channel)
            _name = json.dumps(name)
            _response = _stub.get_detail_info_by_name(stock_pb2.Request(entity_name=_name))
            # print(_response)
            _status = _response.status
            if _status.code != 0:
...
if __name__ == '__main__':
    ...
    r = sense_data.get_detail_info_by_name('南方人民币')
    print(r)
