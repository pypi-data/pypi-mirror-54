...
class SuiteResultDTO:
    ...
    def get_suite_result_dto(self, terminalreporter, global_values, db_measurement_name_for_suite):
        ...
        suite_result_dto.set_retries(suite_results_dict.get('reruns'))
        ...
        suite_result_dto.set_suite_custom_values(global_values.get("influxdb_values"))

        suite_result_dto.merge_suite_result(global_values.get('merged'), global_values.get("influxdb_values"),
