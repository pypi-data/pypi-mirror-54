...
from ._odata.constants import ORDER_BY_CREATEDTIME_EXPRESSION, NAME_EXPRESSION
...
class WorkspaceClient(ClientBase):
    ...
    def list_experiments(self, last=None, order_by=None, experiment_name=None, view_type=None):
        """
        ...
        if experiment_name is not None:
            filter_expression = NAME_EXPRESSION + experiment_name
