...
class Experiment(ChainedIdentity, HasExperimentPortal):
    ...
    @staticmethod
    def list(workspace, experiment_name=None, view_type=ViewType.ActiveOnly):
        ...
        experiments = workspace_client.list_experiments(experiment_name=experiment_name, view_type=view_type)
        return [Experiment(workspace,
                           experiment.name,
                           _id=experiment.experiment_id,
                           _archived_time=experiment.archived_time,
                           _create_in_cloud=False,
                           _skip_name_validation=True) for experiment in experiments]
