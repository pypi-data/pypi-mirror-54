    ...
    * :class:`azureml.data.FileDataset` references single or multiple files in datastores
    ...
    .. remarks::
        ...
        * ``Dataset.File.from_files()``
        ...
        The following example shows how to create a FileDataset referencing multiple files.
    ...
    def get(workspace, name=None, id=None):
        ...
        .. note::
            ...
            This method will be deprecated in a future release. Use the
            :meth:`azureml.core.Dataset.get_by_name` instead. To learn about why this will
            be deprecated, see https://aka.ms/tabular-dataset.

        .. remarks::

            You can provide either ``name`` or ``id``. An exeception is raised if:
    ...
    def from_pandas_dataframe(
        ...
        .. note::
            ...
            This method will be deprecated in a future release. For more information,
            see https://aka.ms/tabular-dataset.
    ...
    def from_delimited_files(
        ...
        .. note::
            ...
            This method will be deprecated in a future release. Use
            ``Dataset.Tabular.from_delimited_files`` instead. To learn about why this is
            getting deprecated, see https://aka.ms/tabular-dataset.
    ...
    def auto_read_files(path, include_path=False, partition_format=None):
        ...
        .. note::
            ...
            This method will be deprecated in a future release. Use the ``Dataset.Tabular.from_*``
            methods to read files. To learn about why this is getting deprecated, see
    ...
    def from_parquet_files(path, include_path=False, partition_format=None):
        ...
        .. note::
            ...
            This method will be deprecated in a future release. Use
            ``Dataset.Tabular.from_parquet_files`` instead. To learn more about the why this is getting
            deprecated, see https://aka.ms/tabular-dataset.
    ...
    def from_excel_files(
        ...
        .. note::
            ...
            This method will be deprecated in a future release. For more information, see
            https://aka.ms/tabular-dataset.
    ...
    def from_binary_files(path):
        ...
        .. note::
            ...
            Dataset.File.from_files instead. To learn about why this is
            getting deprecated, see https://aka.ms/tabular-dataset.
    ...
    def from_sql_query(data_source, query):
        ...
        .. note::
            ...
            This method will be deprecated in a future release. Use
            ``Dataset.Tabular.from_sql_query`` instead. To learn about why this is getting deprecated,
            see https://aka.ms/tabular-dataset.
    ...
    def to_pandas_dataframe(self):
        ...
        .. note::
            ...
            This method will be deprecated in a future release. Create a
            ...
            method there. To learn about why this is getting deprecated, see https://aka.ms/tabular-dataset.
    ...
    def to_spark_dataframe(self):
        ...
        .. note::
            ...
            about why this is getting deprecated, see https://aka.ms/tabular-dataset.
    ...
    def sample(self, sample_strategy, arguments):
        ...
        .. note::
            ...
            This method will be deprecated in a future release. Create a
            :class:`azureml.data.TabularDataset` by calling the static methods on
            ``Dataset.Tabular`` and use the :meth:`azureml.data.TabularDataset.take_sample`
            method there. To learn more about why this is getting deprecated, see
            https://aka.ms/tabular-dataset.
    ...
    def __getitem__(self, key):
        ...
        .. note::
            ...
            This method will be deprecated in a future release. Create a TabularDataset by
            calling the static methods on ``Dataset.Tabular` and use the drop_columns/keep_columns
            method there. To learn about why this is getting deprecated, see
            https://aka.ms/tabular-dataset.
