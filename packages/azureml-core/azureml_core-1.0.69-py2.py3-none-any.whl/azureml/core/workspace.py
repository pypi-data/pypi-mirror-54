...
"""The workspace module manages the interactions with Azure Machine Learning Workspaces.
...
capabilities including Azure Resource Manager role-based access control and
region affinity to all machine learning data saved within the workspace.
The workspace is the primary means for billing.
"""
...
class Workspace(object):
    """The Workspace class manages the interactions with Azure Machine Learning Workspaces.
    ...
    https://docs.microsoft.com/azure/machine-learning/service/quickstart-create-workspace-with-python
    ...
    def from_config(path=None, auth=None, _logger=None, _file_name=None):
        ...
        Users can save the workspace Azure Resource Manager (ARM) properties using the write_config function,
    ...
    def create(name, auth=None, subscription_id=None, resource_group=None,
        ...
        :type location: str
        :param create_resource_group: When True the resource group will be created if it does not exist.
        ...
        :type exist_ok: bool
        :param show_output: If True, the method will print out incremental progress of the method.
    ...
    def write_config(self, path=None, file_name=None):
        ...
        Workspace ARM properties can be loaded later using from_config. The path defaults to '.azureml/'
    ...
    def datastores(self):
        ...
        :return: Dictionary with key as datastore name and value as a azureml.core.Datastore object.
    ...
    def datasets(self):
        ...
        :return: Dictionary with key as dataset name and value as azureml.core.Dataset within the workspace.
    ...
    def images(self):
        ...
        :return: Dictionary with key as image name and value as an azureml.core.Image object.
    ...
    @property
    def models(self):
        """Return a dictionary where the key is model name, and value is a azureml.core.Model object.
