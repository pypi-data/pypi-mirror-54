...
class AksEndpoint(AksWebservice):
    ...
    def create_version(self, version_name, autoscale_enabled=None, autoscale_min_replicas=None,
        ...
        if not inference_config or not models:
            raise WebserviceException('No models or inference_config is provided to create a version.',
                                      logger=module_logger)
...
class AksServiceDeploymentConfiguration(WebserviceDeploymentConfiguration):
    ...
    def _build_create_payload(self, name, environment_image_request, deployment_target=None):
        import copy
