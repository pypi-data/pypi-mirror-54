...
# TODO: This should check if AUTH0_DOMAIN is None.
...
if getattr(settings, 'AUTH0_OIDC_ENDPOINT', None) is not None:
    ...
    if AUTH0_DOMAIN is not None:
        AUTH0_OIDC_ENDPOINT = f'https://{AUTH0_DOMAIN}'
    else:
...
elif getattr(settings, 'SOCIAL_AUTH_AUTH0_MANAGEMENT_API_CLIENT_ID', None) is not None:
...
elif getattr(settings, 'SOCIAL_AUTH_AUTH0_MANAGEMENT_API_CLIENT_SECRET', None) is not None:
