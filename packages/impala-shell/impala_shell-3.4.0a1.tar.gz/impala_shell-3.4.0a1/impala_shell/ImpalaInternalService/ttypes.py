...
class TExecQueryFInstancesSidecar:
  """
  Attributes:
   - query_ctx
   - fragment_ctxs
  ...
  thrift_spec = (
    ...
    (2, TType.LIST, 'fragment_ctxs', (TType.STRUCT,(TPlanFragmentCtx, TPlanFragmentCtx.thrift_spec)), None, ), # 2
    (3, TType.LIST, 'fragment_instance_ctxs', (TType.STRUCT,(TPlanFragmentInstanceCtx, TPlanFragmentInstanceCtx.thrift_spec)), None, ), # 3
  )

  def __init__(self, query_ctx=None, fragment_ctxs=None, fragment_instance_ctxs=None,):
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('TExecQueryFInstancesSidecar')
    ...
    if self.fragment_ctxs is not None:
      oprot.writeFieldBegin('fragment_ctxs', TType.LIST, 2)
    ...
    if self.fragment_instance_ctxs is not None:
      oprot.writeFieldBegin('fragment_instance_ctxs', TType.LIST, 3)
...
class TBloomFilter:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.I32, 'log_bufferpool_space', None, None, ), # 1
    (2, TType.STRING, 'directory', None, None, ), # 2
    (3, TType.BOOL, 'always_true', None, None, ), # 3
    (4, TType.BOOL, 'always_false', None, None, ), # 4
  )

  def __init__(self, log_bufferpool_space=None, directory=None, always_true=None, always_false=None,):
    self.log_bufferpool_space = log_bufferpool_space
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.I32:
          self.log_bufferpool_space = iprot.readI32()
        else:
          iprot.skip(ftype)
      elif fid == 2:
        if ftype == TType.STRING:
  ...
  def write(self, oprot):
    ...
    if self.log_bufferpool_space is not None:
      oprot.writeFieldBegin('log_bufferpool_space', TType.I32, 1)
      oprot.writeI32(self.log_bufferpool_space)
      oprot.writeFieldEnd()
  ...
  def validate(self):
    if self.log_bufferpool_space is None:
      raise TProtocol.TProtocolException(message='Required field log_bufferpool_space is unset!')
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.log_bufferpool_space)
    value = (value * 31) ^ hash(self.directory)
    value = (value * 31) ^ hash(self.always_true)
    value = (value * 31) ^ hash(self.always_false)
    return value
...
class TUpdateFilterParams:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.min_max_filter)
    return value
...
class TPublishFilterParams:
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.protocol_version)
    value = (value * 31) ^ hash(self.filter_id)
    value = (value * 31) ^ hash(self.dst_query_id)
    value = (value * 31) ^ hash(self.dst_fragment_idx)
    value = (value * 31) ^ hash(self.bloom_filter)
    value = (value * 31) ^ hash(self.min_max_filter)
    return value
