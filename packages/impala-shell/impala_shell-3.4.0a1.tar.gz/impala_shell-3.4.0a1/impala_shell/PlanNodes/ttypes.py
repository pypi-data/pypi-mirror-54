...
class TRuntimeFilterDesc:
  ...
  def __init__(self, filter_id=None, src_expr=None, targets=None, planid_to_target_ndx=None, is_broadcast_join=None, has_local_targets=None, has_remote_targets=None, applied_on_partition_columns=None, ndv_estimate=None, type=None, filter_size_bytes=None,):
...
class TAggregationNode:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i122 in xrange(_size118):
            _elem123 = TAggregator()
            _elem123.read(iprot)
            self.aggregators.append(_elem123)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
  ...
  def write(self, oprot):
    ...
    if self.aggregators is not None:
      ...
      for iter124 in self.aggregators:
        iter124.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
...
class TSortInfo:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i129 in xrange(_size125):
            ...
            _elem130.read(iprot)
            self.ordering_exprs.append(_elem130)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
        if ftype == TType.LIST:
          ...
          for _i135 in xrange(_size131):
            ...
            self.is_asc_order.append(_elem136)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 3:
        if ftype == TType.LIST:
          ...
          for _i141 in xrange(_size137):
            ...
            self.nulls_first.append(_elem142)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
        if ftype == TType.LIST:
          ...
          for _i147 in xrange(_size143):
            _elem148 = Exprs.ttypes.TExpr()
            _elem148.read(iprot)
            self.sort_tuple_slot_exprs.append(_elem148)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 5:
  ...
  def write(self, oprot):
    ...
    if self.ordering_exprs is not None:
      ...
      for iter149 in self.ordering_exprs:
        iter149.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.is_asc_order is not None:
      ...
      for iter150 in self.is_asc_order:
    ...
    if self.nulls_first is not None:
      ...
      for iter151 in self.nulls_first:
        oprot.writeBool(iter151)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.sort_tuple_slot_exprs is not None:
      ...
      for iter152 in self.sort_tuple_slot_exprs:
        iter152.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
...
class TAnalyticNode:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i157 in xrange(_size153):
            ...
            _elem158.read(iprot)
            self.partition_exprs.append(_elem158)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
        if ftype == TType.LIST:
          ...
          for _i163 in xrange(_size159):
            _elem164 = Exprs.ttypes.TExpr()
            _elem164.read(iprot)
            self.order_by_exprs.append(_elem164)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 3:
        if ftype == TType.LIST:
          ...
          for _i169 in xrange(_size165):
            _elem170 = Exprs.ttypes.TExpr()
            _elem170.read(iprot)
            self.analytic_functions.append(_elem170)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
  ...
  def write(self, oprot):
    ...
    if self.partition_exprs is not None:
      ...
      for iter171 in self.partition_exprs:
        iter171.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.order_by_exprs is not None:
      ...
      for iter172 in self.order_by_exprs:
        iter172.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.analytic_functions is not None:
      ...
      for iter173 in self.analytic_functions:
        iter173.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
...
class TUnionNode:
        ...
        if ftype == TType.LIST:
          ...
          for _i178 in xrange(_size174):
            ...
            for _i184 in xrange(_size180):
              _elem185 = Exprs.ttypes.TExpr()
              _elem185.read(iprot)
              _elem179.append(_elem185)
            iprot.readListEnd()
            self.result_expr_lists.append(_elem179)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 3:
        if ftype == TType.LIST:
          ...
          for _i190 in xrange(_size186):
            ...
            for _i196 in xrange(_size192):
              _elem197 = Exprs.ttypes.TExpr()
              _elem197.read(iprot)
              _elem191.append(_elem197)
            iprot.readListEnd()
            self.const_expr_lists.append(_elem191)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
  ...
  def write(self, oprot):
    ...
    if self.result_expr_lists is not None:
      ...
      for iter198 in self.result_expr_lists:
    ...
    if self.const_expr_lists is not None:
      ...
      for iter200 in self.const_expr_lists:
        oprot.writeListBegin(TType.STRUCT, len(iter200))
        for iter201 in iter200:
          iter201.write(oprot)
        oprot.writeListEnd()
      oprot.writeListEnd()
      oprot.writeFieldEnd()
...
class TExchangeNode:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i206 in xrange(_size202):
            ...
            self.input_row_tuples.append(_elem207)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
  ...
  def write(self, oprot):
    ...
    if self.input_row_tuples is not None:
      ...
      for iter208 in self.input_row_tuples:
...
class TPlanNode:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i213 in xrange(_size209):
            ...
            self.row_tuples.append(_elem214)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 6:
        if ftype == TType.LIST:
          ...
          for _i219 in xrange(_size215):
            ...
            self.nullable_tuples.append(_elem220)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 7:
        if ftype == TType.LIST:
          ...
          for _i225 in xrange(_size221):
            _elem226 = Exprs.ttypes.TExpr()
            _elem226.read(iprot)
            self.conjuncts.append(_elem226)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 8:
        ...
        if ftype == TType.LIST:
          ...
          for _i231 in xrange(_size227):
            _elem232 = TPipelineMembership()
            _elem232.read(iprot)
            self.pipelines.append(_elem232)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 9:
        ...
        if ftype == TType.LIST:
          ...
          for _i237 in xrange(_size233):
            _elem238 = TRuntimeFilterDesc()
            _elem238.read(iprot)
            self.runtime_filters.append(_elem238)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 25:
  ...
  def write(self, oprot):
    ...
    if self.row_tuples is not None:
      ...
      for iter239 in self.row_tuples:
    ...
    if self.nullable_tuples is not None:
      ...
      for iter240 in self.nullable_tuples:
    ...
    if self.runtime_filters is not None:
      ...
      for iter242 in self.runtime_filters:
        iter242.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.resource_profile is not None:
