...
class TUpdateCatalogCacheResponse:
  ...
  thrift_spec = (
    ...
    (2, TType.I64, 'min_catalog_object_version', None, None, ), # 2
    (3, TType.I64, 'new_catalog_version', None, None, ), # 3
  )

  def __init__(self, catalog_service_id=None, min_catalog_object_version=None, new_catalog_version=None,):
    self.catalog_service_id = catalog_service_id
    self.min_catalog_object_version = min_catalog_object_version
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.I64:
          self.min_catalog_object_version = iprot.readI64()
        else:
          iprot.skip(ftype)
      elif fid == 3:
        if ftype == TType.I64:
  ...
  def write(self, oprot):
    ...
    if self.catalog_service_id is not None:
      ...
      self.catalog_service_id.write(oprot)
      oprot.writeFieldEnd()
    if self.min_catalog_object_version is not None:
      oprot.writeFieldBegin('min_catalog_object_version', TType.I64, 2)
      oprot.writeI64(self.min_catalog_object_version)
      oprot.writeFieldEnd()
  ...
  def validate(self):
    ...
    if self.min_catalog_object_version is None:
      raise TProtocol.TProtocolException(message='Required field min_catalog_object_version is unset!')
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.catalog_service_id)
    value = (value * 31) ^ hash(self.min_catalog_object_version)
