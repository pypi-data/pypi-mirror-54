...
class TCreateTableParams:
  ...
  def write(self, oprot):
    ...
    if self.partition_columns is not None:
      ...
      for iter205 in self.partition_columns:
        iter205.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.file_format is not None:
    ...
    if self.table_properties is not None:
      ...
      for kiter206,viter207 in self.table_properties.items():
    ...
    if self.serde_properties is not None:
      ...
      for kiter208,viter209 in self.serde_properties.items():
    ...
    if self.partition_by is not None:
      ...
      for iter210 in self.partition_by:
        iter210.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.primary_key_column_names is not None:
      ...
      for iter211 in self.primary_key_column_names:
    ...
    if self.sort_columns is not None:
      ...
      oprot.writeListBegin(TType.STRING, len(self.sort_columns))
      for iter212 in self.sort_columns:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i217 in xrange(_size213):
            _elem218 = CatalogObjects.ttypes.TColumn()
            _elem218.read(iprot)
            self.columns.append(_elem218)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 3:
...
class TComputeStatsParams:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i224 in xrange(_size220):
            _elem225 = CatalogObjects.ttypes.TPartitionStats()
            _elem225.read(iprot)
            self.existing_part_stats.append(_elem225)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 6:
        if ftype == TType.LIST:
          ...
          for _i230 in xrange(_size226):
            ...
            iprot.readListEnd()
            self.expected_partitions.append(_elem231)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 7:
  ...
  def write(self, oprot):
    ...
    if self.existing_part_stats is not None:
      ...
      for iter238 in self.existing_part_stats:
        iter238.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.expected_partitions is not None:
      ...
      for iter239 in self.expected_partitions:
        oprot.writeListBegin(TType.STRING, len(iter239))
        for iter240 in iter239:
...
class TGrantRevokeRoleParams:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i245 in xrange(_size241):
            ...
            self.role_names.append(_elem246)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
        if ftype == TType.LIST:
          ...
          for _i251 in xrange(_size247):
            ...
            self.group_names.append(_elem252)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 3:
  ...
  def write(self, oprot):
    ...
    if self.role_names is not None:
      ...
      for iter253 in self.role_names:
    ...
    if self.group_names is not None:
      ...
      for iter254 in self.group_names:
...
class TGrantRevokePrivParams:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i259 in xrange(_size255):
            _elem260 = CatalogObjects.ttypes.TPrivilege()
            _elem260.read(iprot)
            self.privileges.append(_elem260)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
  ...
  def write(self, oprot):
    ...
    if self.privileges is not None:
      ...
      for iter261 in self.privileges:
        iter261.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i266 in xrange(_size262):
            ...
            _elem267.read(iprot)
            self.arg_types.append(_elem267)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 3:
...
class TTableUsageMetrics:
  ...
  def __init__(self, table_name=None, memory_estimate_bytes=None, num_metadata_operations=None, num_files=None,):
    self.table_name = table_name
...
class TGetCatalogUsageResponse:
  ...
  def __init__(self, large_tables=None, frequently_accessed_tables=None, high_file_count_tables=None,):
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i273 in xrange(_size269):
            _elem274 = TTableUsageMetrics()
            _elem274.read(iprot)
            self.large_tables.append(_elem274)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
        if ftype == TType.LIST:
          ...
          for _i279 in xrange(_size275):
            _elem280 = TTableUsageMetrics()
            _elem280.read(iprot)
            self.frequently_accessed_tables.append(_elem280)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 3:
        if ftype == TType.LIST:
          ...
          for _i285 in xrange(_size281):
            _elem286 = TTableUsageMetrics()
            _elem286.read(iprot)
            self.high_file_count_tables.append(_elem286)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.large_tables is not None:
      ...
      for iter287 in self.large_tables:
        iter287.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.frequently_accessed_tables is not None:
      ...
      for iter288 in self.frequently_accessed_tables:
        iter288.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.high_file_count_tables is not None:
      ...
      for iter289 in self.high_file_count_tables:
        iter289.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
