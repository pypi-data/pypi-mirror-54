...
class THdfsTable:
  ...
  def __init__(self, hdfsBaseDir=None, colNames=None, nullPartitionKeyValue=None, nullColumnValue=None, avroSchema=None, partitions=None, prototype_partition=None, partition_prefixes=None, network_addresses=None,):
