...
class TBackendDescriptor:
  ...
  thrift_spec = (
    ...
    (8, TType.I64, 'admit_mem_limit', None, None, ), # 8
    (9, TType.BOOL, 'is_quiescing', None, None, ), # 9
    (10, TType.LIST, 'executor_groups', (TType.STRUCT,(TExecutorGroupDesc, TExecutorGroupDesc.thrift_spec)), None, ), # 10
    (11, TType.I64, 'admission_slots', None, None, ), # 11
  )

  def __init__(self, address=None, ip_address=None, is_coordinator=None, is_executor=None, debug_http_address=None, secure_webserver=None, krpc_address=None, admit_mem_limit=None, is_quiescing=None, executor_groups=None, admission_slots=None,):
  ...
  def write(self, oprot):
    ...
    if self.admit_mem_limit is not None:
      oprot.writeFieldBegin('admit_mem_limit', TType.I64, 8)
      oprot.writeI64(self.admit_mem_limit)
      oprot.writeFieldEnd()
    if self.is_quiescing is not None:
      oprot.writeFieldBegin('is_quiescing', TType.BOOL, 9)
      oprot.writeBool(self.is_quiescing)
      oprot.writeFieldEnd()
    if self.executor_groups is not None:
      oprot.writeFieldBegin('executor_groups', TType.LIST, 10)
    ...
    if self.admission_slots is not None:
      oprot.writeFieldBegin('admission_slots', TType.I64, 11)
