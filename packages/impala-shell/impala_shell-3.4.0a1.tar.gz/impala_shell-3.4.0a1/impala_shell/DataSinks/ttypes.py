...
class TJoinBuildSink:
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.join_table_id)
    value = (value * 31) ^ hash(self.build_exprs)
    return value
...
class TDataSink:
  ...
  def __init__(self, type=None, stream_sink=None, table_sink=None, join_build_sink=None, plan_root_sink=None, label=None, estimated_stats=None, output_exprs=None,):
    self.type = type
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i32 in xrange(_size28):
            _elem33 = Exprs.ttypes.TExpr()
            _elem33.read(iprot)
            self.output_exprs.append(_elem33)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.output_exprs is not None:
      ...
      for iter34 in self.output_exprs:
        iter34.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
