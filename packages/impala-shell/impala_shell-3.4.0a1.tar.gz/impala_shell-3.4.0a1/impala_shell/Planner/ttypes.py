...
class TPlanFragment:
  ...
  Attributes:
   ...
   - initial_mem_reservation_total_claims
  ...
  thrift_spec = (
    ...
    (7, TType.I64, 'min_mem_reservation_bytes', None, None, ), # 7
    (8, TType.I64, 'initial_mem_reservation_total_claims', None, None, ), # 8
    (9, TType.I64, 'runtime_filters_reservation_bytes', None, None, ), # 9
    (10, TType.I64, 'thread_reservation', None, None, ), # 10
  )

  def __init__(self, idx=None, display_name=None, plan=None, output_sink=None, partition=None, min_mem_reservation_bytes=None, initial_mem_reservation_total_claims=None, runtime_filters_reservation_bytes=None, thread_reservation=None,):
    self.idx = idx
    self.display_name = display_name
    self.plan = plan
    self.output_sink = output_sink
    self.partition = partition
    self.min_mem_reservation_bytes = min_mem_reservation_bytes
    self.initial_mem_reservation_total_claims = initial_mem_reservation_total_claims
    self.runtime_filters_reservation_bytes = runtime_filters_reservation_bytes
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.I64:
          self.min_mem_reservation_bytes = iprot.readI64()
        else:
          iprot.skip(ftype)
      elif fid == 8:
        if ftype == TType.I64:
          self.initial_mem_reservation_total_claims = iprot.readI64()
        else:
          iprot.skip(ftype)
      elif fid == 9:
        if ftype == TType.I64:
          self.runtime_filters_reservation_bytes = iprot.readI64()
        else:
          iprot.skip(ftype)
      elif fid == 10:
        if ftype == TType.I64:
  ...
  def write(self, oprot):
    ...
    if self.partition is not None:
      ...
      oprot.writeFieldEnd()
    if self.min_mem_reservation_bytes is not None:
      oprot.writeFieldBegin('min_mem_reservation_bytes', TType.I64, 7)
      oprot.writeI64(self.min_mem_reservation_bytes)
      oprot.writeFieldEnd()
    if self.initial_mem_reservation_total_claims is not None:
      oprot.writeFieldBegin('initial_mem_reservation_total_claims', TType.I64, 8)
      oprot.writeI64(self.initial_mem_reservation_total_claims)
      oprot.writeFieldEnd()
    if self.runtime_filters_reservation_bytes is not None:
      oprot.writeFieldBegin('runtime_filters_reservation_bytes', TType.I64, 9)
      oprot.writeI64(self.runtime_filters_reservation_bytes)
      oprot.writeFieldEnd()
  ...
  def __hash__(self):
    ...
    value = (value * 31) ^ hash(self.min_mem_reservation_bytes)
    value = (value * 31) ^ hash(self.initial_mem_reservation_total_claims)
    value = (value * 31) ^ hash(self.runtime_filters_reservation_bytes)
