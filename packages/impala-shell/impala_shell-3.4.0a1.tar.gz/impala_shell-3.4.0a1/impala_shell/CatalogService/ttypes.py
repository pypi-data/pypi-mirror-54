...
class TDdlExecResponse:
  ...
  def __init__(self, result=None, new_table_created=None, result_set=None, table_name=None, table_create_time=None,):
    self.result = result
...
class TTableInfoSelector:
  ...
  def __init__(self, want_hms_table=None, partition_ids=None, want_partition_names=None, want_partition_metadata=None, want_partition_files=None, want_stats_for_column_names=None, want_partition_stats=None,):
...
class TPartialTableInfo:
  ...
  def __init__(self, hms_table=None, partitions=None, column_stats=None, storage_metadata_load_time_ns=None, network_addresses=None,):
