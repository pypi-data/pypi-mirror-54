...
from .accessories.us_labor_ehe_national_accessory import UsLaborEHENationalAccessory
from azureml.data import TabularDataset


class UsLaborEHENational(AbstractTabularOpenDataset):
    ...
    def __init__(
        ...
        """
        Initializes an instance of the UsLaborEHENational class.
        ...
        """
        worker = UsLaborEHENationalAccessory(enable_telemetry=enable_telemetry)
    ...
    def get(dataset: TabularDataset, enable_telemetry: bool = True):
        """Get an instance of UsLaborEHENational.

        :param dataset: input an instance of TabularDataset.
        :type end_date: Dataset.
        :param enable_telemetry: whether to enable telemetry, disabled for UT only.
        :type enable_telemetry: bool
        :return: an instance of UsLaborEHENational.
        """
        pub = UsLaborEHENational(dataset=dataset, enable_telemetry=enable_telemetry)
