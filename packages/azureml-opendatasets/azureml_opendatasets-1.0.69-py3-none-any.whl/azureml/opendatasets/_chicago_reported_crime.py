...
from .accessories._chicago_reported_crime_accessory import ChicagoReportedCrimeAccessory
from azureml.data import TabularDataset
from typing import List, Optional


class ChicagoReportedCrime(AbstractTabularOpenDataset):
    """Chicago city crime class."""

    def __init__(
            self,
            start_date: datetime = ChicagoReportedCrimeAccessory.default_start_date,
            end_date: datetime = ChicagoReportedCrimeAccessory.default_end_date,
            cols: Optional[List[str]] = None,
            dataset: TabularDataset = None,
            enable_telemetry: bool = True):
        """
        Initializes an instance of the ChicagoReportedCrime class.
        ...
        """
        worker = ChicagoReportedCrimeAccessory(
            start_date=start_date,
            end_date=end_date,
            cols=cols,
            enable_telemetry=enable_telemetry)
        if dataset is not None:
            if start_date != ChicagoReportedCrimeAccessory.default_start_date and \
                end_date != ChicagoReportedCrimeAccessory.default_end_date and \
                    cols is not None:
...
at the same time! Please use either of them.')
    ...
    def get(dataset: TabularDataset, enable_telemetry: bool = True):
        """Get an instance of ChicagoReportedCrime.

        :param dataset: input an instance of TabularDataset.
        :type end_date: Dataset.
        :param enable_telemetry: whether to enable telemetry, disabled for UT only.
        :type enable_telemetry: bool
        :return: an instance of ChicagoReportedCrime.
        """
        chi = ChicagoReportedCrime(dataset=dataset, enable_telemetry=enable_telemetry)
