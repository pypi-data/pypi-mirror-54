...
class NycTlcFhvAccessory(TimePublicData):
    """NYC TLC FHV data accessory class."""
    ...
    def __init__(
        ...
        super(NycTlcFhvAccessory, self).__init__(cols=cols, enable_telemetry=enable_telemetry)
        self.limit = limit
        if enable_telemetry:
    ...
    def filter(self, env, min_date, max_date):
        ...
        ds = super(NycTlcFhvAccessory, self).filter(env, min_date, max_date)
