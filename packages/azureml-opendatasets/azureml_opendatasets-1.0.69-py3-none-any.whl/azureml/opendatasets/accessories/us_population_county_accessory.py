...
"""US population by county accessory."""
...
class UsPopulationCountyAccessory(PublicData):
    """US population by county accessory class."""
    ...
    def __init__(
        ...
        super(UsPopulationCountyAccessory, self).__init__(cols=None, enable_telemetry=enable_telemetry)
        if enable_telemetry:
