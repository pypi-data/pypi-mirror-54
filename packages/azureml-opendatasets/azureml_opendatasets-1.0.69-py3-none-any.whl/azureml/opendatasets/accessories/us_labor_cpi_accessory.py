...
class UsLaborCPIAccessory(PublicData):
    """US labor cpi accessory class."""
    ...
    def __init__(
        ...
        super(UsLaborCPIAccessory, self).__init__(cols=None, enable_telemetry=enable_telemetry)
        if enable_telemetry:
