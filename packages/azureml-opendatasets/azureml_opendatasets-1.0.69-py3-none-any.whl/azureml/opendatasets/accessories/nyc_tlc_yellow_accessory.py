...
class NycTlcYellowAccessory(TimePublicData):
    """NYC TLC yellow data accessory class."""
    ...
    def __init__(
        ...
        super(NycTlcYellowAccessory, self).__init__(cols=cols, enable_telemetry=enable_telemetry)
        self.limit = limit
        if enable_telemetry:
    ...
    def filter(self, env, min_date, max_date):
        ...
        ds = super(NycTlcYellowAccessory, self).filter(env, min_date, max_date)
