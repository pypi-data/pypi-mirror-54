...
"""US labor ppi commodity accessory."""
...
class UsLaborPPICommodityAccessory(PublicData):
    """US labor ppi commodity accessory class."""
    ...
    def __init__(
        ...
        super(UsLaborPPICommodityAccessory, self).__init__(cols=None, enable_telemetry=enable_telemetry)
        if enable_telemetry:
