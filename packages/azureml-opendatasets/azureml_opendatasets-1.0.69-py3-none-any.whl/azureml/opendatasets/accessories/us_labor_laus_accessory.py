...
class UsLaborLAUSAccessory(PublicData):
    """US labor laus accessory class."""
    ...
    def __init__(
        ...
        super(UsLaborLAUSAccessory, self).__init__(cols=None, enable_telemetry=enable_telemetry)
        if enable_telemetry:
