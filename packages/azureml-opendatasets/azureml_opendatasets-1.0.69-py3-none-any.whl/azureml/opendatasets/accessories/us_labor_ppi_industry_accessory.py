...
"""US labor ppi industry accessory."""
...
class UsLaborPPIIndustryAccessory(PublicData):
    """US labor ppi industry accessory class."""
    ...
    def __init__(
        ...
        super(UsLaborPPIIndustryAccessory, self).__init__(cols=None, enable_telemetry=enable_telemetry)
        if enable_telemetry:
