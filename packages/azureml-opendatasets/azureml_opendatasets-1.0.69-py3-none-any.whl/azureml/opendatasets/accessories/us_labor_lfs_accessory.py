...
class UsLaborLFSAccessory(PublicData):
    """US labor lfs accessory class."""
    ...
    def __init__(
        ...
        super(UsLaborLFSAccessory, self).__init__(cols=None, enable_telemetry=enable_telemetry)
        if enable_telemetry:
