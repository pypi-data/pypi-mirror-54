...
class UsLaborEHEStateAccessory(PublicData):
    """US labor ehe state accessory class."""
    ...
    def __init__(
        ...
        super(UsLaborEHEStateAccessory, self).__init__(cols=None, enable_telemetry=enable_telemetry)
        if enable_telemetry:
