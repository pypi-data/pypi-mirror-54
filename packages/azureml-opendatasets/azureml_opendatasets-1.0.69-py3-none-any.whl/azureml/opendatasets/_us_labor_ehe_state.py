...
from .accessories.us_labor_ehe_state_accessory import UsLaborEHEStateAccessory
from azureml.data import TabularDataset


class UsLaborEHEState(AbstractTabularOpenDataset):
    ...
    def __init__(
        ...
        """
        Initializes an instance of the UsLaborEHEState class.
        ...
        """
        worker = UsLaborEHEStateAccessory(enable_telemetry=enable_telemetry)
    ...
    def get(dataset: TabularDataset, enable_telemetry: bool = True):
        """Get an instance of UsLaborEHEState.

        :param dataset: input an instance of TabularDataset.
        :type end_date: Dataset.
        :param enable_telemetry: whether to enable telemetry, disabled for UT only.
        :type enable_telemetry: bool
        :return: an instance of UsLaborEHEState.
        """
        pub = UsLaborEHEState(dataset=dataset, enable_telemetry=enable_telemetry)
