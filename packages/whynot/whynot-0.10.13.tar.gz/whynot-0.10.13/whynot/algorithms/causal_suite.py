...
def causal_suite(covariates, treatment, outcome, verbose=False):
    ...
    for name, estimator in methods.items():
        ...
        results[name] = estimator.estimate_treatment_effect(covariates, treatment, outcome)
