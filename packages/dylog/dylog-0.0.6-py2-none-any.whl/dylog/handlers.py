...
class DynamoHandler(logging.Handler):
    ...
    @classmethod
    def to(cls, table_name, aws_region, nif, level=logging.NOTSET):
        """ Create a handler for a given  """
        return cls(table_name, aws_region, nif, level)

    def __init__(self, table_name, aws_region, nif, level=logging.NOTSET):
