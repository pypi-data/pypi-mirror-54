...
#
# Generated Mon Oct 14 18:14:51 2019 by generateDS.py version 2.33.6.
...
#
# Command line:
#   /root/init-build-jenkins.UiAG8d/opennebula-5.9.80/src/oca/python/bin/generateDS -q -f -o "pyone/bindings/supbind.py" -s "pyone/bindings/__init__.py" --super="supbind" --external-encoding="utf-8" --silence ../../../share/doc/xsd/index.xsd
#
...
class HOST_SHARETypeSub(TemplatedType, supermod.HOST_SHAREType):
    def __init__(self, DISK_USAGE=None, MEM_USAGE=None, CPU_USAGE=None, TOTAL_MEM=None, TOTAL_CPU=None, MAX_DISK=None, MAX_MEM=None, MAX_CPU=None, FREE_DISK=None, FREE_MEM=None, FREE_CPU=None, USED_DISK=None, USED_MEM=None, USED_CPU=None, RUNNING_VMS=None, DATASTORES=None, PCI_DEVICES=None, NUMA_NODES=None, **kwargs_):
        super(HOST_SHARETypeSub, self).__init__(DISK_USAGE, MEM_USAGE, CPU_USAGE, TOTAL_MEM, TOTAL_CPU, MAX_DISK, MAX_MEM, MAX_CPU, FREE_DISK, FREE_MEM, FREE_CPU, USED_DISK, USED_MEM, USED_CPU, RUNNING_VMS, DATASTORES, PCI_DEVICES, NUMA_NODES,  **kwargs_)
...
class CORETypeSub(TemplatedType, supermod.COREType):
    def __init__(self, CPUS=None, FREE=None, ID=None, **kwargs_):
        super(CORETypeSub, self).__init__(CPUS, FREE, ID,  **kwargs_)
