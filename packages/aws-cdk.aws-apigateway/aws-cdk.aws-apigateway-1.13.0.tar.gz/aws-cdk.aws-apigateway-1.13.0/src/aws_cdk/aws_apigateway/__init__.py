...
import aws_cdk.core
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-apigateway", "1.13.0", __name__, "aws-apigateway@1.13.0.jsii.tgz")
...
class IResource(aws_cdk.core.IResource, jsii.compat.Protocol):
    ...
    def add_proxy(self, *, any_method: typing.Optional[bool]=None, default_integration: typing.Optional["Integration"]=None, default_method_options: typing.Optional["MethodOptions"]=None) -> "ProxyResource":
...
class _IResourceProxy(jsii.proxy_for(aws_cdk.core.IResource)):
    ...
    def add_proxy(self, *, any_method: typing.Optional[bool]=None, default_integration: typing.Optional["Integration"]=None, default_method_options: typing.Optional["MethodOptions"]=None) -> "ProxyResource":
        ...
        :param default_method_options: Method options to use as a default for all methods created within this API unless custom options are specified. Default: - Inherited from parent.
        """
        options = ProxyResourceOptions(any_method=any_method, default_integration=default_integration, default_method_options=default_method_options)
...
@jsii.data_type(jsii_type="@aws-cdk/aws-apigateway.ProxyResourceOptions", jsii_struct_bases=[ResourceOptions], name_mapping={'default_integration': 'defaultIntegration', 'default_method_options': 'defaultMethodOptions', 'any_method': 'anyMethod'})
class ProxyResourceOptions(ResourceOptions):
    def __init__(self, *, default_integration: typing.Optional["Integration"]=None, default_method_options: typing.Optional["MethodOptions"]=None, any_method: typing.Optional[bool]=None):
        """
        :param default_integration: An integration to use as a default for all methods created within this API unless an integration is specified. Default: - Inherited from parent.
        :param default_method_options: Method options to use as a default for all methods created within this API unless custom options are specified. Default: - Inherited from parent.
        :param any_method: Adds an "ANY" method to this resource. If set to ``false``, you will have to explicitly add methods to this resource after it's created. Default: true
...
@jsii.data_type(jsii_type="@aws-cdk/aws-apigateway.ProxyResourceProps", jsii_struct_bases=[ProxyResourceOptions], name_mapping={'default_integration': 'defaultIntegration', 'default_method_options': 'defaultMethodOptions', 'any_method': 'anyMethod', 'parent': 'parent'})
class ProxyResourceProps(ProxyResourceOptions):
    def __init__(self, *, default_integration: typing.Optional["Integration"]=None, default_method_options: typing.Optional["MethodOptions"]=None, any_method: typing.Optional[bool]=None, parent: "IResource"):
        """
        :param default_integration: An integration to use as a default for all methods created within this API unless an integration is specified. Default: - Inherited from parent.
        :param default_method_options: Method options to use as a default for all methods created within this API unless custom options are specified. Default: - Inherited from parent.
        :param any_method: Adds an "ANY" method to this resource. If set to ``false``, you will have to explicitly add methods to this resource after it's created. Default: true
