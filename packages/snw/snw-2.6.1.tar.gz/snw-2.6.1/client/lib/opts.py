...
def define_option():
    ...
    launcher.subparsers_map["vocable"] = launcher.subparsers.add_parser('vocable')
    ...
    subparsers_vocable = launcher.subparsers_map["vocable"].add_subparsers(help='sub-command help', dest='subcmd')
    subparsers_vocable.required = True

    parser_get_vocable = subparsers_vocable.add_parser('get', help='download the vocable')
    parser_get_vocable.add_argument('vocable', help='vocable')
    parser_get_vocable.add_argument('-f', '--file', help='path to the file of the vocable')
    parser_get_vocable.add_argument('-o', '--output', help='path to the output file of the vocable')

    parser_detail_vocable = subparsers_vocable.add_parser('detail', help='{cv} show the model contents')
    launcher.shortcut_map["cv"] = ["vocable", "detail"]
    parser_detail_vocable.add_argument('vocable')
    parser_detail_vocable.add_argument('-d', '--directory', help='the directory inside the model')
