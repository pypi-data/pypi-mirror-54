...
def compute_interraction_score(interraction, item):
    print(interraction.shape, item.T.shape, (interraction @ item.T).shape)
...
def satisfaction(people, lights, heaters, pollution_score, nuclear):
    ...
    print("Scores", pollution_score, nuclear_score, light_score, heat_score, heaters_inter, lights_inter)
