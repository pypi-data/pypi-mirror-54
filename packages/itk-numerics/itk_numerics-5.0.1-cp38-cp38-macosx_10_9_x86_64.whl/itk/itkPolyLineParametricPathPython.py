...
class itkPolyLineParametricPath2(itkParametricPathPython.itkParametricPath2):
    ...
    def AddVertex(self, vertex: 'itkContinuousIndexD2') -> "void":
        ...
        exact, algebraic function. */ virtual VectorType
        EvaluateDerivative(const InputType & input) const;

        /** Add a vertex (and a connecting line segment to the previous
        vertex). Adding a vertex has the additional effect of extending the
        domain of the PolyLineParametricPath by 1.0 (each pair of consecutive
        verticies is separated by one unit of input). 
        """
