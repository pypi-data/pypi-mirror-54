...
startbutton=Button(panelA,text='Crop images',command=partial(QGIS_NDVI,2),compound=LEFT)
newuserbutton=Button(panelA,text='Kernel images',command=partial(QGIS_NDVI,1),compound=LEFT)
