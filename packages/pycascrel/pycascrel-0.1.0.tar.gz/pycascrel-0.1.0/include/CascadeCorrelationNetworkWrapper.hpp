#ifndef CASCREL_CASCADECORRELATIONNETWORKWRAPPER_HPP
#define CASCREL_CASCADECORRELATIONNETWORKWRAPPER_HPP
...
public:
    ...
    cascrel::RowMatrix predict(const Eigen::Ref<const cascrel::RowMatrix>& x);
...
#endif //CASCREL_CASCADECORRELATIONNETWORKWRAPPER_HPP
