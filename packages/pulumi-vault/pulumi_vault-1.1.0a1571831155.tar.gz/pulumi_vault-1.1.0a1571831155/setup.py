...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', 'v1.1.0-alpha.1571831155+g94c1e51'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault v1.1.0-alpha.1571831155+g94c1e51`
                """)
            else:
                raise
