...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', 'v1.1.0-alpha.1571414716+ge6d1896'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault v1.1.0-alpha.1571414716+ge6d1896`
                """)
            else:
                raise
