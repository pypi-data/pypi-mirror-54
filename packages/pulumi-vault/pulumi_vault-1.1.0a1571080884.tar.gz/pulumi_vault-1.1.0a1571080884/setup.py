...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', 'v1.1.0-alpha.1571080884+g1d0a06d'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault v1.1.0-alpha.1571080884+g1d0a06d`
                """)
            else:
                raise
