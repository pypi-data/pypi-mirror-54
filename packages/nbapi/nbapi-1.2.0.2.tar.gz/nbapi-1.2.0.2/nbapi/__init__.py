...
class random():
    ...
    class pat():
        def animated():
            return f"http://neko-bot.net/pats/animated/{str(randint(int(1),int(str(requests.get('http://neko-bot.net/info/totalpats_a.txt').text))))}.gif"
        def static():
    ...
    class hug():
        def animated():
            return f"http://neko-bot.net/hugs/animated/{str(randint(int(1),int(str(requests.get('http://neko-bot.net/info/totalpats.txt').text))))}.gif"#NOT FINISHED
        def static():
