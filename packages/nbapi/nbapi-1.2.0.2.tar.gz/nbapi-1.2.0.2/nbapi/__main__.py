...
#TODO: make "hug"&"pat" animated&static endpoint!
class random():
    def anime():
    ...
    class pat():
        def animated():
            return f"http://neko-bot.net/pats/{str(randint(int(1),int(str(requests.get('http://neko-bot.net/info/totalpats.txt').text))))}.png"
        def static():
