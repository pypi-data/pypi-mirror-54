...
class TreePlot(AbstractVisualization):
    ...
    Julia Equivalent:
    `IAI.TreePlot <https://docs.interpretable.ai/IAITrees/stable/reference/#IAI.TreePlot>`
    ...
    ----------
    Refer to the
    [Julia documentation on advanced tree visualization](https://docs.interpretable.ai/IAITrees/stable/advanced/#Advanced-Visualization-1)
...
class Questionnaire(AbstractVisualization):
    ...
    Julia Equivalent:
    `IAI.Questionnaire <https://docs.interpretable.ai/IAITrees/stable/reference/#IAI.Questionnaire>`
...
class MultiQuestionnaire(AbstractVisualization):
    ...
    Julia Equivalent:
    `IAI.MultiQuestionnaire <https://docs.interpretable.ai/IAITrees/stable/reference/#IAI.MultiQuestionnaire>`
    ...
    [documentation on advanced tree visualization](@ref Interactive-Visualizations)
...
class MultiTreePlot(AbstractVisualization):
    ...
    Julia Equivalent:
    `IAI.MultiTreePlot <https://docs.interpretable.ai/IAITrees/stable/reference/#IAI.MultiTreePlot>`
