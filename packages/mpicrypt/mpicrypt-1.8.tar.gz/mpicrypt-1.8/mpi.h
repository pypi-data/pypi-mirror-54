...
#define DONT_USE_PPC_ASM  /*until I can figure out compile problems*/
#define DONT_USE_STDIO
#define USE_NONVARGS_INIT

#define DONT_USE_MALLOC
#  define MPI_DEALLOC JS_FREE
#  define MPI_ALLOC(n) JS_ALLOC(char,(n))
#  include "jsalloc.h"
  /******************************************/
...
#define MPI_DEALLOC free
#define MPI_ALLOC malloc
#endif
...
#else
/*TODO - update me for 64 bit machines!!!*/
...
/**
 * \brief          MPI structure
  IF YOU CHANGE THIS, THEN CHANGE IT IN STARLIB.H as well!!!!!!
 */
typedef struct
{
    int s;              /*!<  integer sign      */
