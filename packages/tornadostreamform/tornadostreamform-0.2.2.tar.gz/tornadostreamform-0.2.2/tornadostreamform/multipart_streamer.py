...
class TemporaryFileStreamedPart(StreamedPart):
    ...
    """
    def __init__(self, streamer, headers, tmp_dir=None, tmp_suffix=None, tmp_prefix=None):
        ...
        :param tmp_suffix: passed to NamedTemporaryFile constructor.
        :param tmp_prefix: passed to NamedTemporaryFile constructor.
        ...
        self.f_out = tempfile.NamedTemporaryFile(dir=tmp_dir, suffix=tmp_suffix, prefix=tmp_prefix, delete=False)
