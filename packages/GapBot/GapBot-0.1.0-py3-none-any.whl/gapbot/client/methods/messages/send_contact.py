...
class SendContact(BaseClient):
    def send_contact(self, chat_id, name, phone, caption=None, reply_keyboard=None, inline_keyboard=None, reply_form=None):
        return self._send(
            method='sendMessage',
            data={
                'chat_id': chat_id,
                'type': 'contact',
                'data': dumps({'name': name, 'phone': phone, 'desc': caption}),
