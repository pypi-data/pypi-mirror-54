...
class SendFile(BaseClient):
    def send_file(self, chat_id, path, caption=None, reply_keyboard=None, inline_keyboard=None, reply_form=None):
        return self._send(
            method='sendMessage',
            data={
                'chat_id': chat_id,
                'type': 'file',
                'data': self.upload(chat_id=chat_id, file_type='file', path=path, desc=caption),
