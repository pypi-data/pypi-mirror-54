...
from tensorflow_model_analysis.types_compat import Any, Callable, List, Optional, Text, Tuple, Union
...
def to_label_prediction_example_weight(
  ...
  def optionally_get_by_keys(value, keys):
...
def _string_labels_to_class_ids(label_vocabulary,
                                labels):
...
def merge_per_key_computations(
  ...
  def merge_computations_fn(eval_config = None,
                            model_names = None,
                            output_names = None,
                            sub_keys = None,
                            query_key = None,
