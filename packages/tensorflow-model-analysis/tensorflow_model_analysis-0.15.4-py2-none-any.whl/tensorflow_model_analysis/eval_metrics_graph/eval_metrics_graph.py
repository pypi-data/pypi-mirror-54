...
class EvalMetricsGraph(object):  # pytype: disable=ignored-metaclass
  ...
  def _perform_metrics_update_list(self, examples_list):
  ...
  def _get_metric_variables(self):
  ...
  def _create_feed_for_metric_variables(self, metric_variable_values
                                       ):
  ...
  def _set_metric_variables(self, metric_variable_values):
    # Lock should be acquired before calling this function.
  ...
  def _reset_metric_variables(self):
    # Lock should be acquired before calling this function.
    self._session.run(self._reset_variables_op)
