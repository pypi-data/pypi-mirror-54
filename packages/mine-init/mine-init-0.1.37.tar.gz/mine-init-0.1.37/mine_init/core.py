...
SERVER_PROPS = {
    ...
    'hardmax-tick-timecore': os.getenv('MAX_TICK_TIME', '-1'),
...
class MineInit:
    ...
    def start(self, args):
        ...
        pack_update = PackFileUpdater(args.dist, args.server)
        ...
        server = JavaRunner(args.server, args.dist)
        server.main()
