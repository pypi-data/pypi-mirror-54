...
kwargs = json.loads("""
{
    ...
    "package_data": {
        "aws_cdk.aws_lambda_event_sources._jsii": [
            "aws-lambda-event-sources@1.13.1.jsii.tgz"
        ],
        "aws_cdk.aws_lambda_event_sources": [
            "py.typed"
        ]
    ...
    "install_requires": [
        "jsii~=0.19.0",
        "publication>=0.0.3",
        "aws-cdk.aws-apigateway~=1.13,>=1.13.1",
        "aws-cdk.aws-dynamodb~=1.13,>=1.13.1",
        "aws-cdk.aws-events~=1.13,>=1.13.1",
        "aws-cdk.aws-iam~=1.13,>=1.13.1",
        "aws-cdk.aws-kinesis~=1.13,>=1.13.1",
        "aws-cdk.aws-lambda~=1.13,>=1.13.1",
        "aws-cdk.aws-s3~=1.13,>=1.13.1",
        "aws-cdk.aws-s3-notifications~=1.13,>=1.13.1",
