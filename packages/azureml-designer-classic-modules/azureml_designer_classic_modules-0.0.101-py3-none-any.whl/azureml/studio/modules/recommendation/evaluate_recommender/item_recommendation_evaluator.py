...
class ItemRecommendationEvaluator(BaseRecommenderEvaluator):
    ...
    def validate_parameters(self, test_data: DataTable, scored_data: DataTable, test_data_name=None,
        ...
        if min_rating < 0:
            ErrorMapping.throw(InvalidDatasetError(dataset1=test_data_name,
    ...
    def evaluate(self, test_data: DataTable, scored_data: DataTable, test_data_name=None, scored_data_name=None):
        ...
        rating_lookup = ItemRecommendationEvaluator._build_rating_lookup(test_data_df)
        ...
        for _, row in scored_data_df.iterrows():
            ...
            ndcg += ItemRecommendationEvaluator.normalized_discounted_cumulative_gain(best_gains, ordered_gains)
        ndcg = ndcg / scored_data.number_of_rows
        return ItemRecommendationEvaluator._build_item_recommendation_result(ndcg)
