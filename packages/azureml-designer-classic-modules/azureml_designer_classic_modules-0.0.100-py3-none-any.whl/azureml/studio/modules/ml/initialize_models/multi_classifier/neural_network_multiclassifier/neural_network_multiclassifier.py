...
class MulticlassNeuralNetworkModule(BaseModule):
    ...
    def run(
            ...
            neural_network_topology1: ModeParameter(
                ...
                default_value=MulticlassNeuralNetworkModuleDefaultParameters.NeuralNetworkTopology1,
                parent_parameter="Create trainer mode",
            ...
            num_hidden_nodes1: StringParameter(
                ...
                description="Type the number of nodes in the hidden layer, or for multiple hidden layers, "
                            "type a comma-separated list.",
                default_value=MulticlassNeuralNetworkModuleDefaultParameters.NumHiddenNodes1,
    ...
    def create_neural_network_multiclassifier(
            ...
            neural_network_topology1=MulticlassNeuralNetworkModuleDefaultParameters.NeuralNetworkTopology1,
            ...
            num_hidden_nodes1: str = MulticlassNeuralNetworkModuleDefaultParameters.NumHiddenNodes1,
