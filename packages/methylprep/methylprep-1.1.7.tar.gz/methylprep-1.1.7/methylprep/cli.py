...
def cli_sample_sheet(cmd_args):
    ...
    parser.add_argument(
        '--controls',
        nargs='*',
        help= 'Create sample sheet: Provide zero or more sample names, to be parsed into sheet, like `--controls 2443, 4523, 7401 ...`. All other samples will be defined as "non-control" samples in sample_sheet.csv.',
        type=str,
        required=False,
        default=[]
    )
