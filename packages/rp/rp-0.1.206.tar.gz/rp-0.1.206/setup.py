...
setup   (
    #region THE FOLLOWING TWO LINES ARE AN ATTEMPT TO INCLUDE NON-PYTHON FILES SUCH AS PYFLANN. BUT FOR SOME REASON THIS DIRECTORY IS 2.2G LARGE, SO I DISABLED IT.
