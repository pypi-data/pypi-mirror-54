...
cyan_4={    
     ...
     Token.Toolbar.Status.BatteryPluggedIn:             '    #aaff55        bg:#001e73                     ',
     Token.Toolbar.Status.BatteryNotPluggedIn:          '    #118800        bg:#001e73                     ',
     Token.Toolbar.Status.Title:                        '                                     underline    ',
...
cyan_4__02={    
     ...
     Token.Toolbar.Status.BatteryPluggedIn:             '    #55aaff        bg:#73001e                     ',
     Token.Toolbar.Status.BatteryNotPluggedIn:          '    #001188        bg:#73001e                     ',
     Token.Toolbar.Status.Title:                        '                                     underline    ',
     ...
     Token.Sidebar.Selected.Status:                     '    #000000        bg:#a0004c        bold         ',
...
cyan_4__02__02={    
     ...
     Token.Toolbar.Status.BatteryPluggedIn:             '    #ff55aa        bg:#1e7300                     ',
     Token.Toolbar.Status.BatteryNotPluggedIn:          '    #880011        bg:#1e7300                     ',
     Token.Toolbar.Status.Title:                        '                                     underline    ',
...
cyan_4__02__02__12={    
     ...
     Token.Toolbar.Status.BatteryPluggedIn:             '    #ffaa55        bg:#1e0073                     ',
     Token.Toolbar.Status.BatteryNotPluggedIn:          '    #881100        bg:#1e0073                     ',
     Token.Toolbar.Status.Title:                        '                                     underline    ',
     ...
     Token.Sidebar.Selected.Status:                     '    #000000        bg:#4c00a0        bold         ',
...
temp = {
    ...
    Token.Toolbar.Status.PseudoTerminalCurrentVariable:'bg:#247973 #7ed4ff',# RYAN BURGERT STUFF
...
temp = {
    ...
    Token.Toolbar.Status.PseudoTerminalCurrentVariable:'bg:#787223 #d3fe7d',# RYAN BURGERT STUFF
