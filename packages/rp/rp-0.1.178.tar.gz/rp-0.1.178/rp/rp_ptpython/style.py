...
temp.update({                                                                                                
    ...
    Token.Sidebar.Title:                                  'bg:#bc00e3 #000045 bold',
...
temp.update({                                                                                                
    ...
    Token.Sidebar.Title:                                  'bg:#e3bc00 #450000 bold',
...
temp.update({                                                                                                
    ...
    Token.Sidebar.Title:                                  'bg:#00e3bc #004500 bold',
...
temp.update({                                                                                                
    ...
    Token.Sidebar.Title:                                  'bg:#e300bc #450000 bold',
