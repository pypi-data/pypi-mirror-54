...
# python3 errors.py --api="damegender" --ml="sgd" > files/tests/errorsminsgd-$(date "+%Y-%m-%d-%H").txt

# if ! cmp files/tests/errorsminsgd.txt files/tests/errorsminsgd-$(date "+%Y-%m-%d-%H").txt >/dev/null 2>&1
# then
# 	if ! cmp files/tests/errorsminsgd2.txt files/tests/errorsminsgd-$(date "+%Y-%m-%d-%H").txt >/dev/null 2>&1
# 	then
# 		echo "errors test min sgd is failing"
# 	else
# 		echo "errors test min sgd is ok"
# 	fi
# else
#     echo "errors test min sgd is ok"
# fi

# python3 errors.py --api="damegender" --ml="gaussianNB" --csv=files/names/min.csv > files/tests/errorsmingaussiannb.txt

# if ! cmp files/tests/errorsmingaussianNB.txt files/tests/errorsmingaussianNB-$(date "+%Y-%m-%d-%H").txt >/dev/null 2>&1
# then
#     echo "errors test min gaussianNB is failing"
# else
#     echo "errors test min gaussianNB is ok"
# fi

# python3 errors.py --api="damegender" --ml="bernoulliNB" --csv=files/names/min.csv > files/tests/errorsminbernoullinb.txt

# if ! cmp files/tests/errorsminbernoulliNB.txt files/tests/errorsminbernoulliNB-$(date "+%Y-%m-%d-%H").txt >/dev/null 2>&1
# then
#     echo "errors test min bernoulliNB is failing"
# else
#     echo "errors test min bernoulliNB is ok"
# fi

# python3 errors.py --api="damegender" --ml="multinomialNB" --csv=files/names/min.csv > files/tests/errorsminmultinomialnb.txt

# if ! cmp files/tests/errorsminmultinomialNB.txt files/tests/errorsminmultinomialNB-$(date "+%Y-%m-%d-%H").txt >/dev/null 2>&1
# then
#     echo "errors test min multinomialNB is failing"
# else
#     echo "errors test min multinomialNB is ok"
# fi
