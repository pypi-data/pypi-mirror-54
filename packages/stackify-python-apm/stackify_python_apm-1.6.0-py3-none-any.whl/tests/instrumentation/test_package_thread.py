...
class ThreadInstrumentationTest(TestCase):
    ...
    def set_up(self, multiprocessing=False):
    ...
    def test_multiprocessing_config_is_False(self):
        self.set_up()
    ...
    def test_multiprocessing_config_is_True(self):
        self.set_up(multiprocessing=True)
        p = Process(target=do_requests, args=('http://www.python.org/',))
        p.start()
        p.join()
