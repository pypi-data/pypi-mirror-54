...
from stackifyapm.conf.constants import RUM_COOKIE_MAX_AGE_IN_SEC
...
class RumInjectionTest(TestCase):
    def setUp(self):
        ...
        self.app = Flask('asfadsa')
        self.app.config['ENV'] = 'test'
        self.app.config['RUM_ENABLED'] = True
    ...
    def test_rum_cookie(self, get_property_info_mock):
        ...
        assert any(cookies)
        assert 'Max-Age={}'.format(RUM_COOKIE_MAX_AGE_IN_SEC) in cookies[0][1]
