...
class Ui_MainClientWindow(object):
    ...
    def retranslateUi(self, MainClientWindow):
        ...
        MainClientWindow.setWindowTitle(_translate("MainClientWindow", "HeroChat"))
        ...
        self.label_new_message.setText(_translate("MainClientWindow", "Enter your message:"))
        ...
        self.menu_exit.setText(_translate("MainClientWindow", "Quit"))
