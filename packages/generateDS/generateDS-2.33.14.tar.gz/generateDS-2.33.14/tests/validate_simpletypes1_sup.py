...
class simpleOneType(GeneratedsSuper):
    ...
    def validate_integer_range_1_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, int):
                ...
                self.gds_collector_.add_message('Value "%(value)s" near line %(lineno)s is not of the correct base simple type (int)' % {"value": value, "lineno": lineno, })
                return False
            if value <= 4:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s" near line %(lineno)s does not match xsd minExclusive restriction on integer_range_1_st' % {"value": value, "lineno": lineno} )
                result = False
            if value >= 8:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxExclusive restriction on integer_range_1_st' % {"value": value, "lineno": lineno} )
                result = False
        return result
    def validate_pattern_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if len(value) < 10:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s" near line %(lineno)s does not match xsd minLength restriction on pattern_st' % {"value" : value, "lineno": lineno} )
                result = False
    ...
    def validate_token_enum_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value not in enumerations:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s" near line %(lineno)s does not match xsd enumeration restriction on token_enum_st' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
        return result
    def validate_integer_range_incl_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value < -5:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s" near line %(lineno)s does not match xsd minInclusive restriction on integer_range_incl_st' % {"value": value, "lineno": lineno} )
                result = False
            if value > 10:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s" near line %(lineno)s does not match xsd maxInclusive restriction on integer_range_incl_st' % {"value": value, "lineno": lineno} )
                result = False
        return result
    def validate_integer_range_excl_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value <= -5:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s" near line %(lineno)s does not match xsd minExclusive restriction on integer_range_excl_st' % {"value": value, "lineno": lineno} )
                result = False
            if value >= 10:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxExclusive restriction on integer_range_excl_st' % {"value": value, "lineno": lineno} )
                result = False
        return result
    def validate_min_max_length_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if len(value) > 20:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s" near line %(lineno)s does not match xsd maxLength restriction on min_max_length_st' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
            if len(value) < 10:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s" near line %(lineno)s does not match xsd minLength restriction on min_max_length_st' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
        return result
    def validate_length_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if len(value) != 10:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s" near line %(lineno)s does not match xsd length restriction on length_st' % {"value": encode_str_2_3(value), "lineno": lineno} )
                result = False
        return result
    def validate_totalDigits_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, decimal_.Decimal):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s" near line %(lineno)s is not of the correct base simple type (decimal_.Decimal)' % {"value": value, "lineno": lineno, })
                return False
            if len(str(value)) >= 15:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd totalDigits restriction on totalDigits_st' % {"value": value, "lineno": lineno} )
                result = False
        return result
    def validate_date_minincl_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, datetime_.date):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s" near line %(lineno)s is not of the correct base simple type (datetime_.date)' % {"value": value, "lineno": lineno, })
                return False
            if value < self.gds_parse_date('2015-06-01'):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s" near line %(lineno)s does not match xsd minInclusive restriction on date_minincl_st' % {"value": value, "lineno": lineno} )
                result = False
        return result
    def validate_date_maxincl_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value > self.gds_parse_date('2015-10-31'):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s" near line %(lineno)s does not match xsd maxInclusive restriction on date_maxincl_st' % {"value": value, "lineno": lineno} )
                result = False
        return result
    def validate_date_minexcl_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value <= self.gds_parse_date('2015-06-01'):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s" near line %(lineno)s does not match xsd minExclusive restriction on date_minexcl_st' % {"value": value, "lineno": lineno} )
                result = False
        return result
    def validate_date_maxexcl_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value >= self.gds_parse_date('2015-10-31'):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxExclusive restriction on date_maxexcl_st' % {"value": value, "lineno": lineno} )
                result = False
        return result
    def validate_time_minincl_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, datetime_.time):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s" near line %(lineno)s is not of the correct base simple type (datetime_.time)' % {"value": value, "lineno": lineno, })
                return False
            if value < self.gds_parse_time('14:20:10'):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s" near line %(lineno)s does not match xsd minInclusive restriction on time_minincl_st' % {"value": value, "lineno": lineno} )
                result = False
        return result
    def validate_time_maxincl_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value > self.gds_parse_time('16:20:10'):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s" near line %(lineno)s does not match xsd maxInclusive restriction on time_maxincl_st' % {"value": value, "lineno": lineno} )
                result = False
        return result
    def validate_time_minexcl_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value <= self.gds_parse_time('14:20:10'):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s" near line %(lineno)s does not match xsd minExclusive restriction on time_minexcl_st' % {"value": value, "lineno": lineno} )
                result = False
        return result
    def validate_time_maxexcl_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value >= self.gds_parse_time('16:20:10'):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxExclusive restriction on time_maxexcl_st' % {"value": value, "lineno": lineno} )
                result = False
        return result
    def validate_datetime_minincl_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, datetime_.datetime):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s" near line %(lineno)s is not of the correct base simple type (datetime_.datetime)' % {"value": value, "lineno": lineno, })
                return False
            if value < self.gds_parse_datetime('2015-06-01T14:20:10'):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s" near line %(lineno)s does not match xsd minInclusive restriction on datetime_minincl_st' % {"value": value, "lineno": lineno} )
                result = False
        return result
    def validate_datetime_maxincl_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value > self.gds_parse_datetime('2015-10-31T16:20:10'):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s" near line %(lineno)s does not match xsd maxInclusive restriction on datetime_maxincl_st' % {"value": value, "lineno": lineno} )
                result = False
        return result
    def validate_datetime_minexcl_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value <= self.gds_parse_datetime('2015-06-01T14:20:10'):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s" near line %(lineno)s does not match xsd minExclusive restriction on datetime_minexcl_st' % {"value": value, "lineno": lineno} )
                result = False
        return result
    def validate_datetime_maxexcl_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value >= self.gds_parse_datetime('2015-10-31T16:20:10'):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s" does not match xsd maxExclusive restriction on datetime_maxexcl_st' % {"value": value, "lineno": lineno} )
                result = False
        return result
    ...
    def validate_gyear_minincl_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if value < '2015':
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s" near line %(lineno)s does not match xsd minInclusive restriction on gyear_minincl_st' % {"value": value, "lineno": lineno} )
                result = False
        return result
    def validate_gyearmonth_minincl_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if value < '2015-06':
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s" near line %(lineno)s does not match xsd minInclusive restriction on gyearmonth_minincl_st' % {"value": value, "lineno": lineno} )
                result = False
        return result
    def validate_integer_range_A_0_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value < 4:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s" near line %(lineno)s does not match xsd minInclusive restriction on integer_range_A_0_st' % {"value": value, "lineno": lineno} )
                result = False
            if value > 6:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s" near line %(lineno)s does not match xsd maxInclusive restriction on integer_range_A_0_st' % {"value": value, "lineno": lineno} )
                result = False
            if value < 2:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s" near line %(lineno)s does not match xsd minInclusive restriction on integer_range_A_0_st' % {"value": value, "lineno": lineno} )
    ...
    def validate_integer_range_A_1_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value < 2:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s" near line %(lineno)s does not match xsd minInclusive restriction on integer_range_A_1_st' % {"value": value, "lineno": lineno} )
                result = False
            if value > 8:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s" near line %(lineno)s does not match xsd maxInclusive restriction on integer_range_A_1_st' % {"value": value, "lineno": lineno} )
                result = False
            if value < 0:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s" near line %(lineno)s does not match xsd minInclusive restriction on integer_range_A_1_st' % {"value": value, "lineno": lineno} )
    ...
    def validate_integer_range_A_2_st(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if value < 0:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s" near line %(lineno)s does not match xsd minInclusive restriction on integer_range_A_2_st' % {"value": value, "lineno": lineno} )
                result = False
            if value > 10:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s" near line %(lineno)s does not match xsd maxInclusive restriction on integer_range_A_2_st' % {"value": value, "lineno": lineno} )
                result = False
        return result
    def validate_anonymous_float_valueType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            if not isinstance(value, float):
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s" near line %(lineno)s is not of the correct base simple type (float)' % {"value": value, "lineno": lineno, })
                return False
            if value < 1.1:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s" near line %(lineno)s does not match xsd minInclusive restriction on anonymous_float_valueType' % {"value": value, "lineno": lineno} )
                result = False
            if value > 4.4:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s" near line %(lineno)s does not match xsd maxInclusive restriction on anonymous_float_valueType' % {"value": value, "lineno": lineno} )
                result = False
        return result
    def hasContent_(self):
        if (
...
class simpleTwoElementOneType(GeneratedsSuper):
    ...
    def validate_simpleTwoElementTwoType(self, value):
        ...
        if value is not None and Validate_simpletypes_ and self.gds_collector_ is not None:
            ...
            if len(value) > 24:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s" near line %(lineno)s does not match xsd maxLength restriction on simpleTwoElementTwoType' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
            if len(value) < 12:
                lineno = self.gds_get_node_lineno_()
                self.gds_collector_.add_message('Value "%(value)s" near line %(lineno)s does not match xsd minLength restriction on simpleTwoElementTwoType' % {"value" : encode_str_2_3(value), "lineno": lineno} )
                result = False
        return result
    def hasContent_(self):
        if (
