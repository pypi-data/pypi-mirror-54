...
def load_package(filename):
    ...
    if conf:
        ...
        if 'build_config' in conf:
            ...
            package_conf(build_conf, 'include', 'LOCAL_INCS')
            package_conf(build_conf, 'include', 'EXPORT_INCS')
            package_conf(build_conf, 'local_include', 'LOCAL_INCS')
            package_conf(build_conf, 'export_include', 'EXPORT_INCS')
