...
class OutputPort(object):
    ...
    def dataset_registration(self):
        ...
        :rtype: azureml.pipeline.core.pipeline_output_dataset._DatasetRegistration
        """
...
class InputPortBinding(object):
    ...
    def get_bind_object_data_type(self):
        ...
        elif isinstance(self.bind_object, PipelineDataset) or isinstance(self.bind_object, PipelineOutputDataset):
...
class OutputPortBinding(object):
    ...
    :type dataset_registration: azureml.pipeline.core.pipeline_output_dataset.PipelineOutputDataset
    """
...
class Graph(object):
    ...
    def submit(self, pipeline_parameters=None, continue_on_step_failure=False, regenerate_outputs=False,
        ...
        print('Link to Azure Portal:', pipeline_run.get_portal_url())
