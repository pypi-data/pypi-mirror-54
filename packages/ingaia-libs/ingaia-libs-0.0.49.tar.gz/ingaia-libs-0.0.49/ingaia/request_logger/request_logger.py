...
from .exceptions import RequestLoggerException
...
def save_request(project_id, log_entry):
    ...
    try:
        ...
        if response.status_code != 200:
            raise RequestLoggerException()

        # log the result
        logging.info(response.text)

    except RequestLoggerException as e:
        logging.warning(e)
        RequestLogger.only_trace(log_entry)
