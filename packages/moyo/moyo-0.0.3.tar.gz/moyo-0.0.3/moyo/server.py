...
class WebApp():
    ...
    def __repr__(self):
        return "Moyo.WebAppObject"

    def __str__(self):
        return "<class 'Moyo.WebAppObject'>"
...
class moyo_server(WSGIServer):
    ...
    def __str__(self):
        return "<class 'Moyo.moyo_serverObeject'>"

    def __repr__(self):
        return 'Moyo.moyo_serverObeject'
    ...
    def run_server(self):
        if self.host:
            print "the moyo server is running on the {} in the port {}".format(
                self.host, self.port)
        else:
