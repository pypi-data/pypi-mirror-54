...
class Elasticsearchlib:
    ...
    def scrolled_query(self, query, index, filter_path=None, query_size=QUERY_SIZE, max_size=MAX_RESPONSE_SIZE, time_index="timestamp"):
        '''
        ...
        if ok:
            ...
            if (res['hits']['total']['value']) > QUERY_SIZE or len(output) < max_size:
                more = True
