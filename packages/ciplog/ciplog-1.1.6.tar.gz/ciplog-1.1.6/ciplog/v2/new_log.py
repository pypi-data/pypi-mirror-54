...
class NewCipLog(object):
    ...
    def info(self, class_name, method, http_status=None, data=None, job_id=None, process_status=None, initial_time=None, finishing_time=None, user=None, path=None, browser=None, user_ip=None, service_name=None, message=None, short_message=None, user_name=None, step=None):
        ...
        self._logger.info(
            message, extra={'_tags': self.tags, 'version': GELF_VERSION, '_service_version': self.service_version, 'short_message': short_message, 'level': '6',
                            '_type': 'INFO', '_http_status': http_status,  '_class_name': class_name, '_method': method, '_data': str(data), '_dinamic_data': dinamic_data, '_service_name': service_name,
    ...
    def warning(self, code, class_name, method, http_status=None, data=None, job_id=None, process_status=None, initial_time=None, finishing_time=None, user=None, path=None, browser=None, user_ip=None, service_name=None, message=None, short_message=None, user_name=None, step=None):
        ...
        self._logger.warning(
            message, extra={'_tags': self.tags, 'version': GELF_VERSION, '_service_version': self.service_version, 'short_message': message,
                            '_code': code, 'level': '4', '_type': 'WARNING', '_http_status': http_status, '_class_name': class_name, '_method': method, '_data': str(data), '_dinamic_data': dinamic_data, '_service_name': service_name,
                            '_environment': self.environment, '_step': step, '_job_id': job_id,
                            '_process_status': process_status, '_initial_time': initial_time, '_finishing_time': finishing_time,
                            '_user': user, '_path': path, '_user_name': user_name})
    ...
    def error(self, code, class_name, method, http_status=None, data=None, job_id=None, process_status=None, initial_time=None, finishing_time=None, user=None, path=None, browser=None, user_ip=None, service_name=None, message=None, short_message=None, user_name=None, step=None):
        ...
        self._logger.error(
            message, extra={'_tags': self.tags, 'version': GELF_VERSION, '_service_version': self.service_version, 'short_message': message,
                            '_code': code, 'level': '3', '_type': 'ERROR', '_http_status': http_status, '_class_name': class_name, '_method': method, '_data': str(data), '_dinamic_data': dinamic_data, '_service_name': service_name,
                            '_environment': self.environment, '_step': step, '_job_id': job_id,
                            '_process_status': process_status, '_initial_time': initial_time, '_finishing_time': finishing_time,
                            '_user': user, '_path': path, '_user_name': user_name})
