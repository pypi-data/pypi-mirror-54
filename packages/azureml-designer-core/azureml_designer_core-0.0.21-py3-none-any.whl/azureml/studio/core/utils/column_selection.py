...
class ColumnSelection:
    ...
    def _handle_column_names_rule(df: pd.DataFrame, rule):
        ...
        """
        # Todo: The column_indexes should change to set so the behavior will be consistent with handle_indexes.
        ...
        for column in rule.columns:
            ...
            if match_index:
                ...
                if 0 <= column_index < num_of_columns:
                    selected_column_indexes.add(column_index)
                else:
                ...
                selected_column_indexes.update(range(start_index, end_index+1))
            else:
    ...
    def _handle_column_types_rule_with_schema(rule, schema):
        ...
        return list(selected_column_indexes)
