...
_TRIALSTARTREPLY = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='observation', full_name='cogment.TrialStartReply.observation', index=2,
...
_TRIALSTARTREQUEST.fields_by_name['config'].message_type = cogment_dot_api_dot_environment__pb2._ENVIRONMENTCONFIG
