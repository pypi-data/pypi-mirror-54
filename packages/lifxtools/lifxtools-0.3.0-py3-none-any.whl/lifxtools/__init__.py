...
def d_benchmark(func):
    def func_wrapper(*args,**kwargs):
        ...
        loop_time = t2-t1
        print("[{}] ({:>3} Hz) took {} seconds to complete!".format(func.__name__, int(1/(loop_time)), loop_time))
        return(result)
    return func_wrapper
...
def return_interface(num_lights):
    ...
    if (num_lights == None):
        ...
        print("WARNING: num_lights is not None. Make sure it is set to your actual number of devices or you will likely have issues!")
