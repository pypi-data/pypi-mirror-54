...
class mysql:
    ...
    def __execute(self,typess='DQL'):
        ...
        try:
            ...
            if errorcodes == 2013 or errorcodes == 2003 or errorcodes == 1053 or errorcodes == 0:  #2013连接丢失、2003数据库无法连接时、1053连接正在被关闭时
                if self.__config['pattern']: # 长连接情况下
    ...
    __join=None
    __joinstr=''
    def join(self,strs,on,types='INNER'):
