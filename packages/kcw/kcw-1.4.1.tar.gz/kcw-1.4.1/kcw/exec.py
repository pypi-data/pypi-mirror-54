                        ...
                        while True:
                            ...
                            if 'Blueprint(' in line:
                                ...
                                line=(self.name+"app = Blueprint(\n"+
                                    "   'application',\n"+
                                    "   __name__,\n"+
                                    "   static_folder='../../../../../app/"+self.name+"/'+app['static_folder'],#设置静态url目录\n"+
                                    "   template_folder='../../../../../app/"+self.name+"/'+app['template_folder'],#设置模板文件目录\n"+
                                    ")")
                                    ...
                                    if cs:
                                        ...
                                        for kkk in cs:
                                            ...
                                            if route['defaultparam']==1:
                                                ...
                                                s=s+'/<'+kkk[0]+'>'
                                            # print(fun+s)
                                            ly=ly+'@'+self.name+'app.route("'+"/"+fileind+'/'+fun+s+'",methods='+methods+',strict_slashes=False)\n'
