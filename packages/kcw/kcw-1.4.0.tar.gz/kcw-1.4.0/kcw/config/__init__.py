...
confkcw={}
confkcw['version']='1.4.0'
confkcw['name']='kcw'
confkcw['description']='kcw 一个快速搭建cli和web的框架,修复Http类请求头以及Http set_cookie字符串转字典'
confkcw['author_email']='fk1402936534@qq.com'
confkcw['install_requires']=['pymongo==3.9.0','six==1.12.0','requests==2.22.0']