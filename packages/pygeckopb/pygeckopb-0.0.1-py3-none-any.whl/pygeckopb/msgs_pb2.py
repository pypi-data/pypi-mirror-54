...
_LASERPT = _descriptor.Descriptor(
  name='LaserPt',
  full_name='LaserPt',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='angle', full_name='LaserPt.angle', index=0,
      number=1, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='range', full_name='LaserPt.range', index=1,
      number=2, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='intensity', full_name='LaserPt.intensity', index=2,
      number=3, type=1, cpp_type=5, label=1,
      has_default_value=False, default_value=float(0),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LASERSCAN = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='range', full_name='LaserScan.range', index=4,
      number=5, type=1, cpp_type=5, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\020\001'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='intensity', full_name='LaserScan.intensity', index=5,
      number=6, type=1, cpp_type=5, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\020\001'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='points', full_name='LaserScan.points', index=6,
...
_LASERSCAN.fields_by_name['points'].message_type = _LASERPT
...
DESCRIPTOR.message_types_by_name['LaserPt'] = _LASERPT
...
LaserPt = _reflection.GeneratedProtocolMessageType('LaserPt', (_message.Message,), {
  'DESCRIPTOR' : _LASERPT,
  '__module__' : 'msgs_pb2'
  # @@protoc_insertion_point(class_scope:LaserPt)
  })
_sym_db.RegisterMessage(LaserPt)
...
_LASERSCAN.fields_by_name['range']._options = None
_LASERSCAN.fields_by_name['intensity']._options = None
