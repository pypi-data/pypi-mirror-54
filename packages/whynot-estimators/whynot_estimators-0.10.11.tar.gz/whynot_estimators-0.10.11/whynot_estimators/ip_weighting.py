...
class IPWeighting(whynot_estimators.Estimator):
    ...
    def estimate_treatment_effect(self, covariates, treatment, outcome):
        ...
        weights = dict(zip(weight_obj.names, weight_obj))["weights"]
        ...
        # 95% confidence interval for the treatment (elements 1, 3)
        robust_cis = self.survey.confint_svyglm(fit)
        robust_ci = [robust_cis[1], robust_cis[3]]
