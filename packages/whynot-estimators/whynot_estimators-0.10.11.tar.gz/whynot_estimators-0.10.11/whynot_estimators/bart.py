...
class CausalBart(whynot_estimators.Estimator):
    ...
    def estimate_treatment_effect(self, covariates, treatment, outcome):
        ...
        estimates = extract(results, "estimates")
        ate = extract(estimates, "estimate")[0]
        stderr = extract(estimates, "sd")[0]
        ci_lower = extract(estimates, "ci.lower")[0]
        ci_upper = extract(estimates, "ci.upper")[0]
