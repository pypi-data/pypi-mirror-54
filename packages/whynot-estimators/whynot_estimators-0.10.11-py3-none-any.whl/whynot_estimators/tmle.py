...
class Tmle(whynot_estimators.Estimator):
    ...
    def estimate_treatment_effect(self, covariates, treatment, outcome):
        ...
        # https://cran.r-project.org/web/packages/tmle/tmle.pdf
        estimates = extract(model, "estimates")
        ate_estimate = extract(estimates, "ATE")
        ate = extract(ate_estimate, "psi")
        conf_int = extract(ate_estimate, "CI")
        var = extract(ate_estimate, "var.psi")
