...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'okta', 'v1.1.0-alpha.1572375249+gbfe2d51'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource okta v1.1.0-alpha.1572375249+gbfe2d51`
                """)
            else:
                raise
