...
class RegCode(models.Model):
    ...
    @classmethod
    @transaction.atomic
    def _generate_reg_code(cls, count=0, password_str="123456789", password_count=10, course_days=None):
        ...
        for code in range(0, count):
            ...
            reg_code = cls.generator_password(password_count,password_str)
