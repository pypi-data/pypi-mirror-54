...
def update_guide_plate():
    ...
    guide_shape = vmi.ccMatchPd_ClosedPts(pts, -cup_cs.axis(2), 4 * cup_radius, aceta_prop.data(), 0.5,
    ...
    outer_radius = hole_radius + min_thick
    bottoms = [vmi.pdRayCast_Pt(c, -cup_cs.axis(2), aceta_prop.data()) for c in centers]
    ...
    solids = [vmi.ccMatchPd_ClosedPts(pts, -cup_cs.axis(2), hole_length + 5, aceta_prop.data(), 0.6)
