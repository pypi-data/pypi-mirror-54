...
class FileHeader:
    ...
    def __init__(self):
        ...
        self._beginTime = datetime.datetime.today()
        self._endTime = datetime.datetime.today()
        self._beginTradingDay = datetime.datetime.today()
        self._endTradingDay = datetime.datetime.today()
        self._barCount = 0
        self._period = 1
