...
class QiDataController:
    def __init__(self, qi_data_directory, instrument_manager):
        self.__trading_day = qi_data_directory.trading_day
        self.__instrument_manager = instrument_manager
    ...
    def __load_today_tick_series(self, market, instrument_id, trading_date):
        ...
        try:
            ...
            if instrument_id.lower() != 'index':
                instrument = self.__instrument_manager[instrument_id.split('.')[0]]
    ...
    def get_bar_series_by_time(self, market, instrument_id, interval, bar_type, begin_time, end_time, restore=EnumRestoration.不复权, *instrument_ids):
        ...
        if bar_type == EnumBarType.second:
            ...
            bar_provider.create_bar_provider_by_period(self.__instrument_manager, instrument_id, begin_time, end_trading_date, interval, bar_type,
                                                       *instrument_ids)
            ...
            bar_provider = BarProvider()
            bar_provider.create_bar_provider_by_period(self.__instrument_manager, instrument_id, begin_trading_date, end_trading_date, interval, bar_type,
                                                       *instrument_ids)
        ...
        bar_provider = BarProvider()
        bar_provider.create_bar_provider_by_trading_day(self.__instrument_manager, instrument_id, self.__trading_day, interval, bar_type, *instrument_ids)
    ...
    def get_bar_series_by_length(self, market, instrument_id, interval, bar_type, max_length, end_time, restore=EnumRestoration.不复权, *instrument_ids):
        ...
        if last_trading_day == self.__trading_day:
            ...
            end_trading_date = last_trading_day
        lst_date_time_slices_one_day = BaseBarHelper.create_day_date_time_slice(self.__instrument_manager, instrument_id, end_trading_date, interval, bar_type,
                                                                                *instrument_ids)
        ...
        if len(bar_provider.bar_series) < max_length:
            ...
            while count < 5:
                ...
                if bar_provider.bar_type == EnumBarType.second:
                    bar_provider = BarProvider()
                    bar_provider.create_bar_provider_by_trading_day(self.__instrument_manager, instrument_id, trading_date, interval, bar_type, *instrument_ids)
    ...
    def __combine_today_tick(self, bar_provider, market, end_time):
        date_time_slice = self.__instrument_manager.get_living_date_time(self.__trading_day, bar_provider.instrument_id)
