...
class LoginRequest(DSRequest):
    def __init__(self, request):
        ...
        try:
            ...
            if user.check_password(data.get('password', None)):
                ws_channel = f'{settings.WS_CANNEL}_{login}'
    ...
    def send_bot_message(user, bot, message):
        ...
        chat_user_user, created = Chat_user_user.objects.get_or_create(user_sender=_bot, user_reciver=_user, props=Chat_user_user.props.compulsory_reading)
