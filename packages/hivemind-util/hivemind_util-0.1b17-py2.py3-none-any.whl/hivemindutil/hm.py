...
def help():
    ...
    print('')
    print('- createInstance(taskId, baseUrl, apiKey, name, instructions=\'\', data={}, overrideSchema=None, tags=[])')
...
def createInstance(taskId, baseUrl, apiKey, name, instructions='', data={}, overrideSchema=None, tags=[]):
