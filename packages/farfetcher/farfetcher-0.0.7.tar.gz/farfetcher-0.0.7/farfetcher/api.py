...
class Farfetcher:
    ...
    def build_url(self, page=None, view=180, gender='Women',
                  page_type='Shopping', price_type='FullPrice'):
        return self.base_url + self.params.format(view, page_type, price_type, page, gender)
