...
class PrinterBase(object):
    ...
    def __init__(self, printer_name=None, doc_name=None, margin=None, linegap=0, default_font=None):
        ...
        self.default_font = default_font and copy.deepcopy(default_font) or None
        self.printer = win32ui.CreateDC()  
        self.printer.CreatePrinterDC(win32print.GetDefaultPrinter()) 
    ...
    def setup_printer_font(self, font_config=None):
        return PrinterFontContext(self, font_config)
