...
from quetzal.openapi_client.models.paginated_queries import PaginatedQueries  # noqa: E501
...
class TestPaginatedQueries(unittest.TestCase):
    ...
    def testPaginatedQueries(self):
        ...
        # model = quetzal.openapi_client.models.paginated_queries.PaginatedQueries()  # noqa: E501
        pass
