...
from quetzal.openapi_client.models.file_contents import FileContents  # noqa: E501
...
class TestFileContents(unittest.TestCase):
    ...
    def testFileContents(self):
        ...
        # model = quetzal.openapi_client.models.file_contents.FileContents()  # noqa: E501
        pass
