...
```python
sciann.functionals.functional.Functional(fields=None, variables=None, hidden_layers=None, activation='tanh', enrichment='linear', kernel_initializer=<keras.initializers.VarianceScaling object at 0x1314dba20>, bias_initializer=<keras.initializers.RandomUniform object at 0x1314dbac8>, dtype=None, trainable=True)
```
...
```python
sciann.functionals.field.Field(name=None, units=1, activation=<function linear at 0x12f782ea0>, kernel_initializer=<keras.initializers.VarianceScaling object at 0x1314d3358>, bias_initializer=<keras.initializers.RandomUniform object at 0x1314d36d8>, trainable=True, dtype=None)
```
